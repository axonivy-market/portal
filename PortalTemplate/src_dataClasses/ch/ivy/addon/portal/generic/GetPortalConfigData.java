...
@javax.annotation.Generated(comments="This is the java file of the ivy data class GetPortalConfigData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class GetPortalConfigData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
