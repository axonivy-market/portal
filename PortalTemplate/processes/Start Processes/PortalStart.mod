[Ivy]
[>Created: Tue May 24 14:36:20 ICT 2016]
...
out.portalNavigator=param.portalNavigator;
' #txt
...
' #txt
Pt0 f7 304 216 96 48 -22 -8 #rect
Pt0 f7 @|RichDialogIcon #fIcon
Pt0 f4 expr in #txt
Pt0 f4 outCond 'java.util.Objects.equals(ch.ivy.addon.portal.generic.navigation.PortalPage.HOME_PAGE.name(), in.portalNavigator) || in.portalNavigator.isEmpty()' #txt
Pt0 f4 198 152 300 152 #arcP
...
' #txt
Pt0 f3 300 128 120 48 -45 -8 #rect
...
Pt0 f8 expr in #txt
Pt0 f8 outCond 'java.util.Objects.equals(ch.ivy.addon.portal.generic.navigation.PortalPage.ERROR_PAGE.name() ,in.portalNavigator) ' #txt
Pt0 f8 184 166 304 240 #arcP
Pt0 f8 1 184 240 #addKink
Pt0 f8 1 0.14760754165585 0 0 #arcLabel
...
' #txt
Pt0 f17 368 312 112 48 -49 -12 #rect
...
' #txt
Pt0 f1 228 312 104 48 -46 -4 #rect
Pt0 f1 @|StepIcon #fIcon
Pt0 f18 expr out #txt
Pt0 f18 332 336 368 336 #arcP
Pt0 f2 expr in #txt
Pt0 f2 outCond 'java.util.Objects.equals(ch.ivy.addon.portal.generic.navigation.PortalPage.CASE_DETAIL_FROM_TASK.name(), in.portalNavigator)' #txt
Pt0 f2 184 166 228 336 #arcP
Pt0 f2 1 184 336 #addKink
Pt0 f2 0 0.5659763711335826 0 0 #arcLabel
...
' #txt
Pt0 f9 404 416 104 48 -46 -6 #rect
Pt0 f9 @|CallSubIcon #fIcon
Pt0 f13 expr in #txt
Pt0 f13 outCond 'java.util.Objects.equals(ch.ivy.addon.portal.generic.navigation.PortalPage.LINK_TO_TASK.name(), in.portalNavigator)' #txt
Pt0 f13 184 166 232 440 #arcP
Pt0 f13 1 184 336 #addKink
Pt0 f13 2 184 304 #addKink
Pt0 f13 3 184 440 #addKink
Pt0 f13 0 0.8710493046776234 0 0 #arcLabel
Pt0 f12 expr out #txt
Pt0 f12 360 440 404 440 #arcP
...
' #txt
Pt0 f15 actionCode 'import ch.ivy.addon.portalkit.datamodel.TaskLazyDataModel;
...
' #txt
Pt0 f15 232 412 128 56 -43 -16 #rect
