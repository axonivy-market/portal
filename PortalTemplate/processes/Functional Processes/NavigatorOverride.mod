[Ivy]
[>Created: Fri May 20 10:54:44 ICT 2016]
...
Nr0 @EndSub f16 '' #zField
Nr0 @StartSub f17 '' #zField
Nr0 @RichDialog f19 '' #zField
Nr0 @PushWFArc f20 '' #zField
Nr0 @PushWFArc f18 '' #zField
...
in.caseView = CaseView.create().dataModel(dataModel).withTitle(title).autoSelectIfExists(in.caseId).buildNewView();' #txt
...
' #txt
Nr0 f14 actionCode 'import ch.ivy.addon.portalkit.datamodel.TaskLazyDataModel;
...
Nr0 f16 363 571 26 26 14 0 #rect
Nr0 f16 @|EndSubIcon #fIcon
Nr0 f17 inParamDecl '<java.lang.String appName,java.lang.String url> param;' #txt
Nr0 f17 inParamTable 'out.thirdPartyAppName=param.appName;
out.thirdPartyAppUrl=param.url;
' #txt
Nr0 f17 outParamDecl '<> result;
' #txt
Nr0 f17 actionDecl 'ch.ivy.addon.portal.generic.NavigatorOverrideData out;
' #txt
Nr0 f17 callSignature thirdPartyApplication(String,String) #txt
Nr0 f17 type ch.ivy.addon.portal.generic.NavigatorOverrideData #txt
Nr0 f17 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>thirdPartyApplication(String,String)</name>
    </language>
</elementInfo>
' #txt
Nr0 f17 363 363 26 26 14 0 #rect
Nr0 f17 @|StartSubIcon #fIcon
Nr0 f19 targetWindow NEW:card: #txt
Nr0 f19 targetDisplay TOP #txt
Nr0 f19 richDialogId ch.ivy.addon.portal.generic.CustomApplication #txt
Nr0 f19 startMethod start(String,String) #txt
Nr0 f19 type ch.ivy.addon.portal.generic.NavigatorOverrideData #txt
Nr0 f19 requestActionDecl '<String url, String appName> param;' #txt
Nr0 f19 requestMappingAction 'param.url=in.thirdPartyAppUrl;
param.appName=in.thirdPartyAppName;
' #txt
Nr0 f19 responseActionDecl 'ch.ivy.addon.portal.generic.NavigatorOverrideData out;
' #txt
Nr0 f19 responseMappingAction 'out=in;
' #txt
Nr0 f19 windowConfiguration '* ' #txt
Nr0 f19 isAsynch false #txt
Nr0 f19 isInnerRd false #txt
Nr0 f19 userContext '* ' #txt
Nr0 f19 358 468 36 24 20 -2 #rect
Nr0 f19 @|RichDialogIcon #fIcon
Nr0 f20 expr out #txt
Nr0 f20 376 389 376 468 #arcP
Nr0 f18 expr out #txt
Nr0 f18 376 492 376 571 #arcP
...
This callable is introduced for clients of PortalKit
to override and implement the functionality
of redirecting into a HtmlDialog of third party application
...
' #txt
Nr0 f23 568 418 496 172 -238 -84 #rect
Nr0 f23 @|IBIcon #fIcon
Nr0 f24 568 504 394 480 #arcP
...
Nr0 f17 mainOut f20 tail #connect
Nr0 f20 head f19 mainIn #connect
Nr0 f19 mainOut f18 tail #connect
Nr0 f18 head f16 mainIn #connect
...
Nr0 f24 head f19 @CG|ai #connect
