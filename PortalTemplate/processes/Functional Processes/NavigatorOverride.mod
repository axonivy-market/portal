[Ivy]
[>Created: Tue May 10 11:26:44 ICT 2016]
...
' #txt
Nr0 f3 240 98 496 172 -238 -84 #rect
Nr0 f3 @|IBIcon #fIcon
...
sb.append("&amp;serverId=");
sb.append(in.caseId.serverId());
sb.append("''>#");
sb.append(in.caseId.id());
sb.append("</a>");
...
Nr0 f9 inParamDecl '<java.lang.String taskId,ch.ivy.addon.portalkit.dto.GlobalCaseId caseId,java.lang.String caseName> param;' #txt
...
' #txt
Nr0 f9 callSignature viewTask(String,ch.ivy.addon.portalkit.dto.GlobalCaseId,String) #txt
