[Ivy]
[>Created: Thu Apr 21 18:21:03 ICT 2016]
...
Ot0 f3 startMethod useView(ch.ivy.addon.portal.generic.view.CaseView) #txt
Ot0 f3 type ch.ivy.addon.portal.generic.OpenPortalCasesData #txt
Ot0 f3 requestActionDecl '<ch.ivy.addon.portal.generic.view.CaseView view> param;' #txt
Ot0 f3 requestMappingAction 'param.view=in.view;
' #txt
