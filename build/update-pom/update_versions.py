"""Updates Portal POM files: project versions, portal dependencies, and Maven properties."""
import xml.etree.ElementTree as ET
import argparse, sys
from pathlib import Path

MAVEN_NS = '{http://maven.apache.org/POM/4.0.0}'
PORTAL_GROUP_IDS = {'com.axonivy.portal', 'ch.ivyteam.ivy.project.portal'}
...
def update_versions(file_path, portal_version=None):
    ...
    if dependencies is not None:
        for dependency in dependencies.findall(f'{MAVEN_NS}dependency'):
            ...
            if group_id is not None and group_id.text in PORTAL_GROUP_IDS:
...
def main():
    ...
    if not any([args.portal_version, args.engine_version, args.build_plugin_version]):
        return 0
    ...
    for pom_file in pom_files:
        ...
        update_versions(str(pom_file), args.portal_version)
