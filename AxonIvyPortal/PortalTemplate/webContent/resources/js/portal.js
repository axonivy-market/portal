...
function highlightCustomCaseDetail() {
  var customTop = $('#case-details-caseItemDetailCustomTop-panel');
  appendStepAnnotation(customTop, 1, -10, customTop.width()/2);
  
  var customMidle = $('#case-details-caseItemDetailCustomMiddle-panel');
  appendStepAnnotation(customMidle, 2, -10, customMidle.width()/2);
  
  var customBottom = $('#case-details-caseItemDetailCustomBottom-panel');
  appendStepAnnotation(customBottom, 3, -10, customBottom.width()/2);
}
