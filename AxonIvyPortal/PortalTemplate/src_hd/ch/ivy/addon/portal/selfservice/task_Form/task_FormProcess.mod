[Ivy]
[>Created: Wed May 10 09:51:51 ICT 2017]
15BF02AF87DEB5C6 3.20 #module
...
ts0 f0 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
ts0 f0 method start(ch.ivy.add.portal.selfservice.CaseDef,ch.ivy.add.portal.selfservice.TaskDef,java.util.List<ch.ivy.add.portal.selfservice.TaskDef>) #txt
ts0 f0 disableUIEvents true #txt
ts0 f0 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<ch.ivy.add.portal.selfservice.CaseDef caseInfo,ch.ivy.add.portal.selfservice.TaskDef nextTask,java.util.List<ch.ivy.add.portal.selfservice.TaskDef> definedTasks> param = methodEvent.getInputArguments();
' #txt
ts0 f0 inParameterMapAction 'out.caseInfo=param.caseInfo;
out.definedTasks=param.definedTasks;
out.nextTask=param.nextTask;
' #txt
ts0 f0 inActionCode 'import ch.ivy.add.portal.selfservice.TaskDef;
...
out.addTask = new TaskDef();
TaskDef oldTask = param.nextTask; //out.taskHistory.get(out.taskHistory.size()-1);
...
ts0 f0 outParameterDecl '<java.util.List<ch.ivy.add.portal.selfservice.TaskDef> definedTasks> result;
' #txt
...
ts0 f1 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
ts0 f1 339 51 26 26 0 12 #rect
ts0 f1 @|RichDialogProcessEndIcon #fIcon
ts0 f3 guid 1492E077ACABAB84 #txt
ts0 f3 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
ts0 f3 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
ts0 f4 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f6 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
ts0 f6 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
ts0 f9 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
' #txt
ts0 f9 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f11 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
ts0 f11 actionTable 'out=in;
' #txt
ts0 f11 actionCode 'import ch.ivy.add.portal.selfservice.TaskDef;

TaskDef newTask1 = new TaskDef();
TaskDef oldTask = out.taskHistory.get(out.taskHistory.size()-1);
...
ts0 f11 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f8 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
ts0 f8 actionTable 'out=in;
' #txt
ts0 f8 actionCode 'import ch.ivy.add.portal.selfservice.TaskDef;
...
' #txt
ts0 f8 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f12 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
ts0 f12 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
ts0 f16 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
ts0 f16 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f20 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f21 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
' #txt
ts0 f21 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f37 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
ts0 f37 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f34 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
ts0 f34 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
ts0 f35 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f15 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
ts0 f15 actionTable 'out=in;
' #txt
ts0 f15 actionCode 'import ch.ivy.addon.portal.selfservice.Helper;
...
ts0 f15 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f24 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
ts0 f24 499 499 26 26 0 12 #rect
ts0 f24 @|RichDialogProcessEndIcon #fIcon
ts0 f28 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
ts0 f28 actionTable 'out=in;
' #txt
ts0 f28 actionCode 'import ch.ivy.addon.portal.selfservice.SystemDo;
import ch.ivy.add.portal.selfservice.TaskDef;
...
out.msg = in.addTask.actor;
' #txt
ts0 f28 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f29 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
ts0 f29 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
ts0 f33 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
ts0 f33 method deleteTask(ch.ivy.add.portal.selfservice.TaskDef) #txt
...
ts0 f39 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f27 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
' #txt
ts0 f27 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f18 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
' #txt
ts0 f18 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
ts0 f41 actionDecl 'ch.ivy.addon.portal.selfservice.task_Form.task_FormData out;
' #txt
...
' #txt
ts0 f41 type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
...
>Proto ts0 .type ch.ivy.addon.portal.selfservice.task_Form.task_FormData #txt
