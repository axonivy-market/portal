[Ivy]
[>Created: Wed May 10 14:55:02 ICT 2017]
15BF061459E45DDC 3.20 #module
...
ds0 f4 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f28 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f28 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f3 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
ds0 f3 actionTable 'out=in;
' #txt
ds0 f3 actionCode 'import ch.ivy.add.portal.selfservice.TaskDef;
import ch.ivy.addon.portal.selfservice.SystemDo;
...
' #txt
ds0 f3 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f11 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
ds0 f11 actionTable 'out=in;
' #txt
ds0 f11 actionCode 'import ch.ivy.add.portal.selfservice.TaskDef;
...
' #txt
ds0 f11 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f8 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f8 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f9 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f9 275 243 26 26 0 12 #rect
ds0 f9 @|RichDialogProcessEndIcon #fIcon
ds0 f7 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
ds0 f7 actionTable 'out=in;
out.caseInfo.kind="TODO";
out.started=new DateTime();
' #txt
ds0 f7 actionCode 'import ch.ivy.add.portal.selfservice.TaskDef;
import ch.ivy.addon.portal.selfservice.Helper;
import javax.faces.context.FacesContext;
import java.util.Collection;

// creator task
out.newTask = new TaskDef();
...
ds0 f7 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f13 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f13 method deleteTask(ch.ivy.add.portal.selfservice.TaskDef) #txt
...
<ch.ivy.add.portal.selfservice.TaskDef taskdef> param = methodEvent.getInputArguments();
' #txt
...
ds0 f15 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f15 275 387 26 26 0 12 #rect
ds0 f15 @|RichDialogProcessEndIcon #fIcon
ds0 f16 expr out #txt
ds0 f16 77 400 275 400 #arcP
ds0 f17 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f17 275 315 26 26 0 12 #rect
ds0 f17 @|RichDialogProcessEndIcon #fIcon
ds0 f18 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
ds0 f18 actionTable 'out=in;
' #txt
ds0 f18 actionCode 'import ch.ivy.add.portal.selfservice.TaskDef;
...
' #txt
ds0 f18 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f19 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f19 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f22 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f24 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f24 531 99 26 26 0 12 #rect
ds0 f24 @|RichDialogProcessEndIcon #fIcon
ds0 f26 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f26 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f29 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f29 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f32 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f32 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f30 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f30 275 467 26 26 0 12 #rect
ds0 f30 @|RichDialogProcessEndIcon #fIcon
ds0 f34 guid 14BEECEBE2A5DE80 #txt
ds0 f34 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f34 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f35 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f35 275 563 26 26 0 12 #rect
ds0 f35 @|RichDialogProcessEndIcon #fIcon
ds0 f37 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f37 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f39 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f39 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f40 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f44 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f44 method initUserList(ch.ivy.add.portal.selfservice.TaskDef) #txt
...
ds0 f47 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f47 method editTaskDescription(ch.ivy.add.portal.selfservice.TaskDef) #txt
...
ds0 f48 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
...
ds0 f50 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f50 actionDecl 'ch.ivy.addon.portal.selfservice.define_WF.define_WFData out;
' #txt
...
ds0 f51 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f51 179 851 26 26 0 12 #rect
ds0 f51 @|RichDialogProcessEndIcon #fIcon
ds0 f52 77 864 179 864 #arcP
ds0 f0 guid 15BF14E42CDDE6F6 #txt
ds0 f0 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f0 method start() #txt
ds0 f0 disableUIEvents true #txt
ds0 f0 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<> param = methodEvent.getInputArguments();
' #txt
ds0 f0 outParameterDecl '<java.util.List<ch.ivy.add.portal.selfservice.TaskDef> definedTasks,ch.ivy.add.portal.selfservice.CaseDef caseInfo> result;
' #txt
...
' #txt
ds0 f0 53 53 22 22 14 0 #rect
ds0 f0 @|RichDialogInitStartIcon #fIcon
ds0 f12 expr out #txt
ds0 f12 75 64 120 64 #arcP
ds0 f1 type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
ds0 f1 309 53 22 22 14 0 #rect
ds0 f1 @|RichDialogProcessEndIcon #fIcon
ds0 f2 expr out #txt
ds0 f2 232 64 309 64 #arcP
>Proto ds0 .type ch.ivy.addon.portal.selfservice.define_WF.define_WFData #txt
