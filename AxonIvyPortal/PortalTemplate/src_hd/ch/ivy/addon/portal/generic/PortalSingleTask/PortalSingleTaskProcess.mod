[Ivy]
[>Created: Tue Mar 22 18:41:36 ICT 2016]
...
Ps0 f11 processCall MultiPortal/TaskService:findTasksByCriteriaAndServers(List<ch.ivy.addon.portalkit.persistence.domain.Server>,ch.ivy.ws.addon.TaskSearchCriteria) #txt
Ps0 f11 doCall true #txt
Ps0 f11 requestActionDecl '<java.util.List<ch.ivy.addon.portalkit.persistence.domain.Server> servers,ch.ivy.ws.addon.TaskSearchCriteria taskSearchCriteria> param;
' #txt
...
in.taskSearchCriteria.setTaskId(in.remoteTaskId);
in.taskSearchCriteria.setInvolvedUsername(ivy.session.getSessionUserName());
' #txt
