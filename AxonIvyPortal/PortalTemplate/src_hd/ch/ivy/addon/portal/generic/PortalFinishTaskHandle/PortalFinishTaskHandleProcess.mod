...
Ps0 @InfoButton f10 '' #zField
Ps0 @AnnotationArc f7 '' #zField
...
' #txt
Ps0 f10 240 210 160 44 -74 -16 #rect
Ps0 f10 @|IBIcon #fIcon
Ps0 f7 240 232 224 182 #arcP
...
Ps0 f10 ao f7 tail #connect
Ps0 f7 head f8 @CG|ai #connect
