...
Ps0 f4 995 187 26 26 0 12 #rect
...
Ps0 f21 processCall MultiPortal/TaskService:findTaskCategoriesOfUserWithReadAllPermission(String,String,List<String>,Long) #txt
...
out.groupTaskCategories=result.groupTaskCategories;
out.myTaskCategories=result.personalTaskCategories;
out.unassignedTaskCategories=result.unassignedTaskCategories;
' #txt
Ps0 f21 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Find categories of
user with read all permission</name>
        <nameStyle>48,5,7
</nameStyle>
    </language>
</elementInfo>
' #txt
Ps0 f21 734 140 36 24 -64 -51 #rect
...
Ps0 f8 processCall MultiPortal/TaskService:findTaskCategoriesOfUserWithoutReadAllPermission(String,String,List<String>,Long) #txt
Ps0 f8 doCall true #txt
Ps0 f8 requestActionDecl '<java.lang.String username,java.lang.String jsonQuery,List<java.lang.String> apps,java.lang.Long serverId> param;
' #txt
...
<elementInfo>
    <language>
        <name>Find categories of
user without read all permission</name>
        <nameStyle>51,5,7
</nameStyle>
    </language>
</elementInfo>
' #txt
Ps0 f8 734 236 36 24 -80 14 #rect
...
Ps0 f6 expr in #txt
Ps0 f6 910 200 995 200 #arcP
Ps0 f11 expr out #txt
Ps0 f11 770 152 896 186 #arcP
Ps0 f11 1 896 152 #addKink
Ps0 f11 0 0.627266316724181 0 0 #arcLabel
...
Ps0 f22 out f6 tail #connect
Ps0 f6 head f4 mainIn #connect
Ps0 f21 mainOut f11 tail #connect
Ps0 f11 head f22 in #connect
