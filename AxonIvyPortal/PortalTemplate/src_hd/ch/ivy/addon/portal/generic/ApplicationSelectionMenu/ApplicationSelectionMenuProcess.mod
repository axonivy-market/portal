...
As0 f66 948 518 26 26 0 12 #rect
...
' #txt
As0 f67 560 433 32 24 20 -2 #rect
...
' #txt
As0 f69 1441 433 36 24 20 -2 #rect
...
' #txt
As0 f71 925 425 72 40 -22 -8 #rect
...
' #txt
As0 f72 950 21 22 22 14 0 #rect
...
' #txt
As0 f73 1403 299 112 44 -40 -8 #rect
...
As0 f76 945 161 32 32 0 16 #rect
...
As0 f77 758 520 22 22 14 0 #rect
...
As0 f78 565 520 22 22 14 0 #rect
...
As0 f81 1108 224 26 26 0 12 #rect
...
' #txt
As0 f82 1081 425 80 40 -27 -8 #rect
...
' #txt
As0 f83 897 215 128 44 -42 -16 #rect
...
' #txt
As0 f84 1407 511 104 40 -48 -12 #rect
...
As0 f90 1108 518 26 26 0 12 #rect
...
' #txt
As0 f95 751 433 36 24 20 -2 #rect
...
' #txt
As0 f24 1263 519 36 24 -76 -40 #rect
...
' #txt
As0 f56 1225 581 112 48 -49 -12 #rect
...
' #txt
As0 f62 1225 423 112 44 -38 -20 #rect
As0 f62 @|CallSubIcon #fIcon
As0 f52 expr out #txt
As0 f52 1281 467 1281 519 #arcP
As0 f34 expr out #txt
As0 f34 1281 543 1281 581 #arcP
As0 f0 expr in #txt
As0 f0 783 323 1281 423 #arcP
As0 f0 1 1281 384 #addKink
As0 f0 0 0.7470190068714725 0 0 #arcLabel
...
' #txt
As0 f1 1108 19 26 26 16 -3 #rect
As0 f1 @|RichDialogProcessStartIcon #fIcon
As0 f2 expr out #txt
As0 f2 1121 45 977 177 #arcP
As0 f2 1 1121 177 #addKink
...
As0 f5 expr out #txt
As0 f5 96 44 232 288 #arcP
As0 f5 1 96 288 #addKink
...
As0 f17 1459 457 1459 511 #arcP
