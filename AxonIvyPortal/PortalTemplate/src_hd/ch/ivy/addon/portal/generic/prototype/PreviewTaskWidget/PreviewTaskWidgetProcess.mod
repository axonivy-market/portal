[Ivy]
172C68ED32F6480C 7.5.0 #module
>Proto >Proto Collection #zClass
Ps0 PreviewTaskWidgetProcess Big #zClass
Ps0 RD #cInfo
Ps0 #process
...
>Proto Ps0 .type ch.ivy.addon.portal.generic.prototype.PreviewTaskWidget.PreviewTaskWidgetData #txt
