[Ivy]
178592835845348C 9.3.1 #module
>Proto >Proto Collection #zClass
Ps0 CaseDashboardWidgetProcess Big #zClass
Ps0 RD #cInfo
Ps0 #process
...
>Proto Ps0 Ps0 CaseDashboardWidgetProcess #zField
...
>Proto Ps0 .type ch.ivy.addon.portal.generic.dashboard.component.CaseDashboardWidget.CaseDashboardWidgetData #txt
