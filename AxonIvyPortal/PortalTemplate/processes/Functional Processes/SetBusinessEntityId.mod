...
' #txt
Sd0 f3 actionCode 'import ch.ivy.addon.portalkit.util.CaseUtils;

ivy.case.setAdditionalProperty(CaseUtils.CASE_BUSINESS_ENTITY_PROPERTY, in.businessEntityId);' #txt
