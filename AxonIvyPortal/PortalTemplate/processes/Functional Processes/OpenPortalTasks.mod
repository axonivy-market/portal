[Ivy]
[>Created: Fri Mar 24 14:13:20 ICT 2017]
...
Os0 f5 actionDecl 'ch.ivy.addon.portal.generic.OpenPortalTasksData out;
' #txt
Os0 f5 actionTable 'out=in;
' #txt
Os0 f5 type ch.ivy.addon.portal.generic.OpenPortalTasksData #txt
