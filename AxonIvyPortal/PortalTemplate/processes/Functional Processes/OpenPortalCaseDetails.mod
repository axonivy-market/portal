...
Os0 f3 richDialogId ch.ivy.addon.portal.generic.PortalCaseDetails #txt
Os0 f3 startMethod start(ch.ivyteam.ivy.workflow.ICase,String) #txt
Os0 f3 type ch.ivy.addon.portal.generic.OpenPortalCaseDetailsData #txt
...
' #txt
Os0 f3 responseActionDecl 'ch.ivy.addon.portal.generic.OpenPortalCaseDetailsData out;
' #txt
