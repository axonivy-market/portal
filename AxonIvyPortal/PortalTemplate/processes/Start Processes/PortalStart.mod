...
Bk0 f23 requestActionDecl '<ch.ivyteam.ivy.workflow.ICase caseData,Boolean isShowBackButton,Boolean isFromTask> param;' #txt
Bk0 f23 requestMappingAction 'param.caseData=in.caseSelected;
param.isShowBackButton=true;
param.isFromTask=true;
' #txt
...
Bk4 f104 requestActionDecl '<ch.ivyteam.ivy.workflow.ICase caseData,Boolean isShowBackButton,Boolean isFromTask> param;' #txt
