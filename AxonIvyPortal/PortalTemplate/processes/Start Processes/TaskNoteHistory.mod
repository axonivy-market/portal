...
Ty0 f1 1081 49 30 30 0 15 #rect
...
Ty0 f7 processCall MultiPortal/CaseService:findNotes(ch.ivy.addon.portalkit.persistence.domain.Server,Long) #txt
Ty0 f7 doCall true #txt
Ty0 f7 requestActionDecl '<ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Long caseId> param;
' #txt
Ty0 f7 requestMappingAction 'param.server=in.remoteTask.applicationRegister.server;
...
' #txt
Ty0 f7 592 42 112 44 -40 -8 #rect
Ty0 f7 @|CallSubIcon #fIcon
Ty0 f8 expr out #txt
Ty0 f8 544 64 592 64 #arcP
...
' #txt
Ty0 f9 752 42 112 44 -27 -8 #rect
Ty0 f9 @|StepIcon #fIcon
Ty0 f10 expr out #txt
Ty0 f10 704 64 752 64 #arcP
...
' #txt
Ty0 f11 920 42 112 44 -48 -8 #rect
Ty0 f11 @|RichDialogIcon #fIcon
Ty0 f12 expr out #txt
Ty0 f12 864 64 920 64 #arcP
Ty0 f2 expr out #txt
Ty0 f2 1032 64 1081 64 #arcP
...
Ty0 f5 mainOut f8 tail #connect
