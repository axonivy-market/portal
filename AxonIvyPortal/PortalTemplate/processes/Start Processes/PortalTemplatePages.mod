[Ivy]
[>Created: Thu Apr 14 09:21:21 ICT 2016]
...
Tt0 f26 startMethod start(java.lang.Long,java.lang.Long,java.lang.Long,String) #txt
Tt0 f26 type ch.ivy.addon.portal.generic.Data #txt
Tt0 f26 requestActionDecl '<java.lang.Long remoteTaskId, java.lang.Long caseId, java.lang.Long serverId, String caseName> param;' #txt
...
Tt0 f22 inParamDecl '<java.lang.Long caseId,java.lang.Long serverId> param;' #txt
...
Tt0 f22 callSignature PortalCaseListLinkedFromTask(Long,Long) #txt
...
Tt0 f22 83 883 26 26 -44 16 #rect
Tt0 f22 @|StartRequestIcon #fIcon
Tt0 f31 type ch.ivy.addon.portal.generic.Data #txt
Tt0 f31 processCall 'Functional Processes/OpenPortalCaseList:openFromCaseSearching(String,Long,Long)' #txt
Tt0 f31 doCall true #txt
Tt0 f31 requestActionDecl '<java.lang.String keyword,java.lang.Long caseId,java.lang.Long serverId> param;
' #txt
Tt0 f31 requestMappingAction 'param.keyword=in.keyword;
param.caseId=in.caseId;
param.serverId=in.serverId;
' #txt
Tt0 f31 responseActionDecl 'ch.ivy.addon.portal.generic.Data out;
' #txt
...
' #txt
Tt0 f31 360 520 128 48 -56 -12 #rect
Tt0 f31 @|CallSubIcon #fIcon
Tt0 f32 expr out #txt
Tt0 f32 109 544 360 544 #arcP
Tt0 f17 type ch.ivy.addon.portal.generic.Data #txt
Tt0 f17 processCall 'Functional Processes/OpenPortalCaseList:openFromLinkedTask(Long,Long)' #txt
Tt0 f17 doCall true #txt
Tt0 f17 requestActionDecl '<java.lang.Long caseId,java.lang.Long serverId> param;
' #txt
Tt0 f17 requestMappingAction 'param.caseId=in.caseId;
param.serverId=in.serverId;
' #txt
...
' #txt
Tt0 f17 360 872 128 48 -56 -12 #rect
Tt0 f17 @|CallSubIcon #fIcon
Tt0 f18 expr out #txt
Tt0 f18 109 896 360 896 #arcP
...
Tt0 f11 mainOut f32 tail #connect
Tt0 f32 head f31 mainIn #connect
Tt0 f22 mainOut f18 tail #connect
