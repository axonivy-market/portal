[Ivy]
[>Created: Tue Mar 08 17:12:12 ICT 2016]
...
Tt0 @RichDialog f22 '' #zField
Tt0 @StartRequest f23 '' #zField
...
Tt0 f22 targetWindow NEW:card: #txt
Tt0 f22 targetDisplay TOP #txt
Tt0 f22 richDialogId ch.ivy.addon.portal.generic.TaskInformation #txt
Tt0 f22 startMethod startFromSearch(java.lang.Long) #txt
Tt0 f22 type ch.ivy.addon.portal.generic.Data #txt
Tt0 f22 requestActionDecl '<java.lang.Long taskId> param;' #txt
Tt0 f22 requestMappingAction 'param.taskId=in.taskId;
' #txt
Tt0 f22 responseActionDecl 'ch.ivy.addon.portal.generic.Data out;
' #txt
Tt0 f22 responseMappingAction 'out=in;
' #txt
Tt0 f22 windowConfiguration '* ' #txt
Tt0 f22 isAsynch false #txt
Tt0 f22 isInnerRd false #txt
Tt0 f22 userContext '* ' #txt
...
' #txt
Tt0 f22 380 716 88 40 -22 -16 #rect
Tt0 f22 @|RichDialogIcon #fIcon
Tt0 f23 outLink PortalTaskDetails.ivp #txt
Tt0 f23 type ch.ivy.addon.portal.generic.Data #txt
Tt0 f23 inParamDecl '<java.lang.Long detailTaskId> param;' #txt
Tt0 f23 inParamTable 'out.taskId=param.detailTaskId;
' #txt
Tt0 f23 actionDecl 'ch.ivy.addon.portal.generic.Data out;
' #txt
Tt0 f23 guid 1533F92B64644E8F #txt
Tt0 f23 requestEnabled true #txt
Tt0 f23 triggerEnabled false #txt
Tt0 f23 callSignature PortalTaskDetails(Long) #txt
Tt0 f23 persist false #txt
Tt0 f23 taskData 'TaskTriggered.ROL=Everybody
TaskTriggered.EXTYPE=0
TaskTriggered.EXPRI=2
TaskTriggered.TYPE=0
TaskTriggered.PRI=2
TaskTriggered.EXROL=Everybody' #txt
Tt0 f23 showInStartList 0 #txt
Tt0 f23 taskAndCaseSetupAction 'import ch.ivyteam.ivy.workflow.TaskUpdateDefinition;
ch.ivyteam.ivy.workflow.TaskUpdateDefinition taskUpdDef = new ch.ivyteam.ivy.workflow.TaskUpdateDefinition();
import ch.ivyteam.ivy.request.impl.DefaultCalendarProxy;
DefaultCalendarProxy calendarProxy = ivy.cal as DefaultCalendarProxy;
taskUpdDef.setPriority(ch.ivyteam.ivy.workflow.WorkflowPriority.valueOf(2));
...
<elementInfo>
    <language>
        <name>PortalTaskDetails.ivp</name>
    </language>
</elementInfo>
' #txt
Tt0 f23 @C|.responsibility Everybody #txt
Tt0 f23 83 723 26 26 -45 19 #rect
Tt0 f23 @|StartRequestIcon #fIcon
Tt0 f24 expr out #txt
Tt0 f24 109 736 380 736 #arcP
...
Tt0 f25 83 819 26 26 -45 19 #rect
...
' #txt
Tt0 f26 372 808 104 48 -14 -16 #rect
Tt0 f26 @|RichDialogIcon #fIcon
Tt0 f27 expr out #txt
Tt0 f27 109 832 372 832 #arcP
...
Tt0 f23 mainOut f24 tail #connect
Tt0 f24 head f22 mainIn #connect
