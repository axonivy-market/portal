...
@javax.annotation.Generated(comments="This is the java file of the ivy data class DevLoadWorkflowsData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class DevLoadWorkflowsData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
