...
ISecurityMember selectedAssignee = in.#selectedUser is initialized ? ivy.wf.getSecurityContext().findSecurityMember(in.selectedUser.getMemberName()) : in.selectedRole;
