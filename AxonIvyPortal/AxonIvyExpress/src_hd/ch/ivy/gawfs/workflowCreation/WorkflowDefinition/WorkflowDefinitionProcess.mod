...
out.taskDefinition.responsibles = in.selectedAssigneeList;

List<String> responsibleNames = new ArrayList();
for (ISecurityMember responsible : out.taskDefinition.responsibles) {
...
' #txt
Fs0 f33 actionCode 'in.selectedAssigneeList = in.taskDefinition.responsibles;' #txt
