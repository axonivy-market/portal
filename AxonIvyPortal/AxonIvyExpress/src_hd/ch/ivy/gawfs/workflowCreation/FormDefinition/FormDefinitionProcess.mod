...
' #txt
Ds0 f9 actionCode 'in.createInputFieldTab.id = in.createInputFieldTab.name + new DateTime();
...
out.activeTab=0;
' #txt
Ds0 f11 actionCode 'import ch.ivy.gawfs.DynaFormController;
...
' #txt
Ds0 f46 actionCode 'ivy.task.setName(ivy.cms.co("/Dialogs/Tasks/FormDefinition/TaskName"));
...
<> param = methodEvent.getInputArguments();
' #txt
Ds0 f49 inActionCode 'out.data.definedTasks.get(out.activeTaskIndex).setDynaFormController(out.dynaFormController);
...
' #txt
Ds0 f58 inActionCode 'out.data.definedTasks.get(out.activeTaskIndex).setDynaFormController(out.dynaFormController);
out.data.definedTasks.get(out.activeTaskIndex).setDragAndDropController(out.dragAndDropController);
...
' #txt
Ds0 f28 actionCode 'out.data.definedTasks.get(out.activeTaskIndex).setDynaFormController(out.dynaFormController);
out.data.definedTasks.get(out.activeTaskIndex).setDragAndDropController(out.dragAndDropController);' #txt
