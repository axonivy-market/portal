...
Ee0 f0 type ch.ivy.addon.express.generic.HandleEndPageData #txt
Ee0 f0 inParamDecl '<> param;' #txt
Ee0 f0 actionDecl 'ch.ivy.addon.express.generic.HandleEndPageData out;
' #txt
...
Ee0 f1 type ch.ivy.addon.express.generic.HandleEndPageData #txt
Ee0 f1 337 49 30 30 0 15 #rect
Ee0 f1 @|EndIcon #fIcon
Ee0 f3 targetWindow NEW #txt
Ee0 f3 targetDisplay TOP #txt
Ee0 f3 richDialogId ch.ivy.addon.express.generic.EndPage #txt
Ee0 f3 startMethod start() #txt
Ee0 f3 type ch.ivy.addon.express.generic.HandleEndPageData #txt
