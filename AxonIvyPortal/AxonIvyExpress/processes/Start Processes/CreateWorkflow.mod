...
TaskTriggered.PRI=2
TaskTriggered.DESC=<%\=ivy.cms.co("/Dialogs/Tasks/WorkflowProperties/TaskDescription")%>
TaskTriggered.NAM=<%\=ivy.cms.co("/Dialogs/Tasks/WorkflowProperties/TaskName")%>
TaskTriggered.EXROL=Everybody' #txt
cw0 f0 caseData 'case.name=<%\=ivy.cms.co("/Dialogs/workflowCreation/ProcessName")%>
