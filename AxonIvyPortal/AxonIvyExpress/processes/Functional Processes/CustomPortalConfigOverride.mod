[Ivy]
[>Created: Mon Apr 03 14:23:29 CEST 2017]
1580329F7E0D9C8F 3.20 #module
...
' #txt
Cg0 f0 actionDecl 'gawfs.CustomPortalConfigOverrideData out;
' #txt
Cg0 f0 callSignature call(ch.ivy.addon.portal.generic.PortalConfig) #txt
Cg0 f0 type gawfs.CustomPortalConfigOverrideData #txt
...
Cg0 f1 type gawfs.CustomPortalConfigOverrideData #txt
Cg0 f1 369 201 30 30 0 15 #rect
Cg0 f1 @|EndSubIcon #fIcon
Cg0 f5 actionDecl 'gawfs.CustomPortalConfigOverrideData out;
' #txt
Cg0 f5 actionTable 'out=in;
' #txt
Cg0 f5 actionCode 'import ch.ivy.addon.portal.generic.CustomPortalLink;

//in.portalConfig.homeLink = ivy.html.startref("Start Processes/PortalStartGAFWS/start.ivp");
in.portalConfig.homeLink = ivy.html.startref("Start Processes/PortalTaskListGAFWS/start.ivp");
...
in.portalConfig.hideCreateNewMenuItem = true;
in.portalConfig.hideDashboardMenuItem = false;
in.portalConfig.hideShowTaskMenuItem = false;
in.portalConfig.hideShowCaseMenuItem = false;


out.portalConfig.portalHomeLink = new CustomPortalLink();
out.portalConfig.portalHomeLink.displayName = "Verfügbare Prozesse";
out.portalConfig.portalHomeLink.url = ivy.html.startref("Start Processes/PortalStartGAFWS/start.ivp");
out.portalConfig.portalHomeLink.icon = "fa fa-home";

CustomPortalLink link1 = new CustomPortalLink();
link1.displayName = "Prozess erstellen";
link1.url = ivy.html.startref("Start Processes/CreateWorkflow/CreateNewWorkflow.ivp");
link1.icon = "fa fa-pencil";


CustomPortalLink link3 = new CustomPortalLink();
link3.displayName = "Gruppenverwaltung";
link3.url = ivy.html.startref("Start Processes/ManageUsergroups/ManageUsergroups.ivp");
link3.icon = "fa fa-users";


out.portalConfig.customLinkList.add(link1);
out.portalConfig.customLinkList.add(link3);
' #txt
Cg0 f5 type gawfs.CustomPortalConfigOverrideData #txt
...
' #txt
Cg0 f4 48 369 208 30 -95 -8 #rect
Cg0 f4 @|IBIcon #fIcon
Cg0 f6 152 369 91 230 #arcP
...
>Proto Cg0 .type gawfs.CustomPortalConfigOverrideData #txt
