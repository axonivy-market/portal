...
' #txt
Ps0 f9 actionCode 'import com.axonivy.portal.components.util.PortalNavigatorInFrameAPI;
...
>Proto Ps0 .type com.axonivy.portal.components.ProcessHistory.ProcessHistoryData #txt
