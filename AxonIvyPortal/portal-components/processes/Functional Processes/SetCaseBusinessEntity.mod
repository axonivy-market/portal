...
' #txt
Sd0 f3 actionCode 'import com.axonivy.portal.components.enums.AdditionalProperty;
...
>Proto Sd0 .type com.axonivy.portal.components.SetCaseBusinessEntityData #txt
