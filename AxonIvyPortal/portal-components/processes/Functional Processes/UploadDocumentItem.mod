...
' #txt
Ut0 f75 responseActionDecl 'com.axonivy.portal.components.UploadDocumentItemData out;
' #txt
...
>Proto Ut0 .type com.axonivy.portal.components.UploadDocumentItemData #txt
