...
Er0 f0 inParamDecl '<java.util.List<com.axonivy.portal.components.ivydata.exception.PortalIvyDataException> exceptions> param;' #txt
Er0 f0 inParamTable 'out.exceptions=param.exceptions;
' #txt
Er0 f0 outParamDecl '<> result;' #txt
Er0 f0 callSignature handle(java.util.List<com.axonivy.portal.components.ivydata.exception.PortalIvyDataException>) #txt
...
' #txt
Er0 f3 actionCode 'import com.axonivy.portal.components.ivydata.exception.PortalIvyDataException;
...
>Proto Er0 .type com.axonivy.portal.components.ErrorHandlerData #txt
