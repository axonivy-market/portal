...
' #txt
Pt0 f0 outParamDecl '<java.util.List<com.axonivy.portal.components.ivydata.exception.PortalIvyDataException> errors,java.util.List<com.axonivy.portal.components.dto.UserDTO> users> result;' #txt
...
' #txt
Pt0 f10 actionCode 'import com.axonivy.portal.components.service.RegisteredApplicationService;
...
Pt0 f24 processCall 'Functional Processes/PortalComponentErrorHandler:handle(java.util.List<com.axonivy.portal.components.ivydata.exception.PortalIvyDataException>)' #txt
Pt0 f24 requestActionDecl '<java.util.List<com.axonivy.portal.components.ivydata.exception.PortalIvyDataException> exceptions> param;' #txt
Pt0 f24 requestMappingAction 'param.exceptions=in.errors;
' #txt
Pt0 f24 responseActionDecl 'com.axonivy.portal.components.service.PortalComponentSecurityServiceData out;
' #txt
...
' #txt
Pt0 f20 actionCode 'import com.axonivy.portal.components.ivydata.service.impl.SecurityService;
...
out.startIndex=param.startIndex;
' #txt
Pt0 f19 outParamDecl '<java.util.List<com.axonivy.portal.components.ivydata.exception.PortalIvyDataException> errors,java.util.List<com.axonivy.portal.components.dto.UserDTO> users> result;' #txt
...
' #txt
Pt0 f25 actionCode 'import com.axonivy.portal.components.ivydata.service.impl.SecurityService;
import com.axonivy.portal.components.ivydata.dto.IvySecurityResultDTO;
...
Pt0 f28 processCall 'Functional Processes/PortalComponentErrorHandler:handle(java.util.List<com.axonivy.portal.components.ivydata.exception.PortalIvyDataException>)' #txt
Pt0 f28 requestActionDecl '<java.util.List<com.axonivy.portal.components.ivydata.exception.PortalIvyDataException> exceptions> param;' #txt
Pt0 f28 requestMappingAction 'param.exceptions=in.errors;
' #txt
Pt0 f28 responseActionDecl 'com.axonivy.portal.components.service.PortalComponentSecurityServiceData out;
' #txt
...
>Proto Pt0 .type com.axonivy.portal.components.service.PortalComponentSecurityServiceData #txt
