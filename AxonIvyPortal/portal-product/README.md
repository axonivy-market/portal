...
### Portal Showcase example
Now, start the **Showcase Application** process to see the UI example available in the **Axon Ivy Portal**.

![portal-example-demo](images/portal-example-demo.png)
