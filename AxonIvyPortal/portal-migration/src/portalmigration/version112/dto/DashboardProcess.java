...
import portalmigration.version112.bo.ExpressProcess;
import portalmigration.version112.bo.ExternalLinkProcessItem;
import portalmigration.version112.bo.PortalExpressProcess;
...
import portalmigration.version112.service.ProcessStartCollector;
import portalmigration.version112.util.CategoryUtils;

@JsonInclude(JsonInclude.Include.NON_NULL)
public class DashboardProcess implements portalmigration.version112.bo.Process {
  ...
  public DashboardProcess(portalmigration.version112.bo.Process process) {
  ...
  public String getIcon() {
    if (StringUtils.isBlank(icon)) {
      if (this.type == ProcessType.IVY_PROCESS) {
        return portalmigration.version112.bo.Process.DEFAULT_PROCESS_ICON;
