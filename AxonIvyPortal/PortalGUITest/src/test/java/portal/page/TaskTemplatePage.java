...
public class TaskTemplatePage extends TemplatePage {
  ...
  public int countNoteItems() {
    return findListElementsByCssSelector("span.history-note-content").size();
  }

  public int countHistoryItems() {
    return findListElementsByCssSelector("div[id='case-item:history:case-histories'] > div.grid-item-content-list-item").size();
  }
