...
public class TaskWidgetPage extends TemplatePage {
  ...
  private static final String KEYWORD_FILTER_SELECTOR = "input[id*='keyword-filter']";
  ...
  public CaseDocumentPage openCaseDocumentPage() {
    waitForElementDisplayed(By.xpath("//a[@href='#document-tab']"), true);
    click(findElementByXpath("//a[@href='#document-tab']"));
