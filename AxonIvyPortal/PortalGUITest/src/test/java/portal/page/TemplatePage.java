...
public abstract class TemplatePage extends AbstractPage {
  ...
  public MainMenuPage openMainMenu() {
    WebElement mainMenuSwitcher = findDisplayedElement("js-main-menu-switcher");
    if (!isMainMenuOpen()) {
  ...
  private WebElement findDisplayedElement(String id) {
    waitForElementDisplayed(By.id(id), true);
    WebElement mainMenuSwitcher = findElementById(id);
    return mainMenuSwitcher;
  }
  ...
  public void createTestingTasksInNewWindow() {
    ...
    String createTestingTasksUrl =
        UrlHelpers.generateAbsoluteProcessStartLink("internalSupport/14B2FC03D2E87141/CreateTestTasks.ivp");
