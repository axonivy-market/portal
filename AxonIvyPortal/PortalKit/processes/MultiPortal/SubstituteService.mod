[Ivy]
[>Created: Thu Feb 04 11:42:49 ICT 2016]
...
Se0 f87 type ch.ivyteam.wf.processes.SubstitueServiceData #txt
Se0 f87 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>server alive</name>
        <nameStyle>12,7
...
' #txt
Se0 f87 346 426 28 28 11 -29 #rect
Se0 f87 @|AlternativeIcon #fIcon
...
Se0 f101 expr in #txt
Se0 f101 374 440 488 227 #arcP
Se0 f101 1 488 440 #addKink
Se0 f101 1 0.5115178601655154 0 0 #arcLabel
Se0 f102 expr out #txt
Se0 f102 488 204 374 184 #arcP
Se0 f102 1 488 184 #addKink
Se0 f102 1 0.31135433052386374 0 0 #arcLabel
Se0 f70 expr out #txt
Se0 f70 64 364 64 402 #arcP
...
' #txt
Se0 f1 342 364 36 24 22 -14 #rect
Se0 f1 @|StepIcon #fIcon
Se0 f3 expr out #txt
Se0 f3 360 388 360 426 #arcP
...
Se0 f10 expr in #txt
Se0 f10 outCond 'in.isServerAlive && in.apps.size()>0' #txt
...
' #txt
Se0 f12 342 500 36 24 20 -2 #rect
Se0 f12 @|CallSubIcon #fIcon
Se0 f13 expr in #txt
Se0 f13 outCond 'in.isServerAlive && in.apps.size()>0' #txt
Se0 f13 360 454 360 500 #arcP
Se0 f4 expr out #txt
Se0 f4 378 512 488 227 #arcP
Se0 f4 1 521 512 #addKink
Se0 f4 2 520 256 #addKink
Se0 f4 1 0.24853206824128543 0 0 #arcLabel
...
Se0 f77 processCall MultiPortal/IsAliveService:getApplicationList(ch.ivy.addon.portalkit.persistence.domain.Server) #txt
...
Se0 f6 type ch.ivyteam.wf.processes.SubstitueServiceData #txt
Se0 f6 processCall MultiPortal/IsAliveService:getApplicationList(ch.ivy.addon.portalkit.persistence.domain.Server) #txt
Se0 f6 doCall true #txt
Se0 f6 requestActionDecl '<ch.ivy.addon.portalkit.persistence.domain.Server server> param;
' #txt
Se0 f6 requestMappingAction 'param.server=in.server;
' #txt
Se0 f6 responseActionDecl 'ch.ivyteam.wf.processes.SubstitueServiceData out;
' #txt
Se0 f6 responseMappingAction 'out=in;
out.applications=result.apps;
out.isServerAlive=result.isServerAlive;
out.tempErrors=result.errors;
' #txt
...
' #txt
Se0 f6 342 300 36 24 20 -2 #rect
Se0 f6 @|CallSubIcon #fIcon
...
Se0 f101 head f89 mainIn #connect
Se0 f89 mainOut f102 tail #connect
Se0 f102 head f91 in #connect
Se0 f65 mainOut f70 tail #connect
Se0 f70 head f60 in #connect
Se0 f1 mainOut f3 tail #connect
Se0 f3 head f87 in #connect
...
Se0 f87 out f13 tail #connect
Se0 f13 head f12 mainIn #connect
Se0 f87 out f101 tail #connect
...
Se0 f7 mainOut f22 tail #connect
Se0 f22 head f6 mainIn #connect
Se0 f91 out f23 tail #connect
Se0 f23 head f7 mainIn #connect
Se0 f6 mainOut f24 tail #connect
Se0 f24 head f1 mainIn #connect
