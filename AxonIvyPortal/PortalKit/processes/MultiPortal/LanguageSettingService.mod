[Ivy]
[>Created: Wed Mar 02 14:52:03 ICT 2016]
...
Ee0 f45 expr in #txt
Ee0 f45 398 360 544 180 #arcP
Ee0 f45 1 544 360 #addKink
Ee0 f45 0 0.9323942143200955 0 0 #arcLabel
Ee0 f36 expr out #txt
Ee0 f36 526 168 398 168 #arcP
Ee0 f24 expr in #txt
Ee0 f24 94 368 200 220 #arcP
Ee0 f24 1 200 368 #addKink
Ee0 f24 1 0.19141262989415814 0 0 #arcLabel
Ee0 f23 expr in #txt
Ee0 f23 outCond in.isServerAlive #txt
Ee0 f23 80 382 80 420 #arcP
...
Ee0 f10 type ch.ivyteam.wf.processes.LanguageSettingServiceData #txt
...
' #txt
Ee0 f10 66 354 28 28 12 -23 #rect
Ee0 f10 @|AlternativeIcon #fIcon
Ee0 f43 type ch.ivyteam.wf.processes.LanguageSettingServiceData #txt
Ee0 f43 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>server alive</name>
        <nameStyle>12,7
...
' #txt
Ee0 f43 370 346 28 28 12 -23 #rect
Ee0 f43 @|AlternativeIcon #fIcon
...
' #txt
Ee0 f11 62 420 36 24 22 -15 #rect
...
' #txt
Ee0 f46 366 404 36 24 26 -10 #rect
Ee0 f46 @|StepIcon #fIcon
Ee0 f47 expr in #txt
Ee0 f47 outCond in.isServerAlive #txt
Ee0 f47 384 374 384 404 #arcP
Ee0 f47 0 0.4877757256254838 0 0 #arcLabel
...
' #txt
Ee0 f54 366 460 36 24 20 -2 #rect
Ee0 f54 @|StepIcon #fIcon
Ee0 f55 expr out #txt
Ee0 f55 384 428 384 460 #arcP
...
' #txt
Ee0 f9 366 516 36 24 20 -2 #rect
Ee0 f9 @|CallSubIcon #fIcon
Ee0 f17 expr out #txt
Ee0 f17 384 484 384 516 #arcP
Ee0 f34 expr out #txt
Ee0 f34 402 528 562 168 #arcP
Ee0 f34 1 608 528 #addKink
Ee0 f34 2 608 168 #addKink
...
Ee0 f22 80 316 80 354 #arcP
Ee0 f2 type ch.ivyteam.wf.processes.LanguageSettingServiceData #txt
Ee0 f2 processCall MultiPortal/IsAliveService:getApplicationList(ch.ivy.addon.portalkit.persistence.domain.Server) #txt
Ee0 f2 doCall true #txt
Ee0 f2 requestActionDecl '<ch.ivy.addon.portalkit.persistence.domain.Server server> param;
' #txt
Ee0 f2 requestMappingAction 'param.server=in.server;
' #txt
Ee0 f2 responseActionDecl 'ch.ivyteam.wf.processes.LanguageSettingServiceData out;
' #txt
...
' #txt
Ee0 f2 366 284 36 24 20 -2 #rect
...
Ee0 f10 out f23 tail #connect
Ee0 f23 head f11 mainIn #connect
Ee0 f10 out f24 tail #connect
Ee0 f24 head f13 mainIn #connect
Ee0 f35 mainOut f36 tail #connect
Ee0 f36 head f28 in #connect
Ee0 f45 head f35 mainIn #connect
Ee0 f43 out f47 tail #connect
Ee0 f47 head f46 mainIn #connect
Ee0 f43 out f45 tail #connect
...
Ee0 f77 mainOut f22 tail #connect
Ee0 f22 head f10 in #connect
Ee0 f5 mainOut f7 tail #connect
Ee0 f7 head f2 mainIn #connect
Ee0 f28 out f31 tail #connect
Ee0 f31 head f5 mainIn #connect
Ee0 f2 mainOut f38 tail #connect
Ee0 f38 head f43 in #connect
