[Ivy]
[>Created: Mon Mar 07 15:40:36 ICT 2016]
...
Te0 @GridStep f53 '' #zField
Te0 @CallSub f57 '' #zField
Te0 @Alternative f52 '' #zField
Te0 @StartSub f62 '' #zField
Te0 @GridStep f63 '' #zField
Te0 @GridStep f61 '' #zField
Te0 @Alternative f54 '' #zField
Te0 @GridStep f56 '' #zField
Te0 @Alternative f60 '' #zField
Te0 @CallSub f55 '' #zField
Te0 @GridStep f58 '' #zField
...
Te0 f53 actionDecl 'ch.ivyteam.wf.processes.TaskServiceData out;
' #txt
Te0 f53 actionTable 'out=in;
' #txt
Te0 f53 actionCode 'import ch.ivy.ws.addon.WsException;
for(int i = 0 ; i < in.tempErrors.size() ; i++){
	WsException w = in.tempErrors.get(i) as WsException;
	w.server = in.server.name;
	in.tempErrors.set(i,w);
...
in.apps.clear();' #txt
Te0 f53 type ch.ivyteam.wf.processes.TaskServiceData #txt
...
' #txt
Te0 f53 1374 228 36 24 20 -2 #rect
Te0 f53 @|StepIcon #fIcon
Te0 f57 type ch.ivyteam.wf.processes.TaskServiceData #txt
Te0 f57 processCall ServiceIntegrators/TaskServiceIntegrator:findTasksByCriteria(ch.ivy.ws.addon.TaskSearchCriteria,String,ch.ivy.addon.portalkit.persistence.domain.Server) #txt
Te0 f57 doCall true #txt
Te0 f57 requestActionDecl '<ch.ivy.ws.addon.TaskSearchCriteria taskSearchCriteria,java.lang.String endpoint,ch.ivy.addon.portalkit.persistence.domain.Server server> param;
' #txt
Te0 f57 requestMappingAction 'param.taskSearchCriteria=in.taskSearchCriteria;
param.taskSearchCriteria.involvedApplications=in.apps;
param.endpoint=in.endpoint;
param.server=in.server;
' #txt
Te0 f57 responseActionDecl 'ch.ivyteam.wf.processes.TaskServiceData out;
' #txt
Te0 f57 responseMappingAction 'out=in;
out.ivyTasks=result.tasks;
out.tempErrors=result.errors;
' #txt
...
' #txt
Te0 f57 1270 580 36 24 20 -2 #rect
Te0 f57 @|CallSubIcon #fIcon
...
' #txt
Te0 f52 1274 170 28 28 22 -21 #rect
Te0 f52 @|AlternativeIcon #fIcon
...
' #txt
Te0 f62 1275 51 26 26 14 0 #rect
Te0 f62 @|StartSubIcon #fIcon
Te0 f63 actionDecl 'ch.ivyteam.wf.processes.TaskServiceData out;
' #txt
Te0 f63 actionTable 'out=in;
' #txt
Te0 f63 actionCode 'import ch.ivy.addon.portalkit.persistence.domain.Application;
import ch.ivy.addon.portalkit.service.PortalConnectorDetector;
import ch.ivy.addon.portalkit.service.ApplicationService;
import ch.ivy.ws.addon.IvyApplication;
import ch.ivy.addon.portalkit.service.UserService;
...
' #txt
Te0 f63 1270 420 36 24 21 -18 #rect
Te0 f63 @|StepIcon #fIcon
Te0 f61 actionDecl 'ch.ivyteam.wf.processes.TaskServiceData out;
' #txt
Te0 f61 actionTable 'out=in;
' #txt
Te0 f61 actionCode 'import ch.ivy.addon.portalkit.persistence.domain.Application;
import ch.ivy.addon.portalkit.bo.RemoteTask;
import ch.ivy.addon.portalkit.mapper.RemoteTaskMapper;
...
' #txt
Te0 f61 1270 652 36 24 20 -2 #rect
Te0 f61 @|StepIcon #fIcon
...
' #txt
Te0 f54 1274 498 28 28 14 0 #rect
Te0 f54 @|AlternativeIcon #fIcon
...
' #txt
Te0 f56 1270 116 36 24 20 -2 #rect
...
' #txt
Te0 f60 1274 362 28 28 11 -29 #rect
Te0 f60 @|AlternativeIcon #fIcon
Te0 f55 type ch.ivyteam.wf.processes.TaskServiceData #txt
Te0 f55 processCall MultiPortal/IsAliveService:getApplicationList(ch.ivy.addon.portalkit.persistence.domain.Server) #txt
Te0 f55 doCall true #txt
Te0 f55 requestActionDecl '<ch.ivy.addon.portalkit.persistence.domain.Server server> param;
' #txt
Te0 f55 requestMappingAction 'param.server=in.server;
' #txt
Te0 f55 responseActionDecl 'ch.ivyteam.wf.processes.TaskServiceData out;
' #txt
Te0 f55 responseMappingAction 'out=in;
out.applications=result.apps;
out.isServerAlive=result.isServerAlive;
out.tempErrors=result.errors;
' #txt
...
' #txt
Te0 f55 1270 292 36 24 20 -2 #rect
Te0 f55 @|CallSubIcon #fIcon
Te0 f58 actionDecl 'ch.ivyteam.wf.processes.TaskServiceData out;
' #txt
Te0 f58 actionTable 'out=in;
' #txt
Te0 f58 actionCode 'import ch.ivy.addon.portalkit.persistence.domain.Server;
...
' #txt
Te0 f58 1270 228 36 24 20 -2 #rect
Te0 f58 @|StepIcon #fIcon
Te0 f65 expr in #txt
Te0 f65 outCond in.isServerAlive #txt
Te0 f65 1288 390 1288 420 #arcP
Te0 f66 expr out #txt
Te0 f66 1306 664 1392 252 #arcP
Te0 f66 1 1392 664 #addKink
Te0 f66 1 0.4321413036724042 0 0 #arcLabel
Te0 f67 expr in #txt
Te0 f67 1302 376 1392 252 #arcP
Te0 f67 1 1392 376 #addKink
Te0 f67 1 0.5115178601655154 0 0 #arcLabel
Te0 f68 expr out #txt
Te0 f68 1392 228 1302 184 #arcP
Te0 f68 1 1392 184 #addKink
Te0 f68 1 0.31135433052386374 0 0 #arcLabel
Te0 f69 expr out #txt
Te0 f69 1288 444 1288 498 #arcP
Te0 f70 expr in #txt
Te0 f70 1302 512 1392 252 #arcP
Te0 f70 1 1392 512 #addKink
Te0 f70 0 0.9540356379241759 0 0 #arcLabel
Te0 f71 expr in #txt
Te0 f71 outCond 'in.apps.size() > 0' #txt
Te0 f71 1288 526 1288 580 #arcP
Te0 f72 expr out #txt
Te0 f72 1288 604 1288 652 #arcP
Te0 f73 expr out #txt
Te0 f73 1288 77 1288 116 #arcP
Te0 f74 expr out #txt
Te0 f74 1288 140 1288 170 #arcP
Te0 f75 expr out #txt
Te0 f75 1288 252 1288 292 #arcP
Te0 f76 expr in #txt
Te0 f76 outCond in.listIterator.hasNext() #txt
Te0 f76 1288 198 1288 228 #arcP
Te0 f78 expr out #txt
Te0 f78 1288 316 1288 362 #arcP
...
' #txt
Te0 f81 1462 372 36 24 20 -2 #rect
...
' #txt
Te0 f82 1462 116 36 24 20 -2 #rect
...
' #txt
Te0 f83 1462 244 36 24 20 -2 #rect
...
' #txt
Te0 f84 1467 51 26 26 14 0 #rect
...
' #txt
Te0 f85 1462 308 36 24 20 -2 #rect
...
' #txt
Te0 f86 1466 178 28 28 8 -27 #rect
Te0 f86 @|AlternativeIcon #fIcon
Te0 f87 expr in #txt
Te0 f87 1494 192 1498 384 #arcP
Te0 f87 1 1624 192 #addKink
Te0 f87 2 1624 384 #addKink
Te0 f87 0 0.9217931257916813 0 0 #arcLabel
Te0 f89 expr out #txt
Te0 f89 1480 332 1480 372 #arcP
Te0 f90 expr in #txt
Te0 f90 outCond in.isServerAlive #txt
Te0 f90 1480 206 1480 244 #arcP
Te0 f91 expr out #txt
Te0 f91 1480 268 1480 308 #arcP
Te0 f92 expr out #txt
Te0 f92 1480 77 1480 116 #arcP
Te0 f93 expr out #txt
Te0 f93 1480 140 1480 178 #arcP
Te0 f94 actionDecl 'ch.ivyteam.wf.processes.TaskServiceData out;
' #txt
Te0 f94 actionTable 'out=in;
' #txt
Te0 f94 actionCode 'import ch.ivy.addon.portalkit.comparator.TaskNameComparator;

if (in.tasks.size() > 1){
	in.tasks.sort(new TaskNameComparator());
}
' #txt
Te0 f94 type ch.ivyteam.wf.processes.TaskServiceData #txt
Te0 f94 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Te0 f94 1206 580 36 24 -47 26 #rect
Te0 f94 @|StepIcon #fIcon
Te0 f95 expr in #txt
Te0 f95 1274 184 1224 580 #arcP
Te0 f95 1 1224 184 #addKink
Te0 f95 1 0.4697017091790999 0 0 #arcLabel
...
' #txt
Te0 f96 1675 51 26 26 14 0 #rect
...
' #txt
Te0 f97 1670 116 36 24 20 -2 #rect
Te0 f97 @|CallSubIcon #fIcon
Te0 f98 expr out #txt
Te0 f98 1688 77 1688 116 #arcP
...
' #txt
Te0 f99 1674 178 28 28 16 -24 #rect
Te0 f99 @|AlternativeIcon #fIcon
Te0 f100 expr out #txt
Te0 f100 1688 140 1688 178 #arcP
...
' #txt
Te0 f101 1670 244 36 24 20 -2 #rect
...
' #txt
Te0 f102 1688 206 1688 244 #arcP
...
' #txt
Te0 f103 1670 308 36 24 20 -2 #rect
Te0 f103 @|CallSubIcon #fIcon
Te0 f104 expr out #txt
Te0 f104 1688 268 1688 308 #arcP
...
' #txt
Te0 f105 1670 372 36 24 14 9 #rect
...
' #txt
Te0 f109 1702 192 1706 384 #arcP
Te0 f109 1 1872 192 #addKink
Te0 f109 2 1872 384 #addKink
...
Te0 f42 1224 604 796 734 #arcP
Te0 f42 1 1224 672 #addKink
Te0 f42 1 0.4697017091790999 0 0 #arcLabel
Te0 f64 expr out #txt
Te0 f64 1480 396 797 735 #arcP
Te0 f64 1 1480 688 #addKink
Te0 f64 1 0.2885922078745302 0 0 #arcLabel
Te0 f88 expr out #txt
Te0 f88 1688 396 798 736 #arcP
Te0 f88 1 1688 704 #addKink
...
Te0 f12 inParamDecl '<ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Long caseId> param;' #txt
...
' #txt
Te0 f12 callSignature findTasksOfCase(ch.ivy.addon.portalkit.persistence.domain.Server,Long) #txt
...
' #txt
Te0 f12 1955 51 26 26 14 0 #rect
...
' #txt
Te0 f59 1950 116 36 24 20 -2 #rect
...
' #txt
Te0 f80 1950 244 36 24 20 -2 #rect
...
' #txt
Te0 f106 1954 178 28 28 16 -24 #rect
Te0 f106 @|AlternativeIcon #fIcon
Te0 f110 type ch.ivyteam.wf.processes.TaskServiceData #txt
Te0 f110 processCall ServiceIntegrators/TaskServiceIntegrator:findTasksOfCase(String,ch.ivy.addon.portalkit.persistence.domain.Server,Long) #txt
Te0 f110 doCall true #txt
Te0 f110 requestActionDecl '<java.lang.String endpoint,ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Long caseId> param;
' #txt
Te0 f110 requestMappingAction 'param.endpoint=in.endpoint;
param.server=in.server;
...
' #txt
Te0 f110 1950 308 36 24 20 -2 #rect
...
' #txt
Te0 f111 1950 468 36 24 14 9 #rect
Te0 f111 @|StepIcon #fIcon
Te0 f112 expr out #txt
Te0 f112 1968 140 1968 178 #arcP
...
' #txt
Te0 f124 1982 192 1986 480 #arcP
Te0 f124 1 2178 192 #addKink
Te0 f124 2 2178 480 #addKink
Te0 f124 1 0.16145833333333334 -9 0 #arcLabel
Te0 f128 expr out #txt
Te0 f128 1968 77 1968 116 #arcP
Te0 f142 expr out #txt
Te0 f142 1968 492 798 736 #arcP
Te0 f142 1 1968 712 #addKink
Te0 f142 0 0.7590874101950051 0 0 #arcLabel
Te0 f108 expr out #txt
Te0 f108 1688 332 1688 372 #arcP
Te0 f143 actionDecl 'ch.ivyteam.wf.processes.TaskServiceData out;
' #txt
Te0 f143 actionTable 'out=in;
' #txt
Te0 f143 actionCode 'import ch.ivy.addon.portalkit.bo.RemoteTask;
import ch.ivy.addon.portalkit.mapper.RemoteTaskMapper;
...
' #txt
Te0 f143 1950 380 36 24 20 -2 #rect
Te0 f143 @|StepIcon #fIcon
Te0 f146 expr out #txt
Te0 f146 1968 332 1968 380 #arcP
Te0 f116 expr out #txt
Te0 f116 1968 404 1968 468 #arcP
...
Te0 f60 out f65 tail #connect
Te0 f65 head f63 mainIn #connect
Te0 f61 mainOut f66 tail #connect
Te0 f66 head f53 mainIn #connect
Te0 f60 out f67 tail #connect
Te0 f67 head f53 mainIn #connect
Te0 f53 mainOut f68 tail #connect
Te0 f68 head f52 in #connect
Te0 f63 mainOut f69 tail #connect
Te0 f69 head f54 in #connect
Te0 f70 head f53 mainIn #connect
Te0 f54 out f71 tail #connect
Te0 f71 head f57 mainIn #connect
Te0 f54 out f70 tail #connect
Te0 f57 mainOut f72 tail #connect
Te0 f72 head f61 mainIn #connect
Te0 f62 mainOut f73 tail #connect
Te0 f73 head f56 mainIn #connect
Te0 f56 mainOut f74 tail #connect
Te0 f74 head f52 in #connect
Te0 f58 mainOut f75 tail #connect
Te0 f75 head f55 mainIn #connect
Te0 f52 out f76 tail #connect
Te0 f76 head f58 mainIn #connect
Te0 f55 mainOut f78 tail #connect
Te0 f78 head f60 in #connect
...
Te0 f52 out f95 tail #connect
Te0 f95 head f94 mainIn #connect
...
Te0 f94 mainOut f42 tail #connect
Te0 f42 head f148 in #connect
