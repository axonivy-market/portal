[Ivy]
[>Created: Fri Jun 23 15:21:03 ICT 2017]
15CD32368377F097 3.20 #module
>Proto >Proto Collection #zClass
Pt0 WebStartableService Big #zClass
Pt0 B #cInfo
Pt0 #process
...
>Proto Pt0 Pt0 WebStartableService #zField
Pt0 f4 actionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
...
if (!in.apps.isEmpty()) {
	in.webStartableSearchCriteria.involvedApplications = in.apps.clear();
}' #txt
Pt0 f4 type ch.ivyteam.wf.processes.WebStartableData #txt
...
Pt0 f5 type ch.ivyteam.wf.processes.WebStartableData #txt
Pt0 f5 processCall ServiceIntegrators/WebStartableServiceIntegrator:findWebStartablesByCriteria(String,String,ch.ivy.ws.addon.WebStartableSearchCriteria,ch.ivy.addon.portalkit.persistence.domain.Server) #txt
Pt0 f5 doCall true #txt
Pt0 f5 requestActionDecl '<java.lang.String endpoint,java.lang.String language,ch.ivy.ws.addon.WebStartableSearchCriteria webStartableSearchCriteria,ch.ivy.addon.portalkit.persistence.domain.Server server> param;
' #txt
...
' #txt
Pt0 f5 responseActionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
Pt0 f5 responseMappingAction 'out=in;
out.ivyWebStartables=result.webStartables;
out.tempErrors=result.errors;
' #txt
Pt0 f5 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>WebStartableServiceIntegrator</name>
    </language>
</elementInfo>
' #txt
Pt0 f5 174 564 36 24 20 -2 #rect
Pt0 f5 @|CallSubIcon #fIcon
Pt0 f12 actionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
...
java.util.List<String> apps = userService.findApplicationNamesUserCanWorkOn(in.webStartableSearchCriteria.involvedUsername, in.server.id);
...
in.webStartableSearchCriteria.involvedApplications = in.apps;' #txt
Pt0 f12 type ch.ivyteam.wf.processes.WebStartableData #txt
...
Pt0 f20 actionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
...
List<Server> servers;
Long serverId = in.webStartableSearchCriteria.#serverId;
...
Pt0 f20 type ch.ivyteam.wf.processes.WebStartableData #txt
...
Pt0 f21 type ch.ivyteam.wf.processes.WebStartableData #txt
...
Pt0 f28 actionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
Pt0 f28 actionTable 'out=in;
' #txt
Pt0 f28 actionCode 'import ch.ivy.addon.portalkit.mapper.RemoteWebStartableMapper;

if (in.tempErrors.isEmpty()) {
	in.webStartables.addAll(RemoteWebStartableMapper.mapWebStartables(in.ivyWebStartables));
}' #txt
Pt0 f28 type ch.ivyteam.wf.processes.WebStartableData #txt
...
' #txt
Pt0 f28 174 628 36 24 20 -2 #rect
Pt0 f28 @|StepIcon #fIcon
Pt0 f29 actionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
...
Pt0 f29 type ch.ivyteam.wf.processes.WebStartableData #txt
...
Pt0 f30 210 640 384 204 #arcP
Pt0 f30 1 384 640 #addKink
Pt0 f30 1 0.21281805234667672 0 0 #arcLabel
Pt0 f36 expr out #txt
Pt0 f36 192 588 192 628 #arcP
Pt0 f38 expr out #txt
Pt0 f38 192 148 192 178 #arcP
Pt0 f37 expr out #txt
Pt0 f37 192 77 192 124 #arcP
Pt0 f11 inParamDecl '<java.lang.String language,ch.ivy.ws.addon.WebStartableSearchCriteria webStartableSearchCriteria> param;' #txt
Pt0 f11 inParamTable 'out.language=param.language;
out.webStartableSearchCriteria=param.webStartableSearchCriteria;
' #txt
Pt0 f11 outParamDecl '<List<ch.ivy.ws.addon.WsException> errors,List<ch.ivy.addon.portalkit.bo.RemoteWebStartable> webStartables> result;
' #txt
Pt0 f11 outParamTable 'result.errors=in.errors;
result.webStartables=in.webStartables;
' #txt
Pt0 f11 actionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
Pt0 f11 callSignature findWebStartablesByCriteria(String,ch.ivy.ws.addon.WebStartableSearchCriteria) #txt
Pt0 f11 type ch.ivyteam.wf.processes.WebStartableData #txt
Pt0 f11 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>findWebStartablesByCriteria(String,WebStartableSearchCriteria)</name>
        <nameStyle>62,5,7
</nameStyle>
    </language>
</elementInfo>
...
Pt0 f94 actionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
Pt0 f94 actionTable 'out=in;
' #txt
Pt0 f94 actionCode 'import ch.ivy.addon.portalkit.comparator.WebStartableNameComparator;

if (in.webStartables.size() > 1){
	in.webStartables.sort(new WebStartableNameComparator());
}
' #txt
Pt0 f94 type ch.ivyteam.wf.processes.WebStartableData #txt
...
Pt0 f34 type ch.ivyteam.wf.processes.WebStartableData #txt
Pt0 f34 179 739 26 26 14 0 #rect
Pt0 f34 @|EndSubIcon #fIcon
Pt0 f144 type ch.ivyteam.wf.processes.WebStartableData #txt
...
' #txt
Pt0 f144 responseActionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
...
' #txt
Pt0 f144 174 692 36 24 20 -2 #rect
Pt0 f144 @|CallSubIcon #fIcon
Pt0 f44 expr out #txt
Pt0 f44 192 716 192 739 #arcP
Pt0 f0 expr out #txt
Pt0 f0 366 192 206 192 #arcP
Pt0 f2 expr out #txt
Pt0 f2 64 364 174 704 #arcP
Pt0 f2 1 64 704 #addKink
Pt0 f2 1 0.7686360130156248 0 0 #arcLabel
Pt0 f3 type ch.ivyteam.wf.processes.WebStartableData #txt
...
' #txt
Pt0 f3 responseActionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
...
Pt0 f1 type ch.ivyteam.wf.processes.WebStartableData #txt
...
Pt0 f7 expr in #txt
Pt0 f7 outCond in.webStartableSearchCriteria.involvedApplications.isEmpty() #txt
Pt0 f7 192 334 192 372 #arcP
Pt0 f13 actionDecl 'ch.ivyteam.wf.processes.WebStartableData out;
' #txt
...
in.endpoint = detector.getPortalConnectorURLOf(in.server) + WebServiceEndPoint.WEB_STARTABLE.toString();' #txt
Pt0 f13 type ch.ivyteam.wf.processes.WebStartableData #txt
...
Pt0 f15 192 524 192 564 #arcP
>Proto Pt0 .type ch.ivyteam.wf.processes.WebStartableData #txt
...
Pt0 f15 head f5 mainIn #connect
