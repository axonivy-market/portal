[Ivy]
[>Created: Mon Nov 16 11:07:44 ICT 2015]
...
Se0 f3 processCall SynchronizeDataProcesses/SynchronizingTriggerProcess:addOrUpdate(Boolean,String,List<ch.ivy.ws.addon.CustomPropertyPair>) #txt
Se0 f3 doCall true #txt
Se0 f3 requestActionDecl '<java.lang.Boolean isNTLMAuthentication,java.lang.String serverURL,List<ch.ivy.ws.addon.CustomPropertyPair> customPropertiesPair> param;
' #txt
Se0 f3 requestMappingAction 'param.isNTLMAuthentication=in.servers.get(in.counter).isNTLMAuthentication;
param.serverURL=in.servers.get(in.counter).getPath();
...
Se0 f20 processCall SynchronizeDataProcesses/SynchronizingTriggerProcess:delete(Boolean,String,String) #txt
Se0 f20 doCall true #txt
Se0 f20 requestActionDecl '<java.lang.Boolean isNTLMAuthentication,java.lang.String serverURL,java.lang.String key> param;
' #txt
Se0 f20 requestMappingAction 'param.isNTLMAuthentication=in.servers.get(in.counter).isNTLMAuthentication;
param.serverURL=in.servers.get(in.counter).getPath();
param.key=in.keyToBeDeleted;
' #txt
...
Se0 f37 processCall SynchronizeDataProcesses/SynchronizingTriggerProcess:deleteByPrefix(Boolean,String,String) #txt
Se0 f37 doCall true #txt
Se0 f37 requestActionDecl '<java.lang.Boolean isNTLMAuthentication,java.lang.String serverURL,java.lang.String keyPrefix> param;
' #txt
Se0 f37 requestMappingAction 'param.isNTLMAuthentication=in.servers.get(in.counter).isNTLMAuthentication;
param.serverURL=in.servers.get(in.counter).getPath();
...
Se0 f52 processCall SynchronizeDataProcesses/SynchronizingTriggerProcess:deleteManyProperties(Boolean,String,List<String>) #txt
Se0 f52 doCall true #txt
Se0 f52 requestActionDecl '<java.lang.Boolean isNTLMAuthentication,java.lang.String serverURL,List<java.lang.String> keys> param;
' #txt
Se0 f52 requestMappingAction 'param.isNTLMAuthentication=in.servers.get(in.counter).isNTLMAuthentication;
param.serverURL=in.servers.get(in.counter).getPath();
