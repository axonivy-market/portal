...
' #txt
Dt0 f0 actionDecl 'ch.ivy.addon.portalkit.DefaultChartData out;
' #txt
Dt0 f0 callSignature createDefaultChart() #txt
Dt0 f0 type ch.ivy.addon.portalkit.DefaultChartData #txt
...
Dt0 f1 type ch.ivy.addon.portalkit.DefaultChartData #txt
