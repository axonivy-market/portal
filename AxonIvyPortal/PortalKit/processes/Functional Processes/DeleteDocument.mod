...
' #txt
Dt0 f0 actionDecl 'ch.ivy.add.portalkit.DeleteDocumentData out;
' #txt
Dt0 f0 callSignature call(ch.ivyteam.ivy.workflow.ICase,ch.ivy.addon.portalkit.ivydata.bo.IvyDocument) #txt
Dt0 f0 type ch.ivy.add.portalkit.DeleteDocumentData #txt
...
Dt0 f1 type ch.ivy.add.portalkit.DeleteDocumentData #txt
Dt0 f1 337 49 30 30 0 15 #rect
Dt0 f1 @|EndSubIcon #fIcon
Dt0 f3 actionDecl 'ch.ivy.add.portalkit.DeleteDocumentData out;
' #txt
...
Dt0 f3 type ch.ivy.add.portalkit.DeleteDocumentData #txt
...
>Proto Dt0 .type ch.ivy.add.portalkit.DeleteDocumentData #txt
