...
try {
	...
	if (CollectionUtils.isEmpty(users)) {
		...
		String resetUrl = UrlUtils.getServerUrl() + PortalNavigator.getPasswordResetUrl(token, in.user.getName());
...
Sl0 f9 type portalkit.SendPasswordResetEmailData #txt
...
' #txt
Sl0 f5 attachedToRef 1764192CC5D94D93-f9 #txt
...
Sl0 f7 1 0.2153944107831828 0 0 #arcLabel
Sl0 f8 912 128 960 79 #arcP
Sl0 f8 1 960 128 #addKink
Sl0 f8 0 0.8599159434166511 0 0 #arcLabel
>Proto Sl0 .type portalkit.SendPasswordResetEmailData #txt
