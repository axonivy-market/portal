...
' #txt
Ln0 f0 actionDecl 'ch.ivy.add.portalkit.LoginData out;
' #txt
Ln0 f0 callSignature call() #txt
Ln0 f0 type ch.ivy.add.portalkit.LoginData #txt
...
Ln0 f1 type ch.ivy.add.portalkit.LoginData #txt
