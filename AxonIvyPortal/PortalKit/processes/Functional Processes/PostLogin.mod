...
' #txt
Pn0 f0 actionDecl 'ch.ivy.add.portalkit.PostLoginData out;
' #txt
Pn0 f0 callSignature call() #txt
Pn0 f0 type ch.ivy.add.portalkit.PostLoginData #txt
...
Pn0 f1 type ch.ivy.add.portalkit.PostLoginData #txt
...
Pn0 f3 @|IBIcon #fIcon
Pn0 f4 216 137 224 64 #arcP
>Proto Pn0 .type ch.ivy.add.portalkit.PostLoginData #txt
