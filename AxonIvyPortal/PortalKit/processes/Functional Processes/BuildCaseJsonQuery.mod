...
' #txt
By0 f0 actionDecl 'ch.ivy.add.portalkit.BuildCaseJsonQueryData out;
' #txt
By0 f0 callSignature buildCaseJsonQuery() #txt
By0 f0 type ch.ivy.add.portalkit.BuildCaseJsonQueryData #txt
...
By0 f1 type ch.ivy.add.portalkit.BuildCaseJsonQueryData #txt
By0 f1 77 361 30 30 0 15 #rect
By0 f1 @|EndSubIcon #fIcon
By0 f3 actionDecl 'ch.ivy.add.portalkit.BuildCaseJsonQueryData out;
' #txt
By0 f3 actionTable 'out=in;
' #txt
By0 f3 type ch.ivy.add.portalkit.BuildCaseJsonQueryData #txt
...
>Proto By0 .type ch.ivy.add.portalkit.BuildCaseJsonQueryData #txt
