...
>Proto Pe0 Pe0 WebStartableServiceIntegrator #zField
Pe0 f0 .resExport export #txt
Pe0 f0 actionDecl 'ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData out;
' #txt
Pe0 f0 actionTable 'out=in;
' #txt
Pe0 f0 actionCode ivy.log.fatal(exception); #txt
Pe0 f0 type ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData #txt
...
Pe0 f1 type ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData #txt
Pe0 f1 691 179 26 26 14 0 #rect
Pe0 f1 @|EndSubIcon #fIcon
Pe0 f2 expr out #txt
Pe0 f2 704 77 704 179 #arcP
Pe0 f6 type ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData #txt
Pe0 f6 211 339 26 26 14 0 #rect
Pe0 f6 @|EndSubIcon #fIcon
Pe0 f7 type ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData #txt
Pe0 f7 actionDecl 'ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData out;
' #txt
Pe0 f7 actionTable 'out=in;
out.errors=wsResponse.findWebStartablesByCriteriaResponse.result.errors;
...
KEY_OPERATION=findWebStartablesByCriteria
KEY_AUTHENTICATION_KIND=4
KEY_HOST=<%\\=in.server.host%>
KEY_USE_AUTHENTICATION=true
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.findWebStartablesByCriteria.language__@@__String__@@__in.language"",""arg0.findWebStartablesByCriteria.webStartableSearchCriteria__@@__ch.ivy.ws.addon.WebStartableSearchCriteria__@@__in.webStartableSearchCriteria"""' #txt
Pe0 f7 exceptionHandler 15CD315921044A92-f0-buffer #txt
Pe0 f7 timeoutExceptionHandler 15CD315921044A92-f0-buffer #txt
...
Pe0 f8 type ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData #txt
Pe0 f8 actionDecl 'ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData out;
' #txt
...
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.findWebStartablesByCriteria.language__@@__String__@@__in.language"",""arg0.findWebStartablesByCriteria.webStartableSearchCriteria__@@__ch.ivy.ws.addon.WebStartableSearchCriteria__@@__in.webStartableSearchCriteria"""' #txt
Pe0 f8 exceptionHandler 15CD315921044A92-f0-buffer #txt
Pe0 f8 timeoutExceptionHandler 15CD315921044A92-f0-buffer #txt
...
Pe0 f9 inParamDecl '<java.lang.String endpoint,java.lang.String language,ch.ivy.ws.addon.WebStartableSearchCriteria webStartableSearchCriteria,ch.ivy.addon.portalkit.persistence.domain.Server server> param;' #txt
...
' #txt
Pe0 f9 outParamDecl '<List<ch.ivy.ws.addon.IvyWebStartable> webStartables,List<ch.ivy.ws.addon.WsException> errors> result;
' #txt
Pe0 f9 outParamTable 'result.webStartables=in.webStartables;
result.errors=in.errors;
' #txt
Pe0 f9 actionDecl 'ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData out;
' #txt
Pe0 f9 callSignature findWebStartablesByCriteria(String,String,ch.ivy.ws.addon.WebStartableSearchCriteria,ch.ivy.addon.portalkit.persistence.domain.Server) #txt
Pe0 f9 type ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData #txt
Pe0 f9 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>findWebStartablesByCriteria(String,String,WebStartableSearchCriteria,Server)</name>
    </language>
</elementInfo>
' #txt
Pe0 f9 211 51 26 26 14 0 #rect
Pe0 f9 @|StartSubIcon #fIcon
Pe0 f10 type ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData #txt
...
Pe0 f3 type ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData #txt
Pe0 f3 actionDecl 'ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData out;
' #txt
...
KEY_USE_AUTHENTICATION=true
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.findWebStartablesByCriteria.language__@@__String__@@__in.language"",""arg0.findWebStartablesByCriteria.webStartableSearchCriteria__@@__ch.ivy.ws.addon.WebStartableSearchCriteria__@@__in.webStartableSearchCriteria"""' #txt
Pe0 f3 exceptionHandler 15CD315921044A92-f0-buffer #txt
Pe0 f3 timeoutExceptionHandler 15CD315921044A92-f0-buffer #txt
...
>Proto Pe0 .type ch.ivy.add.portalkit.service.integrators.WebStartableServiceIntegratorData #txt
