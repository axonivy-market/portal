[Ivy]
[>Created: Fri Feb 26 15:07:24 ICT 2016]
...
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.findProcessesStartsByCriteria.processSearchCriteria__@@__ch.ivy.ws.addon.ProcessSearchCriteria__@@__in.processSearchCriteria"",""arg0.findProcessesStartsByCriteria.serverUrl__@@__String__@@__in.serverUrl"""' #txt
...
Pe0 f9 inParamDecl '<java.lang.String endpoint,ch.ivy.ws.addon.ProcessSearchCriteria processSearchCriteria,ch.ivy.addon.portalkit.persistence.domain.Server server> param;' #txt
...
' #txt
Pe0 f9 callSignature findProcessStartsByCriteria(String,ch.ivy.ws.addon.ProcessSearchCriteria,ch.ivy.addon.portalkit.persistence.domain.Server) #txt
...
Pe0 f14 expr in #txt
Pe0 f14 142 192 416 260 #arcP
Pe0 f14 1 416 192 #addKink
Pe0 f14 0 0.7302200350148694 0 0 #arcLabel
