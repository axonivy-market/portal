[Ivy]
[>Created: Wed Mar 09 11:44:15 ICT 2016]
...
Te0 f85 inParamDecl '<java.lang.String userName,java.lang.String endpoint,ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Long caseId> param;' #txt
...
' #txt
Te0 f85 callSignature findTasksOfCase(String,String,ch.ivy.addon.portalkit.persistence.domain.Server,Long) #txt
...
KEY_HOST=
KEY_USE_AUTHENTICATION=false
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.findTasksOfCase.id__@@__Long__@@__in.caseId"",""arg0.findTasksOfCase.serverUrl__@@__String__@@__in.serverUrl"",""arg0.findTasksOfCase.username__@@__String__@@__in.userName"""' #txt
