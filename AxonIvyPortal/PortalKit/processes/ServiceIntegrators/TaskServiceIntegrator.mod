[Ivy]
[>Created: Fri Sep 30 15:26:50 ICT 2016]
...
' #txt
Te0 f12 1234 178 28 28 14 0 #rect
...
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.resetTask.currentUserName__@@__String__@@__ivy.session.getSessionUserName()"",""arg0.resetTask.id__@@__Long__@@__in.taskId"",""arg0.resetTask.isNoConfigurationMode__@@__Boolean__@@__in.isNoConfigurationMode"",""arg0.resetTask.serverUrl__@@__String__@@__in.serverUrl"""' #txt
...
' #txt
Te0 f18 1248 206 1248 276 #arcP
Te0 f19 expr out #txt
Te0 f19 1248 300 1248 371 #arcP
...
' #txt
Te0 f20 1422 276 36 24 20 -2 #rect
Te0 f20 @|WebServiceIcon #fIcon
Te0 f22 expr out #txt
Te0 f22 1440 300 1261 384 #arcP
Te0 f22 1 1440 384 #addKink
...
' #txt
Te0 f25 1746 178 28 28 14 0 #rect
...
' #txt
Te0 f27 1902 276 36 24 19 -3 #rect
...
' #txt
Te0 f29 1760 206 1760 276 #arcP
Te0 f29 0 0.22857142857142856 -16 0 #arcLabel
Te0 f30 expr out #txt
Te0 f30 1760 300 1760 371 #arcP
Te0 f32 expr out #txt
Te0 f32 1920 300 1773 384 #arcP
Te0 f32 1 1920 384 #addKink
...
Te0 f33 243 851 26 26 14 0 #rect
...
KEY_HOST=
KEY_USE_AUTHENTICATION=false
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.findTasksByCriteria.count__@@__Integer__@@__in.count"",""arg0.findTasksByCriteria.isNoConfigurationMode__@@__Boolean__@@__in.isNoConfigurationMode"",""arg0.findTasksByCriteria.serverId__@@__Long__@@__in.server.id"",""arg0.findTasksByCriteria.serverUrl__@@__String__@@__in.serverUrl"",""arg0.findTasksByCriteria.startIndex__@@__Integer__@@__in.startIndex"",""arg0.findTasksByCriteria.taskSearchCriteria__@@__ch.ivy.ws.addon.TaskSearchCriteria__@@__in.taskSearchCriteria"""' #txt
...
' #txt
Te0 f34 398 756 36 24 20 -2 #rect
Te0 f34 @|WebServiceIcon #fIcon
Te0 f35 inParamDecl '<java.lang.Boolean isNoConfigurationMode,ch.ivy.ws.addon.TaskSearchCriteria taskSearchCriteria,java.lang.String endpoint,ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Integer startIndex,java.lang.Integer count> param;' #txt
Te0 f35 inParamTable 'out.count=param.count;
out.endpoint=param.endpoint;
out.isNoConfigurationMode=param.isNoConfigurationMode;
out.server=param.server;
...
' #txt
Te0 f35 callSignature findTasksByCriteria(Boolean,ch.ivy.ws.addon.TaskSearchCriteria,String,ch.ivy.addon.portalkit.persistence.domain.Server,Integer,Integer) #txt
...
<elementInfo>
    <language>
        <name>findTasksByCriteria(TaskSearchCriteria,String,Server, int, int)</name>
        <nameStyle>63,5,7
</nameStyle>
    </language>
</elementInfo>
...
' #txt
Te0 f36 242 658 28 28 14 -22 #rect
...
' #txt
Te0 f37 238 756 36 24 20 -2 #rect
...
' #txt
Te0 f39 256 686 256 756 #arcP
Te0 f39 0 0.4857142857142857 0 0 #arcLabel
Te0 f40 expr out #txt
Te0 f40 256 780 256 851 #arcP
Te0 f42 expr out #txt
Te0 f42 416 780 269 864 #arcP
Te0 f42 1 416 864 #addKink
...
' #txt
Te0 f65 1742 116 36 24 20 -17 #rect
Te0 f65 @|StepIcon #fIcon
Te0 f28 expr out #txt
Te0 f28 1760 140 1760 178 #arcP
...
' #txt
Te0 f67 238 532 36 24 20 -19 #rect
...
' #txt
Te0 f38 1230 116 36 24 20 -17 #rect
Te0 f38 @|StepIcon #fIcon
Te0 f70 expr out #txt
Te0 f70 1248 140 1248 178 #arcP
...
' #txt
Te0 f15 718 532 36 24 22 -19 #rect
Te0 f15 @|StepIcon #fIcon
Te0 f50 expr out #txt
Te0 f50 736 556 736 594 #arcP
...
' #txt
Te0 f74 2766 276 36 24 20 -2 #rect
Te0 f74 @|WebServiceIcon #fIcon
Te0 f75 inParamDecl '<ch.ivy.ws.addon.TaskSearchCriteria taskSearchCriteria,java.lang.String endpoint,ch.ivy.addon.portalkit.persistence.domain.Server server> param;' #txt
...
' #txt
Te0 f75 callSignature countTasksByCriteria(ch.ivy.ws.addon.TaskSearchCriteria,String,ch.ivy.addon.portalkit.persistence.domain.Server) #txt
...
<elementInfo>
    <language>
        <name>countTasksByCriteria(TaskSearchCriteria,String,Server)</name>
        <nameStyle>54,5,7
</nameStyle>
    </language>
</elementInfo>
...
' #txt
Te0 f76 actionCode 'import ch.ivy.addon.portalkit.support.UrlDetector;
import org.apache.commons.lang.StringUtils;
UrlDetector detector = new UrlDetector();
String serverPath = (StringUtils.isEmpty(in.server.externalPath)) ? in.server.path : in.server.externalPath;
in.serverUrl = detector.getHost(serverPath);' #txt
...
' #txt
Te0 f76 2766 116 36 24 20 -19 #rect
Te0 f76 @|StepIcon #fIcon
...
' #txt
Te0 f78 2926 276 36 24 20 -2 #rect
...
' #txt
Te0 f79 2770 178 28 28 14 -22 #rect
...
' #txt
Te0 f80 2784 206 2784 276 #arcP
Te0 f81 expr out #txt
Te0 f81 2784 300 2784 371 #arcP
Te0 f83 expr out #txt
Te0 f83 2944 300 2797 384 #arcP
Te0 f83 1 2944 384 #addKink
...
Te0 f0 inParamDecl '<java.lang.String userName,java.lang.String endpoint,ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Long taskId> param;' #txt
...
' #txt
Te0 f0 callSignature parkTask(String,String,ch.ivy.addon.portalkit.persistence.domain.Server,Long) #txt
...
<elementInfo>
    <language>
        <name>parkTask(String,String,Server,Long)</name>
        <nameStyle>35,5,7
</nameStyle>
    </language>
</elementInfo>
...
Te0 f1 243 371 26 26 14 0 #rect
...
' #txt
Te0 f3 actionCode 'import ch.ivy.addon.portalkit.support.UrlDetector;
import org.apache.commons.lang.StringUtils;
UrlDetector detector = new UrlDetector();
String serverPath = (StringUtils.isEmpty(in.server.externalPath)) ? in.server.path : in.server.externalPath;
in.serverUrl = detector.getHost(serverPath);' #txt
...
' #txt
Te0 f3 238 116 36 24 20 -2 #rect
...
' #txt
Te0 f5 242 178 28 28 16 -21 #rect
Te0 f5 @|AlternativeIcon #fIcon
Te0 f6 expr out #txt
Te0 f6 256 140 256 178 #arcP
...
KEY_HOST=
KEY_USE_AUTHENTICATION=false
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.parkTask.id__@@__Long__@@__in.taskId"",""arg0.parkTask.serverUrl__@@__String__@@__in.serverUrl"",""arg0.parkTask.user__@@__String__@@__in.parkTaskRequester"""' #txt
...
' #txt
Te0 f10 398 276 36 24 20 -2 #rect
Te0 f10 @|WebServiceIcon #fIcon
Te0 f14 expr out #txt
Te0 f14 416 300 269 384 #arcP
Te0 f14 1 416 384 #addKink
...
' #txt
Te0 f62 238 276 36 24 20 -2 #rect
...
' #txt
Te0 f64 256 206 256 276 #arcP
Te0 f2 expr out #txt
Te0 f2 256 300 256 371 #arcP
Te0 f77 expr out #txt
Te0 f77 2784 140 2784 178 #arcP
...
Te0 f127 242 192 96 276 #arcP
Te0 f127 1 96 192 #addKink
Te0 f127 0 0.8046599158908039 0 0 #arcLabel
Te0 f13 expr out #txt
Te0 f13 96 300 243 384 #arcP
Te0 f13 1 96 384 #addKink
Te0 f13 1 0.20679742620065877 0 0 #arcLabel
Te0 f128 expr in #txt
Te0 f128 270 192 416 276 #arcP
Te0 f128 1 416 192 #addKink
...
Te0 f151 1248 76 1248 116 #arcP
...
KEY_HOST=
KEY_USE_AUTHENTICATION=true
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.resetTask.currentUserName__@@__String__@@__ivy.session.getSessionUserName()"",""arg0.resetTask.id__@@__Long__@@__in.taskId"",""arg0.resetTask.serverUrl__@@__String__@@__in.serverUrl"""' #txt
...
' #txt
Te0 f71 1070 276 36 24 20 -2 #rect
...
Te0 f131 1234 192 1088 276 #arcP
Te0 f131 1 1088 192 #addKink
Te0 f131 0 0.6554122903055368 0 0 #arcLabel
Te0 f21 expr in #txt
Te0 f21 1262 192 1440 276 #arcP
Te0 f21 1 1440 192 #addKink
Te0 f21 0 0.755600716531798 0 0 #arcLabel
Te0 f132 expr out #txt
Te0 f132 1088 300 1235 384 #arcP
Te0 f132 1 1088 384 #addKink
Te0 f132 1 0.20679742620065877 0 0 #arcLabel
Te0 f152 expr out #txt
Te0 f152 1760 77 1760 116 #arcP
...
' #txt
Te0 f66 1582 276 36 24 21 1 #rect
...
Te0 f133 1746 192 1600 276 #arcP
Te0 f133 1 1600 192 #addKink
Te0 f133 0 0.6862492995113834 0 0 #arcLabel
Te0 f31 expr out #txt
Te0 f31 1600 300 1747 384 #arcP
Te0 f31 1 1600 384 #addKink
Te0 f31 1 0.20679742620065877 0 0 #arcLabel
Te0 f134 expr in #txt
Te0 f134 1774 192 1920 276 #arcP
Te0 f134 1 1920 192 #addKink
...
Te0 f154 expr out #txt
Te0 f154 2784 77 2784 116 #arcP
...
' #txt
Te0 f84 2606 276 36 24 20 -2 #rect
...
Te0 f137 2770 192 2624 276 #arcP
Te0 f137 1 2624 192 #addKink
Te0 f137 0 0.7601222518175896 0 0 #arcLabel
Te0 f82 expr out #txt
Te0 f82 2624 300 2771 384 #arcP
Te0 f82 1 2624 384 #addKink
Te0 f82 1 0.20679742620065877 0 0 #arcLabel
Te0 f138 expr in #txt
Te0 f138 2798 192 2944 276 #arcP
Te0 f138 1 2944 192 #addKink
Te0 f138 0 0.7667663576064934 0 0 #arcLabel
Te0 f155 expr out #txt
Te0 f155 256 493 256 532 #arcP
...
' #txt
Te0 f69 78 756 36 24 20 -2 #rect
...
Te0 f139 242 672 96 756 #arcP
Te0 f139 1 96 672 #addKink
Te0 f139 0 0.7302200350148694 0 0 #arcLabel
Te0 f41 expr out #txt
Te0 f41 96 780 243 864 #arcP
Te0 f41 1 96 864 #addKink
Te0 f41 1 0.20679742620065877 0 0 #arcLabel
Te0 f140 expr in #txt
Te0 f140 270 672 416 756 #arcP
Te0 f140 1 416 672 #addKink
...
Te0 f67 mainOut f104 tail #connect
Te0 f104 head f99 mainIn #connect
...
Te0 f76 mainOut f77 tail #connect
Te0 f77 head f79 in #connect
...
Te0 f0 mainOut f149 tail #connect
Te0 f149 head f3 mainIn #connect
...
Te0 f11 mainOut f151 tail #connect
Te0 f151 head f38 mainIn #connect
...
Te0 f26 mainOut f152 tail #connect
Te0 f152 head f65 mainIn #connect
...
Te0 f75 mainOut f154 tail #connect
Te0 f154 head f76 mainIn #connect
...
Te0 f35 mainOut f155 tail #connect
Te0 f155 head f67 mainIn #connect
...
Te0 f45 mainOut f162 tail #connect
Te0 f162 head f15 mainIn #connect
