...
public class PortalCacheConstants {
  ...
  // cache tasks of case: for related tasks and history in case details
  public static final String TASK_IN_CASE_DETAILS_CACHE_GROUP_NAME = "Task In Case Details Group";
  public static final String TASK_IN_CASE_DETAILS_CACHE_ENTRY_NAME = "Task In Case Details Name";
}
