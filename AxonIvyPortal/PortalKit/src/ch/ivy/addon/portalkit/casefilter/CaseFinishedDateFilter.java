...
/**
 * @deprecated use CaseFinishedDateFilter in package ch.ivy.addon.portalkit.casefilter.impl
 *
 */
  ...
  public void validate() {
    if (fromFinishedDate != null && toFinishedDate != null && (fromFinishedDate.compareTo(toFinishedDate) > 0)) {
      ...
      FacesContext.getCurrentInstance().addMessage(
          ...
          FacesMessageUtils.message(FacesMessage.SEVERITY_ERROR, Ivy.cms().co(
