...
public class TaskSearchCriteria {
  ...
  public final static EnumSet<TaskState> ADVANCE_STATES = EnumSet.of(DONE, UNASSIGNED, DELAYED, DESTROYED, TaskState.JOIN_FAILED, TaskState.FAILED, TaskState.WAITING_FOR_INTERMEDIATE_EVENT);
