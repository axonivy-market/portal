...
public class TaskBean {
  ...
  public void getUrlOfTaskDetails(final long taskId) throws MalformedURLException {
    ...
    IProcessStart processStart =
        processStartCollector
            .findProcessStartByUserFriendlyRequestPath("Start Processes/PortalTemplatePages/PortalTaskDetails.ivp");
    ...
    String taskDetailURLFormat = "${serverURL}/pro/${processStartPath}?detailTaskId=${taskId}";
  ...
  private boolean isSessionUserHasDelegatePermission() {
    ...
    boolean hasDelegatePermission = ivySession.hasPermission(securityDescriptor, DELEGATE_TASKS);
