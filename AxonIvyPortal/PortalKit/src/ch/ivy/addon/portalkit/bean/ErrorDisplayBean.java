...
public class ErrorDisplayBean {
  ...
  public void displayErrors(List<PortalIvyDataException> errors) {
    ...
    if (CollectionUtils.isNotEmpty(errors)) {
      ...
      FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, Ivy.cms().co("/ch.ivy.addon.portalkit.ui.jsf/common/errorNotification"), "<span style=\"cursor:pointer\"><a onclick=\"PF('application-error-dialog').show(); \">"+errorLink+"</a></span>"));
