...
public class RemoteTask implements ITask {
	...
	public INote createNote(IWorkflowSession session, String message)
	...
	@Override
	public Object getPropertyValue(TaskProperty arg0)
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public IIntermediateEvent getIntermediateEvent()
			throws PersistencyException {
		return null;
	}
	...
	@Override
	public IProcessData getInternalProcessElementProcessData(String arg0)
			throws PersistencyException {
		return null;
	}

	@Override
	public IProcessData getInternalStartProcessData()
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.ADVANCED)
	public IPageArchive getPageArchive(long pageArchiveIdentifier)
			throws PersistencyException {
		return null;
	}
	...
	@Override
	public IIntermediateEvent getTimeoutedCreatorIntermediateEvent()
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public void setActivator(ISecurityMember activator)
			throws PersistencyException {
	...
	@Override
	@PublicAPI(IvyScriptVisibility.ADVANCED)
	public void setBusinessMilestoneTimestamp(Date businessMilestoneTimestamp)
			throws PersistencyException {
	...
	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public void setExpiryActivator(ISecurityMember expiryActivator)
			throws PersistencyException {
	...
	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public void setOriginalActivator(ISecurityMember activator)
			throws PersistencyException {
	...
	@Override
	public void updateTask(TaskUpdateDefinition arg0, ISecurityMember arg1)
			throws PersistencyException {

	}

	@Override
	public void writeInternalStartProcessData(IProcessData arg0)
			throws PersistencyException {
	 ...
	 *
	 * @param displayDescriptionTemplate
	 ...
	 *
	 * @param expiryActivatorName
	 *            expriry activator name
	 * @throws PersistencyException
	 *             PersistencyException
	 */
	 ...
	 *
	 * @param originalActivatorName
	 *            original activator name
	 * @throws PersistencyException
	 *             PersistencyException
	 */
	 ...
	 *
	 * @param expiresInBusinessDuration
	 *            expiresInBusinessDuration
	 */
	public void setExpiresInBusinessDuration(
			BusinessDuration expiresInBusinessDuration) {
	 ...
	 *
	 * @param expiryTaskStartElementPid
	...
	public String getPriorityLabel() {
		return Ivy.cms().co(
				"/ch.ivy.addon.portalkit.ui.jsf/taskPriority/" + this.priority);
	}
	...
	public String getStateLabel() {
		return Ivy.cms().co(
				"/ch.ivy.addon.portalkit.ui.jsf/taskState/" + this.state);
	}
