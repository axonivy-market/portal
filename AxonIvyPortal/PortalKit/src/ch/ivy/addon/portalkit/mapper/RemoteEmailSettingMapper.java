...
public class RemoteEmailSettingMapper {
   ...
   */
  public static List<RemoteEmailSetting> mapEmailSettings(List<IvyEmailSetting> emailSettings, String endPoint,
      Server server) {
   ...
   * @throws JSONException
   */
  private static RemoteEmailSetting mappEmailSetting(IvyEmailSetting ivyEmailSetting, String endPoint, Server server) {
    ...
    setEmailSendDailyTaskSummaryOnMonday(ivyEmailSetting, weekDays);
    setEmailSendDailyTaskSummaryOnTuesday(ivyEmailSetting, weekDays);
    setEmailSendDailyTaskSummaryOnWednesday(ivyEmailSetting, weekDays);
    setEmailSendDailyTaskSummaryOnThursday(ivyEmailSetting, weekDays);
    setEmailSendDailyTaskSummaryOnFriday(ivyEmailSetting, weekDays);
    setEmailSendDailyTaskSummaryOnSaturday(ivyEmailSetting, weekDays);
    setEmailSendDailyTaskSummaryOnSunday(ivyEmailSetting, weekDays);
  ...
  private static void setEmailSendDailyTaskSummaryOnSunday(IvyEmailSetting ivyEmailSetting, List<RemoteWeekDay> weekDays) {
    if (ivyEmailSetting.getEmailSendDailyTaskSummaryOnSunday()) {
      weekDays.add(RemoteWeekDay.SUNDAY);
    }
  }

  private static void setEmailSendDailyTaskSummaryOnSaturday(IvyEmailSetting ivyEmailSetting,
      List<RemoteWeekDay> weekDays) {
    if (ivyEmailSetting.getEmailSendDailyTaskSummaryOnSaturday()) {
      weekDays.add(RemoteWeekDay.SATURDAY);
    }
  }

  private static void setEmailSendDailyTaskSummaryOnFriday(IvyEmailSetting ivyEmailSetting, List<RemoteWeekDay> weekDays) {
    if (ivyEmailSetting.getEmailSendDailyTaskSummaryOnFriday()) {
      weekDays.add(RemoteWeekDay.FRIDAY);
    }
  }

  private static void setEmailSendDailyTaskSummaryOnThursday(IvyEmailSetting ivyEmailSetting,
      List<RemoteWeekDay> weekDays) {
  ...
  private static void setEmailSendDailyTaskSummaryOnWednesday(IvyEmailSetting ivyEmailSetting,
      List<RemoteWeekDay> weekDays) {
  ...
  private static void setEmailSendDailyTaskSummaryOnTuesday(IvyEmailSetting ivyEmailSetting,
      List<RemoteWeekDay> weekDays) {
  ...
  private static void setEmailSendDailyTaskSummaryOnMonday(IvyEmailSetting ivyEmailSetting, List<RemoteWeekDay> weekDays) {
   ...
   * @return WS object.
   */
  private static IvyEmailSetting convertToIvyEmailSetting(RemoteEmailSetting remoteEmailSetting) {
   ...
   */
  public static void parseData(EmailSettingServiceData emailSettingServiceData,
      Map<String, List<IvyEmailSetting>> mapSetting) {
    if (mapSetting != null) {
      for (Map.Entry<String, List<IvyEmailSetting>> item : mapSetting.entrySet()) {
        emailSettingServiceData.setEndpoint(item.getKey());
        ch.ivyteam.ivy.scripting.objects.List<IvyEmailSetting> emailSettingList =
            ch.ivyteam.ivy.scripting.objects.List.create(IvyEmailSetting.class);
