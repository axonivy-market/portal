...
public class CaseQueryService {
  ...
  public CaseQuery createQuery(CaseQueryCriteria criteria) {
    ...
    criteria.setNewQueryCreated(criteria.isNewQueryCreated() || criteria.getCaseQuery() == null || criteria.hasTaskId()
        || criteria.hasCaseId());
  ...
  private CaseQuery queryForKeyword(String keyword) {
    ...
    CaseQuery filterByKeywordQuery =
        CaseQuery.create().where().or().name().isLikeIgnoreCase(containingKeyword).or().description()
            .isLikeIgnoreCase(containingKeyword).or().customVarCharField1().isLikeIgnoreCase(containingKeyword).or()
            .customVarCharField2().isLikeIgnoreCase(containingKeyword).or().customVarCharField3()
            .isLikeIgnoreCase(containingKeyword).or().customVarCharField4().isLikeIgnoreCase(containingKeyword).or()
            .customVarCharField5().isLikeIgnoreCase(containingKeyword);
