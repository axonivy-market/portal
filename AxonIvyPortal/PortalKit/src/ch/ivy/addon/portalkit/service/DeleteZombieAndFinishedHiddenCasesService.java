...
public class DeleteZombieAndFinishedHiddenCasesService {
  ...
  public void deleteZombieAndFinishedHiddenCases() {
    ...
    boolean shouldDeleteCasesInAllApps = Boolean.parseBoolean(globalSettingService.findGlobalSettingValue(GlobalVariable.DELETE_ZOMBIE_AND_FINISHED_HIDDEN_CASES_IN_ALL_APPS.toString()));
    for (int i = cases.size()-1; i >= 0; i--) {
      ...
      boolean isApplicationNamePortal = PortalConstants.PORTAL_APPLICATION_NAME.equals(iCase.getApplication().getName());
