...
public class DeleteZombieAndFinishedHiddenCasesService {
  ...
  public void deleteZombieAndFinishedHiddenCases() {
	    ...
	    boolean shouldDeleteCasesInAllApps = Boolean.parseBoolean(globalSettingService.findGlobalSettingValue(GlobalVariable.DELETE_ZOMBIE_AND_FINISHED_HIDDEN_CASES_IN_ALL_APPS));
