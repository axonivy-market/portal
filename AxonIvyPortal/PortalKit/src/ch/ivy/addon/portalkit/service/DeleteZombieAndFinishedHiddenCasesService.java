...
public class DeleteZombieAndFinishedHiddenCasesService {
  ...
  public void deleteZombieAndFinishedHiddenCases() {
    ...
    boolean shouldDeleteAllCases = Boolean.parseBoolean(globalSettingService.findGlobalSettingValue(GlobalVariable.DELETE_ALL_ZOMBIE_AND_FINISHED_HIDDEN_CASES.toString()));
