...
public enum GlobalVariable {
  ...
  DELETE_ALL_ZOMBIE_AND_FINISHED_HIDDEN_CASES(Boolean.FALSE.toString(),"deleteAllZombieAndFinishedHiddenCasesNote");
  ...
  public static List<GlobalVariable> getBooleanType() {
    return Arrays.asList(HIDE_LOGOUT_BUTTON, SHOW_ENVIRONMENT_INFO, SHOW_TASK_BUTTON_LABELS, HIDE_CHANGE_PASSWORD_BUTTON,
            ...
            HIDE_SYSTEM_TASKS_FROM_HISTORY_ADMINISTRATOR, ENABLE_USER_FAVORITES, DELETE_ALL_ZOMBIE_AND_FINISHED_HIDDEN_CASES);
  }
