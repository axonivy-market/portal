...
public enum GlobalVariable {
  ...
  DELETE_ZOMBIE_AND_FINISHED_HIDDEN_CASES_IN_ALL_APPS(Boolean.FALSE.toString(),"deleteZombieAndFinishedHiddenCasesInAllAppsNote");
  ...
  public static List<GlobalVariable> getBooleanType() {
    return Arrays.asList(HIDE_LOGOUT_BUTTON, SHOW_ENVIRONMENT_INFO, SHOW_TASK_BUTTON_LABELS, HIDE_CHANGE_PASSWORD_BUTTON,
            ...
            HIDE_SYSTEM_TASKS_FROM_HISTORY_ADMINISTRATOR, ENABLE_USER_FAVORITES, DELETE_ZOMBIE_AND_FINISHED_HIDDEN_CASES_IN_ALL_APPS);
  }
