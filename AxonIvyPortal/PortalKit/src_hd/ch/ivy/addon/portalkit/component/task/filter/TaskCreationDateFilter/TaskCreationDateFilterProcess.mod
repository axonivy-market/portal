...
Ts0 f0 type ch.ivy.addon.portalkit.component.task.filter.TaskCreationDateFilter.TaskCreationDateFilterData #txt
...
Ts0 f1 type ch.ivy.addon.portalkit.component.task.filter.TaskCreationDateFilter.TaskCreationDateFilterData #txt
Ts0 f1 53 213 22 22 14 0 #rect
Ts0 f1 @|RichDialogProcessEndIcon #fIcon
Ts0 f2 expr out #txt
Ts0 f2 64 107 64 213 #arcP
Ts0 f3 guid 15AE9A0BAC670820 #txt
Ts0 f3 type ch.ivy.addon.portalkit.component.task.filter.TaskCreationDateFilter.TaskCreationDateFilterData #txt
Ts0 f3 actionDecl 'ch.ivy.addon.portalkit.component.task.filter.TaskCreationDateFilter.TaskCreationDateFilterData out;
' #txt
...
Ts0 f4 type ch.ivy.addon.portalkit.component.task.filter.TaskCreationDateFilter.TaskCreationDateFilterData #txt
