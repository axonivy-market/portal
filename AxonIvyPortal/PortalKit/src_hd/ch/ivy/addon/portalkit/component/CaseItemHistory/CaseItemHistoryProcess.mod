[Ivy]
[>Created: Wed Mar 09 14:10:49 ICT 2016]
...
Cs0 f66 processCall MultiPortal/TaskService:findTasksOfCase(String,ch.ivy.addon.portalkit.persistence.domain.Server,Long) #txt
Cs0 f66 doCall true #txt
Cs0 f66 requestActionDecl '<java.lang.String userName,ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Long caseId> param;
' #txt
Cs0 f66 requestMappingAction 'param.userName=ivy.session.getSessionUserName();
...
in.histories = historyService.createHistories(finishedTasks, in.remoteCase.remoteNotes);
...
Cs0 f16 processCall MultiPortal/TaskService:findTasksOfCase(String,ch.ivy.addon.portalkit.persistence.domain.Server,Long) #txt
Cs0 f16 doCall true #txt
Cs0 f16 requestActionDecl '<java.lang.String userName,ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Long caseId> param;
' #txt
