[Ivy]
17F7724167F454E5 7.5.0 #module
>Proto >Proto Collection #zClass
Ts0 CaseIdFilterProcess Big #zClass
Ts0 RD #cInfo
Ts0 #process
...
>Proto Ts0 Ts0 CaseIdFilterProcess #zField
...
>Proto Ts0 .type ch.ivy.addon.portalkit.component.cases.filter.CaseIdFilter.CaseIdFilterData #txt
