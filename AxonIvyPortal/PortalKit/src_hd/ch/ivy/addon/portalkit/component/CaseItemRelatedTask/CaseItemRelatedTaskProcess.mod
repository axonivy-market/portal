[Ivy]
[>Created: Wed Mar 09 11:47:11 ICT 2016]
...
' #txt
Cs0 f4 actionCode 'import ch.ivy.addon.portalkit.util.SecurityServiceUtils;
...
in.tasksOfCaseProcessLink = SecurityServiceUtils.findProcessByUserFriendlyRequestPath("Start Processes/PortalTemplatePages/PortalTaskListOfCase.ivp");
' #txt
