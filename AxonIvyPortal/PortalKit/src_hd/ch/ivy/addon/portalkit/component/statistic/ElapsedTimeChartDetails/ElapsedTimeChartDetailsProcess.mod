...
Es0 @RichDialogProcessEnd f20 '' #zField
...
Es0 @RichDialogMethodStart f12 '' #zField
...
Es0 f20 type ch.ivy.addon.portalkit.component.statistic.ElapsedTimeChartDetails.ElapsedTimeChartDetailsData #txt
...
Es0 f7 type ch.ivy.addon.portalkit.component.statistic.ElapsedTimeChartDetails.ElapsedTimeChartDetailsData #txt
...
Es0 f9 type ch.ivy.addon.portalkit.component.statistic.ElapsedTimeChartDetails.ElapsedTimeChartDetailsData #txt
Es0 f9 563 243 26 26 0 12 #rect
Es0 f9 @|RichDialogProcessEndIcon #fIcon
Es0 f18 type ch.ivy.addon.portalkit.component.statistic.ElapsedTimeChartDetails.ElapsedTimeChartDetailsData #txt
...
Es0 f0 inParameterDecl 'ch.ivy.addon.portalkit.component.statistic.ElapsedTimeChartDetails.ElapsedTimeChartDetailsData out;
' #txt
...
Es0 f12 @|RichDialogMethodStartIcon #fIcon
Es0 f13 type ch.ivy.addon.portalkit.component.statistic.ElapsedTimeChartDetails.ElapsedTimeChartDetailsData #txt
Es0 f13 563 435 26 26 0 12 #rect
Es0 f13 @|RichDialogProcessEndIcon #fIcon
Es0 f16 actionDecl 'ch.ivy.addon.portalkit.component.statistic.ElapsedTimeChartDetails.ElapsedTimeChartDetailsData out;
' #txt
