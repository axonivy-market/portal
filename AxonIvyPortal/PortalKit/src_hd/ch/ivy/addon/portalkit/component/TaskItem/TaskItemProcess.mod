[Ivy]
[>Created: Mon Jun 05 10:31:47 ICT 2017]
...
' #txt
Ts0 f47 1110 508 36 24 20 -2 #rect
...
' #txt
Ts0 f79 1238 508 36 24 20 -2 #rect
Ts0 f79 @|StepIcon #fIcon
Ts0 f50 expr out #txt
Ts0 f50 1128 532 1128 573 #arcP
Ts0 f76 expr out #txt
Ts0 f76 1128 339 1128 380 #arcP
Ts0 f78 expr out #txt
Ts0 f78 1128 404 1128 442 #arcP
Ts0 f49 expr in #txt
Ts0 f49 outCond in.canUserResumeTask #txt
Ts0 f49 1128 470 1128 508 #arcP
Ts0 f80 expr in #txt
Ts0 f80 1142 456 1256 508 #arcP
Ts0 f80 1 1256 456 #addKink
...
' #txt
Ts0 f33 166 132 36 24 20 -2 #rect
...
Ts0 f58 actionDecl 'ch.ivy.addon.portalkit.component.TaskItem.TaskItemData out;
' #txt
Ts0 f58 actionTable 'out=in;
' #txt
Ts0 f58 actionCode 'import ch.ivy.ws.addon.SideStepSearchCriteria;
...
' #txt
Ts0 f58 1412 407 112 44 -28 -8 #rect
Ts0 f58 @|StepIcon #fIcon
Ts0 f56 type ch.ivy.addon.portalkit.component.TaskItem.TaskItemData #txt
Ts0 f56 1455 592 26 26 0 12 #rect
Ts0 f56 @|RichDialogProcessEndIcon #fIcon
Ts0 f54 guid 015C764E9E7EFAAE #txt
Ts0 f54 type ch.ivy.addon.portalkit.component.TaskItem.TaskItemData #txt
Ts0 f54 method collectSideSteps(ch.ivy.addon.portalkit.bo.RemoteTask) #txt
...
<ch.ivy.addon.portalkit.bo.RemoteTask task> param = methodEvent.getInputArguments();
' #txt
Ts0 f54 inParameterMapAction 'out.selectedTask=param.task;
' #txt
Ts0 f54 outParameterDecl '<java.util.List<ch.ivyteam.ivy.casemap.runtime.ISideStepProcess> sideSteps> result;
' #txt
Ts0 f54 outParameterMapAction 'result.sideSteps=in.sideSteps;
' #txt
...
' #txt
Ts0 f54 1455 320 26 26 -85 15 #rect
Ts0 f54 @|RichDialogMethodStartIcon #fIcon
Ts0 f60 type ch.ivy.addon.portalkit.component.TaskItem.TaskItemData #txt
Ts0 f60 processCall MultiPortal/SideStepProcessStart:findSideStepsByCriteria(ch.ivy.addon.portalkit.persistence.domain.Server,ch.ivy.ws.addon.SideStepSearchCriteria) #txt
Ts0 f60 doCall true #txt
Ts0 f60 requestActionDecl '<ch.ivy.addon.portalkit.persistence.domain.Server server,ch.ivy.ws.addon.SideStepSearchCriteria sideStepSearchCriteria> param;
' #txt
Ts0 f60 requestMappingAction 'param.server=in.selectedTask.applicationRegister.server;
param.sideStepSearchCriteria=in.sideStepSearchCriteria;
' #txt
Ts0 f60 responseActionDecl 'ch.ivy.addon.portalkit.component.TaskItem.TaskItemData out;
' #txt
Ts0 f60 responseMappingAction 'out=in;
out.errors=result.errors;
...
' #txt
Ts0 f60 1450 513 36 24 20 -2 #rect
Ts0 f60 @|CallSubIcon #fIcon
Ts0 f63 expr out #txt
Ts0 f63 1468 346 1468 407 #arcP
Ts0 f62 expr out #txt
Ts0 f62 1468 451 1468 513 #arcP
Ts0 f57 expr out #txt
Ts0 f57 1468 537 1468 592 #arcP
...
Ts0 f60 mainOut f57 tail #connect
Ts0 f57 head f56 mainIn #connect
Ts0 f54 mainOut f63 tail #connect
Ts0 f63 head f58 mainIn #connect
