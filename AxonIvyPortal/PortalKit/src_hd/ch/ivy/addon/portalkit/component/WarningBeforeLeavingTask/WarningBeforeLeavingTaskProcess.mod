...
Ws0 f3 actionDecl 'ch.ivy.addon.portalkit.component.WarningBeforeLeavingTask.WarningBeforeLeavingTaskData out;
' #txt
...
Ws0 f4 type ch.ivy.addon.portalkit.component.WarningBeforeLeavingTask.WarningBeforeLeavingTaskData #txt
...
Ws0 f7 type ch.ivy.addon.portalkit.component.WarningBeforeLeavingTask.WarningBeforeLeavingTaskData #txt
Ws0 f7 347 243 26 26 0 12 #rect
Ws0 f7 @|RichDialogProcessEndIcon #fIcon
Ws0 f9 type ch.ivy.addon.portalkit.component.WarningBeforeLeavingTask.WarningBeforeLeavingTaskData #txt
...
' #txt
Ws0 f9 responseActionDecl 'ch.ivy.addon.portalkit.component.WarningBeforeLeavingTask.WarningBeforeLeavingTaskData out;
' #txt
...
Ws0 f11 type ch.ivy.addon.portalkit.component.WarningBeforeLeavingTask.WarningBeforeLeavingTaskData #txt
...
Ws0 f12 type ch.ivy.addon.portalkit.component.WarningBeforeLeavingTask.WarningBeforeLeavingTaskData #txt
