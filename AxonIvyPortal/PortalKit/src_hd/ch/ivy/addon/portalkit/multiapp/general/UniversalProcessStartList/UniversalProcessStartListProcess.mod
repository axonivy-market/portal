[Ivy]
[>Created: Fri Mar 25 18:01:43 ICT 2016]
...
Ps0 f1 86 270 20 20 13 0 #rect
Ps0 f1 @|RichDialogProcessEndIcon #fIcon
Ps0 f2 expr out #txt
Ps0 f2 96 204 96 270 #arcP
Ps0 f8 type ch.ivy.addon.portalkit.multiapp.general.UniversalProcessStartList.UniversalProcessStartListData #txt
Ps0 f8 processCall MultiPortal/ProcessStart:findProcessStartsByCriteria(String,ch.ivy.ws.addon.ProcessSearchCriteria) #txt
Ps0 f8 doCall true #txt
Ps0 f8 requestActionDecl '<java.lang.String language,ch.ivy.ws.addon.ProcessSearchCriteria processSearchCriteria> param;
' #txt
...
' #txt
Ps0 f8 78 180 36 24 20 -2 #rect
Ps0 f8 @|CallSubIcon #fIcon
Ps0 f3 expr out #txt
Ps0 f3 96 74 96 180 #arcP
Ps0 f4 expr out #txt
Ps0 f4 186 72 96 180 #arcP
...
Ps0 f7 mainOut f4 tail #connect
