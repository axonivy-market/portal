[Ivy]
[>Created: Wed Mar 09 10:47:25 ICT 2016]
...
Ts0 f8 processCall MultiPortal/CaseService:createNote(ch.ivy.addon.portalkit.persistence.domain.Server,Long,String,String) #txt
Ts0 f8 doCall true #txt
Ts0 f8 requestActionDecl '<ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Long caseId,java.lang.String username,java.lang.String content> param;
' #txt
Ts0 f8 requestMappingAction 'param.server=in.task.#applicationRegister.#server;
...
Ts0 f5 method findNotesAndDocuments(ch.ivy.addon.portalkit.bo.RemoteTask) #txt
...
Ts0 f18 445 405 22 22 14 0 #rect
...
' #txt
Ts0 f53 717 85 22 22 14 0 #rect
...
' #txt
Ts0 f58 710 252 36 24 20 -2 #rect
Ts0 f58 @|CallSubIcon #fIcon
Ts0 f59 expr out #txt
Ts0 f59 728 212 728 252 #arcP
...
' #txt
Ts0 f13 710 348 36 24 21 -11 #rect
Ts0 f13 @|StepIcon #fIcon
Ts0 f20 expr out #txt
Ts0 f20 728 372 728 413 #arcP
...
' #txt
Ts0 f28 714 298 28 28 14 0 #rect
Ts0 f28 @|AlternativeIcon #fIcon
Ts0 f29 expr out #txt
Ts0 f29 728 276 728 298 #arcP
Ts0 f15 expr in #txt
Ts0 f15 outCond in.errors.isEmpty() #txt
Ts0 f15 728 326 728 348 #arcP
Ts0 f32 expr out #txt
Ts0 f32 904 372 739 424 #arcP
Ts0 f32 1 904 424 #addKink
Ts0 f32 1 0.2544295989340298 0 0 #arcLabel
Ts0 f31 expr in #txt
Ts0 f31 742 312 904 348 #arcP
Ts0 f31 1 904 312 #addKink
...
' #txt
Ts0 f30 886 348 36 24 24 -15 #rect
...
' #txt
Ts0 f35 714 130 28 28 14 0 #rect
Ts0 f35 @|AlternativeIcon #fIcon
Ts0 f36 expr out #txt
Ts0 f36 728 107 728 130 #arcP
Ts0 f37 expr in #txt
...
' #txt
Ts0 f37 728 158 728 188 #arcP
Ts0 f37 0 0.41304347826086957 14 0 #arcLabel
Ts0 f38 expr in #txt
Ts0 f38 714 144 717 424 #arcP
Ts0 f38 1 680 144 #addKink
Ts0 f38 2 680 424 #addKink
...
' #txt
Ts0 f39 1685 77 22 22 14 0 #rect
...
Ts0 f40 1685 333 22 22 14 0 #rect
...
' #txt
Ts0 f42 1678 140 36 24 20 -2 #rect
Ts0 f42 @|CallSubIcon #fIcon
Ts0 f43 expr out #txt
Ts0 f43 1696 99 1696 140 #arcP
...
' #txt
Ts0 f44 1213 93 22 22 26 -17 #rect
...
Ts0 f45 1213 221 22 22 14 0 #rect
Ts0 f45 @|RichDialogProcessEndIcon #fIcon
Ts0 f46 expr out #txt
Ts0 f46 1224 115 1224 221 #arcP
...
' #txt
Ts0 f47 1678 268 36 24 21 -11 #rect
...
' #txt
Ts0 f48 1682 202 28 28 14 0 #rect
...
' #txt
Ts0 f49 1870 268 36 24 20 -2 #rect
Ts0 f49 @|StepIcon #fIcon
Ts0 f50 expr in #txt
Ts0 f50 outCond in.errors.isEmpty() #txt
Ts0 f50 1696 230 1696 268 #arcP
Ts0 f51 expr in #txt
Ts0 f51 1710 216 1888 268 #arcP
Ts0 f51 1 1888 216 #addKink
Ts0 f51 0 0.7001921317088737 0 0 #arcLabel
Ts0 f52 expr out #txt
Ts0 f52 1696 164 1696 202 #arcP
Ts0 f41 expr out #txt
Ts0 f41 1696 292 1696 333 #arcP
Ts0 f55 expr out #txt
Ts0 f55 1888 292 1707 344 #arcP
Ts0 f55 1 1888 344 #addKink
...
' #txt
Ts0 f57 1469 93 22 22 14 -9 #rect
...
Ts0 f60 1469 221 22 22 14 0 #rect
...
Ts0 f62 1462 156 36 24 20 -2 #rect
Ts0 f62 @|StepIcon #fIcon
Ts0 f63 expr out #txt
Ts0 f63 1480 115 1480 156 #arcP
Ts0 f61 expr out #txt
Ts0 f61 1480 180 1480 221 #arcP
Ts0 f64 type ch.ivy.addon.portalkit.singleapp.tasks.TaskDetails.TaskDetailsData #txt
...
param.caseId=in.task.case.getId();
' #txt
Ts0 f64 responseActionDecl 'ch.ivy.addon.portalkit.singleapp.tasks.TaskDetails.TaskDetailsData out;
' #txt
...
' #txt
Ts0 f64 438 236 36 24 20 -2 #rect
Ts0 f64 @|CallSubIcon #fIcon
Ts0 f65 expr out #txt
Ts0 f65 456 172 456 236 #arcP
Ts0 f66 actionDecl 'ch.ivy.addon.portalkit.singleapp.tasks.TaskDetails.TaskDetailsData out;
' #txt
...
Ts0 f66 type ch.ivy.addon.portalkit.singleapp.tasks.TaskDetails.TaskDetailsData #txt
...
' #txt
Ts0 f66 438 316 36 24 19 -9 #rect
Ts0 f66 @|StepIcon #fIcon
Ts0 f67 expr out #txt
Ts0 f67 456 260 456 316 #arcP
Ts0 f19 expr out #txt
Ts0 f19 456 340 456 405 #arcP
...
Ts0 f16 mainOut f65 tail #connect
