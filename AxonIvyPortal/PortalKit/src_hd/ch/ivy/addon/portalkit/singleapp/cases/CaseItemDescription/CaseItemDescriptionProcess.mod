[Ivy]
[>Created: Tue Jan 03 13:36:21 ICT 2017]
1642081255951FB2 3.18 #module
...
Cs0 f0 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData #txt
...
Cs0 f1 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData #txt
Cs0 f1 53 213 22 22 14 0 #rect
Cs0 f1 @|RichDialogProcessEndIcon #fIcon
Cs0 f2 expr out #txt
Cs0 f2 64 107 64 213 #arcP
Cs0 f3 guid 157D1B9BA8DCBC43 #txt
Cs0 f3 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData #txt
Cs0 f3 actionDecl 'ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData out;
' #txt
...
Cs0 f4 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData #txt
...
Cs0 f6 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData #txt
...
Cs0 f7 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData #txt
Cs0 f7 245 285 22 22 14 0 #rect
Cs0 f7 @|RichDialogProcessEndIcon #fIcon
Cs0 f9 actionDecl 'ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData out;
' #txt
...
Cs0 f9 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData #txt
...
Cs0 f14 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData #txt
...
' #txt
Cs0 f14 responseActionDecl 'ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData out;
' #txt
...
>Proto Cs0 .type ch.ivy.addon.portalkit.singleapp.cases.CaseItemDescription.CaseItemDescriptionData #txt
