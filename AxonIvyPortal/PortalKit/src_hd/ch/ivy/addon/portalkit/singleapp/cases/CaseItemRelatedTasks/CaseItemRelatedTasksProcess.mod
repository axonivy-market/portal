...
Cs0 f8 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemRelatedTasks.CaseItemRelatedTasksData #txt
Cs0 f8 processCall 'Functional Processes/Navigator:viewTask(Long,ch.ivy.addon.portalkit.dto.GlobalCaseId,String)' #txt
Cs0 f8 doCall true #txt
Cs0 f8 requestActionDecl '<java.lang.Long taskId,ch.ivy.addon.portalkit.dto.GlobalCaseId caseId,java.lang.String caseName> param;
' #txt
Cs0 f8 requestMappingAction 'param.taskId=in.taskId;
param.caseId=in.globalCaseId;
param.caseName=in.caseName;
' #txt
Cs0 f8 responseActionDecl 'ch.ivy.addon.portalkit.singleapp.cases.CaseItemRelatedTasks.CaseItemRelatedTasksData out;
' #txt
...
' #txt
Cs0 f8 522 211 36 24 20 -2 #rect
Cs0 f8 @|CallSubIcon #fIcon
Cs0 f11 guid 1641CB0D47D4736C #txt
Cs0 f11 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemRelatedTasks.CaseItemRelatedTasksData #txt
Cs0 f11 actionDecl 'ch.ivy.addon.portalkit.singleapp.cases.CaseItemRelatedTasks.CaseItemRelatedTasksData out;
' #txt
Cs0 f11 actionTable 'out=in;
' #txt
Cs0 f11 actionCode 'import ch.ivy.addon.portalkit.util.SecurityServiceUtils;
import ch.ivy.addon.portalkit.dto.GlobalCaseId;
import org.primefaces.component.commandlink.CommandLink;

out.globalCaseId = GlobalCaseId.inServer(SecurityServiceUtils.getServerIdFromSession()).caseId(in.internalCase.getId()).isBusinessCase(in.internalCase.isBusinessCase()).build();
out.caseName = in.internalCase.getName();
...
' #txt
Cs0 f11 529 84 22 22 14 0 #rect
Cs0 f11 @|RichDialogProcessStartIcon #fIcon
Cs0 f12 actionDecl 'ch.ivy.addon.portalkit.singleapp.cases.CaseItemRelatedTasks.CaseItemRelatedTasksData out;
' #txt
Cs0 f12 actionTable 'out=in;
' #txt
Cs0 f12 actionCode 'import ch.ivy.addon.portalkit.util.MenuUtils;
MenuUtils.clearMenuState();' #txt
Cs0 f12 type ch.ivy.addon.portalkit.singleapp.cases.CaseItemRelatedTasks.CaseItemRelatedTasksData #txt
...
' #txt
Cs0 f12 522 147 36 24 20 -2 #rect
Cs0 f12 @|StepIcon #fIcon
Cs0 f13 expr out #txt
Cs0 f13 540 171 540 211 #arcP
Cs0 f14 expr out #txt
Cs0 f14 540 106 540 147 #arcP
