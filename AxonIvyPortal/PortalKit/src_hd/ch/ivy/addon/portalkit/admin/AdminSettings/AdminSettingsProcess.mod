[Ivy]
[>Created: Thu Jan 28 10:07:39 ICT 2016]
...
in.isAddMode = true;
in.dialogTitle = ivy.cms.co("/ch.ivy.addon.portalkit.ui.jsf/adminSettings/addNewServer");' #txt
...
As0 f131 processCall MultiPortal/IsAliveService:getAllApplications(ch.ivy.addon.portalkit.persistence.domain.Server) #txt
...
out.ivyApplications=result.apps;
' #txt
...
' #txt
As0 f102 actionCode 'import ch.ivy.addon.portalkit.persistence.domain.Server;
...
' #txt
As0 f2 outActionCode 'import ch.ivy.addon.portalkit.service.ApplicationService;
ApplicationService applicationService = new ApplicationService();
result.applications = applicationService.findAll();' #txt
