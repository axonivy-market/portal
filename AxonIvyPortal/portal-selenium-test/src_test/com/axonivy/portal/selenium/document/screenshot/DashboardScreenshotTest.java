...
public class DashboardScreenshotTest extends ScreenshotBaseTest{
  ...
  public void screenshotNewDashboard() throws IOException{
    ...
    ScreenshotUtils.resizeBrowserAndCaptureWholeScreen(ScreenshotUtils.DASHBOARD_FOLDER + "dashboard", new Dimension(1800, 1400));
  ...
  public void screenshotConfigureCustomWidget() throws IOException {
    ...
    ScreenshotUtils.captureElementScreenshot(customWidgetPage.getConfigurationDialog(), ScreenshotUtils.DASHBOARD_FOLDER + "process-custom-widget-configuration");
  }
  ...
  public void screenshotConfigureExternalPageWidget() throws IOException {
    ...
    ScreenshotUtils.captureElementScreenshot(customWidgetPage.getConfigurationDialog(), ScreenshotUtils.DASHBOARD_FOLDER + "external-page-widget-configuration");
  }
  ...
  public void screenshotDashboardWithAnnotation() throws IOException {
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(homePage.getTopBar(), ScreenshotUtils.DASHBOARD_FOLDER + "portal-header-with-numbering-annotation", new ScreenshotMargin(20, 20, 20, 120));
  }
  ...
  public void screenshotNewDashboardUserGuide() throws IOException {
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(homePage.openWidgetFilter(1), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "widget-filter", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(taskInfoOverlayPanel, ScreenshotUtils.NEW_DASHBOARD_FOLDER + "widget-info", new ScreenshotMargin(20));
    
    // Take screenshot of task Excel export link
    ScreenshotUtils.executeDecorateJs("highlightWidgetExportToExcelLinkForTask()");
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(taskInfoOverlayPanel, ScreenshotUtils.NEW_DASHBOARD_FOLDER + "task-export-excel", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(caseInfoOverlayPanel, ScreenshotUtils.NEW_DASHBOARD_FOLDER + "case-export-excel", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(newWidgetDialog, ScreenshotUtils.NEW_DASHBOARD_FOLDER + "add-widget", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(taskConfigurationPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "task-list-widget", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementScreenshot(caseConfigurationPage.getConfigurationFilter(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "case-list-widget-configuration");
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(caseConfigurationPage.openColumnManagementDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "case-list-widget-table-configuration", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(caseConfigurationPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "case-list-widget", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(processConfigurationPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "process-widget-combined-mode", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(processConfigurationPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "process-widget-compact-mode", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(processConfigurationPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "process-widget-full-mode", new ScreenshotMargin(20));
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(processConfigurationPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "process-widget-image-mode", new ScreenshotMargin(20));

    processConfigurationPage.getProcessDisplayMode().click();
    ScreenshotUtils.executeDecorateJs("highlightProcessDisplayModePanel()");
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(processConfigurationPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "process-widget-modes", new ScreenshotMargin(20));
  }
  ...
  public void screenshotProcessViewerWidget() throws IOException {
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(processViewerPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "process-viewer-widget-configuration", new ScreenshotMargin(20));

    processViewerPage.clickSaveProcessViewerWidget();
    redirectToRelativeLink(PORTAL_HOME_PAGE_URL);
    homePage = new NewDashboardPage();
    ScreenshotUtils.captureElementScreenshot(homePage.waitAndGetProcessViewerWidget(0), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "process-viewer-widget");
  }
  ...
  public void screenshotStatisticChartWidget() throws IOException {
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(statisticPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "statistic-chart-widget-configuration", new ScreenshotMargin(20));

    statisticPage.save();
    redirectToRelativeLink(PORTAL_HOME_PAGE_URL);
    homePage = new NewDashboardPage();
    ScreenshotUtils.captureElementScreenshot(homePage.waitAndGetStatisticChart(0), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "statistic-chart-widget");
  }
  ...
  public void screenshotWelcomeWidget() throws IOException {
    ...
    ScreenshotUtils.captureElementWithMarginOptionScreenshot(welcomeWidgetPage.getConfigurationDialog(), ScreenshotUtils.NEW_DASHBOARD_FOLDER + "welcome-widget-configuration", new ScreenshotMargin(20));
  }
