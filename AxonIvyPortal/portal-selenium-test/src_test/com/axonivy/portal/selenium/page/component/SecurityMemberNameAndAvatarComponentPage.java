...
public class SecurityMemberNameAndAvatarComponentPage extends TemplatePage{
  ...
  public SelenideElement getCurrentSessionUserSecurityMemberNameAndAvatarComponentContainer() {
    ...
    var element = $("[id='current-session-user-security-member-name-and-avatar-component-container']").shouldBe(Condition.appear, DEFAULT_TIMEOUT);
    return element;
  }

  public SelenideElement getCurrentSessionRoleSecurityMemberNameAndAvatarComponentContainer() {
    var element = $("[id='current-session-role-security-member-name-and-avatar-component-container']").shouldBe(Condition.appear, DEFAULT_TIMEOUT);
    return element;
  }
}
