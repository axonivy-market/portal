...
public class UserProfilePage extends TemplatePage {
  ...
  public void selectCaseSortDirection(String selectValue) {
    ...
    waitForElementClickableThenClick($(By.xpath("//*[@id='" + CASE_SORT_DIRECTION_SELECTION_ITEMS + "']/li[contains(text(),'" + selectValue + "')]")));
  }
  ...
  public void inputFormattingLanguage(String newLanguage) {
    ...
    SelenideElement formattingLanguage = findElementByCssSelector("[id$='my-profile-form:format-language-selection_input']");
