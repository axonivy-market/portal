...
public class DashboardNotificationWidgetConfigurationPage extends TemplatePage {
  ...
  protected String getLoadedLocator() {
    return "[id$='notification-widget-configuration-header']";
  }

  public void changeWidgetTitle(String newWidgetName) {
    SelenideElement widgetTitle = $(".widget-configuration.notification-widget-configuration").shouldBe(appear, DEFAULT_TIMEOUT)
