...
public enum Variable {
  ...
  REFRESH_TASK_LIST_INTERVAL("Portal.Tasks.RefreshInterval"), DISABLE_TASK_COUNT("Portal.Tasks.DisableCount"),
  ...
  CLIENT_SIDE_TIMEOUT("Portal.ClientSideTimeout"), EMBED_IN_FRAME("Portal.EmbedInFrame"),
  ...
  ENABLE_SWITCH_THEME_BUTTON("Portal.Theme.EnableSwitchThemeModeButton"), DASHBOARD_MAIN_MENU_ENTRY("Portal.Dashboard.MainMenuEntry");
