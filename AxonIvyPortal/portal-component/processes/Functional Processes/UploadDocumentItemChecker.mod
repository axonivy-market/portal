...
' #txt
Ur0 f0 outParamDecl '<com.axonivy.portal.component.enums.UploadDocumentCheckStatus uploadDocumentCheckStatus,String message> result;' #txt
...
' #txt
Ur0 f3 actionCode 'import com.axonivy.portal.component.enums.UploadDocumentCheckStatus;
...
' #txt
Ur0 f5 actionCode 'import com.axonivy.portal.component.service.CaseDocumentService;
...
Ur0 f4 expr in #txt
Ur0 f4 outCond 'in.checkStatus == com.axonivy.portal.component.enums.UploadDocumentCheckStatus.OK && in.enableScriptCheckingForUploadedDocument' #txt
...
' #txt
Ur0 f10 actionCode 'import com.axonivy.portal.component.enums.UploadDocumentCheckStatus;
import com.axonivy.portal.component.service.CaseDocumentService;
...
Ur0 f11 expr in #txt
Ur0 f11 outCond 'in.checkStatus == com.axonivy.portal.component.enums.UploadDocumentCheckStatus.OK && in.enableVirusScannerForUploadedDocument' #txt
...
>Proto Ur0 .type com.axonivy.portal.component.UploadDocumentItemCheckerData #txt
