[Ivy]
18098C74EBB97195 7.5.0 #module
>Proto >Proto Collection #zClass
Er0 PortalComponentErrorHandler Big #zClass
Er0 B #cInfo
Er0 #process
...
>Proto Er0 Er0 PortalComponentErrorHandler #zField
Er0 f0 inParamDecl '<java.util.List<com.axonivy.portal.component.ivydata.exception.PortalIvyDataException> exceptions> param;' #txt
Er0 f0 inParamTable 'out.exceptions=param.exceptions;
' #txt
Er0 f0 outParamDecl '<> result;' #txt
Er0 f0 callSignature handle(java.util.List<com.axonivy.portal.component.ivydata.exception.PortalIvyDataException>) #txt
...
' #txt
Er0 f3 actionCode 'import com.axonivy.portal.component.ivydata.exception.PortalIvyDataException;
import com.axonivy.portal.component.util.ErrorHandler;
...
>Proto Er0 .type com.axonivy.portal.component.ErrorHandlerData #txt
