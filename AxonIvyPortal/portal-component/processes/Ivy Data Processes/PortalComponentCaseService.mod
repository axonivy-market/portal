...
Ce0 f0 inParamDecl '<com.axonivy.portal.component.ivydata.searchcriteria.CaseSearchCriteria caseSearchCriteria,Integer startIndex,Integer count> param;' #txt
Ce0 f0 inParamTable 'out.caseSearchCriteria=param.caseSearchCriteria;
out.count=param.count;
out.startIndex=param.startIndex;
' #txt
Ce0 f0 outParamDecl '<java.util.List<com.axonivy.portal.component.ivydata.exception.PortalIvyDataException> errors,java.util.List<ch.ivyteam.ivy.workflow.ICase> cases> result;' #txt
Ce0 f0 outParamTable 'result.errors=in.errors;
result.cases=in.cases;
' #txt
Ce0 f0 callSignature findCasesByCriteria(com.axonivy.portal.component.ivydata.searchcriteria.CaseSearchCriteria,Integer,Integer) #txt
...
' #txt
Ce0 f6 actionCode 'import com.axonivy.portal.component.ivydata.service.impl.CaseService;
...
Ce0 f5 processCall 'Functional Processes/PortalComponentErrorHandler:handle(java.util.List<com.axonivy.portal.component.ivydata.exception.PortalIvyDataException>)' #txt
Ce0 f5 requestActionDecl '<java.util.List<com.axonivy.portal.component.ivydata.exception.PortalIvyDataException> exceptions> param;' #txt
Ce0 f5 requestMappingAction 'param.exceptions=in.errors;
' #txt
Ce0 f5 responseActionDecl 'com.axonivy.portal.component.service.PortalConponentCaseServiceData out;
' #txt
...
' #txt
Ce0 f11 actionCode 'import com.axonivy.portal.component.ivydata.service.impl.CaseService;
import com.axonivy.portal.component.ivydata.dto.IvyCaseResultDTO;
...
Ce0 f12 inParamDecl '<com.axonivy.portal.component.ivydata.searchcriteria.CaseSearchCriteria caseSearchCriteria> param;' #txt
Ce0 f12 inParamTable 'out.caseSearchCriteria=param.caseSearchCriteria;
' #txt
Ce0 f12 outParamDecl '<java.util.List<com.axonivy.portal.component.ivydata.exception.PortalIvyDataException> errors,Long totalCases> result;' #txt
Ce0 f12 outParamTable 'result.errors=in.errors;
result.totalCases=in.totalCases;
' #txt
Ce0 f12 callSignature countCasesByCriteria(com.axonivy.portal.component.ivydata.searchcriteria.CaseSearchCriteria) #txt
...
Ce0 f13 processCall 'Functional Processes/PortalComponentErrorHandler:handle(java.util.List<com.axonivy.portal.component.ivydata.exception.PortalIvyDataException>)' #txt
Ce0 f13 requestActionDecl '<java.util.List<com.axonivy.portal.component.ivydata.exception.PortalIvyDataException> exceptions> param;' #txt
Ce0 f13 requestMappingAction 'param.exceptions=in.errors;
' #txt
Ce0 f13 responseActionDecl 'com.axonivy.portal.component.service.PortalConponentCaseServiceData out;
' #txt
...
>Proto Ce0 .type com.axonivy.portal.component.service.PortalConponentCaseServiceData #txt
