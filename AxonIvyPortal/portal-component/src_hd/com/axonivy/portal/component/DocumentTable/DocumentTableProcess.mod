...
' #txt
Ds0 f6 responseActionDecl 'com.axonivy.portal.component.DocumentTable.DocumentTableData out;
' #txt
...
' #txt
Ds0 f13 responseActionDecl 'com.axonivy.portal.component.DocumentTable.DocumentTableData out;
' #txt
...
Ds0 f20 processCall 'Functional Processes/DeleteDocumentItem:call(ch.ivyteam.ivy.workflow.ICase,com.axonivy.portal.component.ivydata.bo.IvyDocument)' #txt
Ds0 f20 requestActionDecl '<ch.ivyteam.ivy.workflow.ICase businessCase,com.axonivy.portal.component.ivydata.bo.IvyDocument document> param;' #txt
Ds0 f20 requestMappingAction 'param.businessCase=in.ivyCase;
param.document=in.selectedDocument;
' #txt
Ds0 f20 responseActionDecl 'com.axonivy.portal.component.DocumentTable.DocumentTableData out;
' #txt
...
Ds0 f24 method download(com.axonivy.portal.component.ivydata.bo.IvyDocument) #txt
Ds0 f24 inParameterDecl '<com.axonivy.portal.component.ivydata.bo.IvyDocument selectedDocument> param;' #txt
...
Ds0 f25 processCall 'Functional Processes/DownloadDocumentItem:call(ch.ivyteam.ivy.workflow.ICase,com.axonivy.portal.component.ivydata.bo.IvyDocument)' #txt
Ds0 f25 requestActionDecl '<ch.ivyteam.ivy.workflow.ICase bussinessCase,com.axonivy.portal.component.ivydata.bo.IvyDocument document> param;' #txt
Ds0 f25 requestMappingAction 'param.bussinessCase=in.ivyCase;
param.document=in.selectedDocument;
' #txt
Ds0 f25 responseActionDecl 'com.axonivy.portal.component.DocumentTable.DocumentTableData out;
' #txt
...
' #txt
Ds0 f34 actionCode 'out.message = ivy.cms.co("/Dialogs/com/axonivy/portal/component/DocumentTable/FileLimitMessage") + " (max." + in.fileLimit + ")";' #txt
...
' #txt
Ds0 f39 actionCode 'import com.axonivy.portal.component.document.DocumentCustomField;
...
Ds0 f40 expr in #txt
Ds0 f40 outCond 'in.uploadDocumentCheckStatus == com.axonivy.portal.component.enums.UploadDocumentCheckStatus.OK' #txt
...
Ds0 f42 method renderComponent(String,Boolean,com.axonivy.portal.component.enums.DocumentType,Boolean,Boolean,String) #txt
Ds0 f42 inParameterDecl '<String messageComponentId,Boolean typeColumnRendered,com.axonivy.portal.component.enums.DocumentType selectedType,Boolean enableScriptCheckingForUploadedDocument,Boolean enableVirusScannerForUploadedDocument,String allowedUploadFileTypes> param;' #txt
...
>Proto Ds0 .type com.axonivy.portal.component.DocumentTable.DocumentTableData #txt
