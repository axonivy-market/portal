...
if (param.currentStep < 0 || param.currentStep >= param.stepsSize && !(param.currentStep == 0 && param.stepsSize ==0)) {
	FacesMessage error = new javax.faces.application.FacesMessage(FacesMessage.SEVERITY_ERROR, ivy.cms.co("/Dialogs/com/axonivy/portal/component/ProcessChain/CurrentStepIsNotDefined", Arrays.asList(param.currentStep)), ivy.cms.co("/Dialogs/com/axonivy/portal/component/ProcessChain/CurrentStepIsNotDefined", Arrays.asList(param.currentStep)));
...
>Proto Ps0 .type com.axonivy.portal.component.ProcessChain.ProcessChainData #txt
