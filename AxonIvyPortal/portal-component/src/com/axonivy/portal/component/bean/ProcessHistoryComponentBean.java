...
import com.axonivy.portal.component.datamodel.internal.CaseHistoryLazyDataModel;
import com.axonivy.portal.component.util.UserFormatUtils;
...
public class ProcessHistoryComponentBean implements Serializable {
  ...
  public String formatCaseDescription(String text) {
    ...
    if (StringUtils.isBlank(extractedText)) {
      return Ivy.cms().co("/Dialogs/com/axonivy/portal/component/ProcessHistory/NoDescription");
    }
  ...
  public String getDisplayState(CaseState caseState) {
    ...
    return Ivy.cms().co("/Dialogs/com/axonivy/portal/component/ProcessHistory/CaseState/" + caseState);
  }
