...
//Copied from PortalKit, just change: EngineMode.is(EngineMode.DEMO) || EngineMode.isEmbeddedInDesigner() -> EngineMode.is(EngineMode.ENTERPRISE)
...
public enum PortalSecurity {
  ...
  public void assignPermissionsToDefaultUsers() {
    ...
    if (EngineMode.is(EngineMode.ENTERPRISE) && isIvySecurity) {
