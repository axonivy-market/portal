[Ivy]
[>Created: Wed Mar 09 16:04:36 ICT 2016]
...
Te0 f4 inParamDecl '<java.lang.String username,java.lang.String serverUrl,java.lang.Long id> param;' #txt
...
' #txt
Te0 f4 callSignature findTasksOfCase(String,String,Long) #txt
...
<elementInfo>
    <language>
        <name>findTasksOfCase(String,String,Long)</name>
    </language>
</elementInfo>
' #txt
...
try {
  TaskServiceResult result = taskService.findTasksOfCase(in.ivyCase.id, in.user, in.serverUrl);
