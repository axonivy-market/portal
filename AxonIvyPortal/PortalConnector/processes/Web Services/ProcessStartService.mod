[Ivy]
[>Created: Fri Feb 26 14:38:19 ICT 2016]
...
Pe0 f8 inParamDecl '<java.lang.String serverUrl,ch.ivy.ws.addon.service.ProcessSearchCriteria processSearchCriteria> param;' #txt
Pe0 f8 inParamTable 'out.processSearchCriteria=param.processSearchCriteria;
...
' #txt
Pe0 f8 callSignature findProcessesStartsByCriteria(String,ch.ivy.ws.addon.service.ProcessSearchCriteria) #txt
...
<elementInfo>
    <language>
        <name>findProcessesStartsByCriteria(String,ProcessSearchCriteria)</name>
    </language>
</elementInfo>
' #txt
...
try{
	ProcessStartServiceResult pssResult = WsServiceFactory.getProcessStartService().findProcessStartsByCriteria(in.processSearchCriteria, in.serverUrl);
