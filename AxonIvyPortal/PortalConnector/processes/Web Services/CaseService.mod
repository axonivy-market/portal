...
try {
	CaseServiceResult result = WsServiceFactory.getCaseService().findCustomVarChars(in.caseCustomVarCharSearchCriteria.portalCaseCustomVarField, in.caseCustomVarCharSearchCriteria.keyword, in.caseCustomVarCharSearchCriteria.limit, in.caseCustomVarCharSearchCriteria.applicationIds);
