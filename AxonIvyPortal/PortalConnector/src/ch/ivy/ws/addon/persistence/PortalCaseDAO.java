...
public class PortalCaseDAO extends AbstractDAO{
  ...
  public List<String> findCustomVarChar1Fields(String keyword,int limit, List<IvyApplication> applications) {
      Query query = generateQueryForField("customVarCharField1", keyword, limit, applications);
      return query.getResultList();
  }

  @SuppressWarnings("unchecked")
  public List<String> findCustomVarChar2Fields(String keyword, int limit, List<IvyApplication> applications) {
      Query query = generateQueryForField("customVarCharField2", keyword, limit, applications);
      return query.getResultList();
  }
  
  @SuppressWarnings("unchecked")
  public List<String> findCustomVarChar3Fields(String keyword, int limit, List<IvyApplication> applications) {
      Query query = generateQueryForField("customVarCharField3", keyword, limit, applications);
      return query.getResultList();
  }
  
  @SuppressWarnings("unchecked")
  public List<String> findCustomVarChar4Fields(String keyword, int limit, List<IvyApplication> applications) {
      Query query = generateQueryForField("customVarCharField4", keyword, limit, applications);
      return query.getResultList();
  }
  
  @SuppressWarnings("unchecked")
  public List<String> findCustomVarChar5Fields(String keyword, int limit, List<IvyApplication> applications) {
      Query query = generateQueryForField("customVarCharField5", keyword, limit, applications);
      return query.getResultList();
  }
  
  private Query generateQueryForField(String fieldName ,String keyword, int limit, List<IvyApplication> applications) {
    Query query = null;
