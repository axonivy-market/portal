...
public class CaseServiceImpl extends AbstractService implements ICaseService {
  ...
  @Override
  public CaseServiceResult findCase(final Integer caseId) {
    ...
    caseServiceResult.setErrors(errors);
        ...
        public NoteServiceResult call() throws Exception {
          ...
          if (caseId != null) {
            ...
            try {
              ...
              errors.add(new WSException(WSErrorType.WARNING, 10022, userText, null));
            }
