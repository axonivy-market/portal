...
public class DashboardCustomWidgetBean implements Serializable {
  ...
  public void validateUrl(FacesContext context, UIComponent component, Object value) {
    if (context.getExternalContext().getRequestParameterMap().get("skipValidator") != null) {
      return;
    }
    if (value == null) {
      return;
    ...
    if (!UrlUtils.isSafeIframeUrl(url)) {
      String message = Ivy.cms().co("/ch.ivy.addon.portalkit.ui.jsf/dashboard/configuration/CustomWidgetUrlInvalidScheme");
