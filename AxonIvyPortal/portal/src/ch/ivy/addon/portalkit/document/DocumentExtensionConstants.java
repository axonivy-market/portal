...
public class DocumentExtensionConstants {
  ...
  public static final List<String> DEFAULT_WHITELIST_EXTENSION = ImmutableList.of("doc", "docx", "xls", "xlsx", "xlsm", "csv", "pdf", "ppt", "pptx", "txt" ,"zip", "jpg", "jpeg", "bmp", "png", "log");
  public static final List<String> ALLOWED_SVG_FORMAT = ImmutableList.of("svg");  public static final List<String> ARCHIVE_FORMAT = ImmutableList.of("zip", "rar", "7z");
