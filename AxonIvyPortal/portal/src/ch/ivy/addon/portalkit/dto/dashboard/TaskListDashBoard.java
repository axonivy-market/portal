...
public class TaskListDashBoard extends DashboardWidget {

  private static final long serialVersionUID = 324673517612307854L;
  ...
  public void onApplyUserFilters() {
    setUserFilters(this.getUserFilters().stream().filter(Objects::nonNull)
        .filter(filter -> StringUtils.isNotBlank(filter.getField())).collect(Collectors.toList()));
