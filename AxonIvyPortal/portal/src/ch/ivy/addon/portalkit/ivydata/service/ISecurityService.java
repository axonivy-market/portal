...
public interface ISecurityService {
  ...
  /**
   * Finds the users with their roles who have the given roles and in current application
   * @param query
   * @param startIndex 0..n. The index of the first record is 0
   * @param count 0..n. Use -1 to return all beginning from the startIndex
   * @param fromRoles
   ...
   * @return {@link IvySecurityResultDTO}
   */
  IvySecurityResultDTO findUsersWithRoles(String query, int startIndex, int count, List<String> fromRoles, List<String> excludedUsernames);
