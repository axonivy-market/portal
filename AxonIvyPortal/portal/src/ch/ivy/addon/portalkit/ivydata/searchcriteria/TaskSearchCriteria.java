...
public class TaskSearchCriteria {
  ...
  public final static List<TaskBusinessState> STANDARD_BUSINESS_STATES =
      Arrays.asList(TaskBusinessState.DONE, TaskBusinessState.OPEN, TaskBusinessState.IN_PROGRESS);

  public final static List<TaskBusinessState> ADVANCE_BUSINESS_STATES =
      Arrays.asList(TaskBusinessState.OPEN, TaskBusinessState.IN_PROGRESS, TaskBusinessState.DONE,
          TaskBusinessState.DESTROYED, TaskBusinessState.DELAYED, TaskBusinessState.ERROR);
