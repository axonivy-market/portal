  ...
  private class TaskSortingQueryAppender {
    ...
    public TaskSortingQueryAppender appendSorting(DashboardProcessTaskSearchCriteria criteria) {
      ...
      if (order != null) {
        ...
        // and Oracle/PostgreSQL order NULLs opposite to MySQL/MSSQL. Sorting empty values last
        // in both directions keeps the first page populated on every database.
    ...
    private void appendSortByCompletionionDateIfSet(DashboardProcessTaskSearchCriteria criteria) {
