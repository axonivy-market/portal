...
public class JsonDefaultStatisticMigrator {

  private final JsonNode node;
  private final StatisticJsonVersion version;

  public JsonDefaultStatisticMigrator(JsonNode node) {
    this.node = node;
    this.version = StatisticJsonVersion.LATEST_VERSION;
  }

  public JsonDefaultStatisticMigrator(JsonNode node, StatisticJsonVersion version) {
    this.node = node;
  ...
  public JsonNode migrate() {
    ...
    filterDefaultChartsFromClientStatistic((ArrayNode) node);
  ...
  private void filterDefaultChartsFromClientStatistic(ArrayNode nodes) {
