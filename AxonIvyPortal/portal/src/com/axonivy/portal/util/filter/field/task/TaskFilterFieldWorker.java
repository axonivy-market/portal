...
public class TaskFilterFieldWorker extends FilterField {

  public TaskFilterFieldWorker() {
    super(DashboardStandardTaskColumn.WORKER.getField());
  }

  @Override
  public String getLabel() {
    if (org.apache.commons.lang3.StringUtils.isBlank(this.label)) {
      return DashboardStandardTaskColumn.WORKER.getLabel();
    }
    return this.label;
  }
