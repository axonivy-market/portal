...
public class CustomStringStartWithOperatorHandler {
  ...
  public TaskQuery buildStartWithQueryByCase(DashboardFilter filter) {
    CaseQuery caseQuery = com.axonivy.portal.util.filter.operator.caze.customfield.CustomStringStartWithOperatorHandler
        .getInstance().buildStartWithQuery(filter);
  ...
  public TaskQuery buildNotStartWithQueryByCase(DashboardFilter filter) {
    CaseQuery caseQuery = com.axonivy.portal.util.filter.operator.caze.customfield.CustomStringStartWithOperatorHandler
        .getInstance().buildNotStartWithQuery(filter);
