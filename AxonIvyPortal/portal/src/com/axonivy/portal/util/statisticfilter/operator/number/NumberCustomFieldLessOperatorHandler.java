...
public class NumberCustomFieldLessOperatorHandler {
  private static NumberCustomFieldLessOperatorHandler instance;

  public static NumberCustomFieldLessOperatorHandler getInstance() {
    if (instance == null) {
      instance = new NumberCustomFieldLessOperatorHandler();
    }
    return instance;
  }
