[Ivy]
[>Created: Fri Sep 30 16:23:41 ICT 2016]
...
try{
	TaskServiceResult tsResult = WsServiceFactory.getTaskService().findTasksByCriteria(in.taskSearchCriteria, in.serverId, in.serverUrl, in.startIndex, in.count, in.isNoConfigurationMode);
...
Te0 f44 inParamDecl '<java.lang.Boolean isNoConfigurationMode,java.lang.Long serverId,java.lang.Integer startIndex,java.lang.Integer count,java.lang.String serverUrl,ch.ivy.ws.addon.service.TaskSearchCriteria taskSearchCriteria> param;' #txt
...
' #txt
Te0 f44 callSignature findTasksByCriteria(Boolean,Long,Integer,Integer,String,ch.ivy.ws.addon.service.TaskSearchCriteria) #txt
