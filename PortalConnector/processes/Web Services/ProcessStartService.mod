[Ivy]
[>Created: Thu Jun 09 17:28:15 ICT 2016]
...
Pe0 f8 inParamDecl '<java.lang.String language,java.lang.String serverUrl,ch.ivy.ws.addon.service.ProcessSearchCriteria processSearchCriteria> param;' #txt
Pe0 f8 inParamTable 'out.language=param.language;
...
' #txt
Pe0 f8 callSignature findProcessesStartsByCriteria(String,String,ch.ivy.ws.addon.service.ProcessSearchCriteria) #txt
...
try{
	ProcessStartServiceResult pssResult = WsServiceFactory.getProcessStartService().findProcessStartsByCriteria(in.processSearchCriteria, in.serverUrl, in.language);
