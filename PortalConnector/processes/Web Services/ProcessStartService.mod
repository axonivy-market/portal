[Ivy]
[>Created: Tue Jul 12 17:11:55 ICT 2016]
...
Pe0 f8 inParamDecl '<java.lang.String language,java.lang.String serverUrl,java.lang.Boolean isNoConfigurationMode,ch.ivy.ws.addon.service.ProcessSearchCriteria processSearchCriteria> param;' #txt
Pe0 f8 inParamTable 'out.isNoConfigurationMode=param.isNoConfigurationMode;
...
' #txt
Pe0 f8 callSignature findProcessesStartsByCriteria(String,String,Boolean,ch.ivy.ws.addon.service.ProcessSearchCriteria) #txt
...
try{
	ProcessStartServiceResult pssResult = WsServiceFactory.getProcessStartService().findProcessStartsByCriteria(in.processSearchCriteria, in.serverUrl, in.language, in.isNoConfigurationMode);
