...
public class IvyTaskTransformer {
  private static final String EVERYBODY_ROLE = "Everybody";
  ...
  public IvyTask transform(ITask t, boolean addCaseToTask) {
    ...
    if (t.getActivator() != null) {
      ...
      if (activator != null) {
        if (EVERYBODY_ROLE.equals(activatorName)) {
          result.setActivatorFullName(activatorName);
        } else {
          String fullName =
    ...
    if (t.getExpiryActivatorName() != null) {
      ...
      if (expiryActivator != null) {
        if (EVERYBODY_ROLE.equals(expiryActivator)) {
          result.setExpireActivatorFullName(expiryActivatorName);
        } else {
          String fullName =
    ...
    if (t.getOriginalActivatorName() != null) {
      ...
      if (originalActivator != null) {
        if (EVERYBODY_ROLE.equals(originalActivatorName)) {
          result.setOriginalActivatorFullName(originalActivatorName);
        } else {
          String fullName =
  ...
  private String specifyServerUrl(String serverUrl) {
    if (isNoConfigurationMode) {
      return serverUrl;
    }
    return ServerUrlUtils.getServerUrl(serverUrl);
  }
}
