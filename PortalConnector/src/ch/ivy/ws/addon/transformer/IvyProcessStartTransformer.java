...
public class IvyProcessStartTransformer {
  ...
  private boolean isNoConfigurationMode = false;
  
  public IvyProcessStartTransformer(String serverUrl) {
    this.serverUrl = serverUrl;
  }
  
  public IvyProcessStartTransformer(String serverUrl, boolean isNoConfigurationMode) {
    this.serverUrl = serverUrl;
  ...
  private String getStartLink(IProcessStart process) {
    ...
    String specifiedServerURL = specifyServerUrl(serverUrl);
