...
public final class SystemProperties {
  ...
  public static String getSystemPropertyValue(String propertyName){
    try {
      return ServerFactory.getServer().getSecurityManager().executeAsSystem(() -> getExternalHostCallable(propertyName));
    } catch (Exception e) {
  ...
  private static String getExternalHostCallable(String propertyName) {
    IApplicationConfigurationManager applicationConfigurationManager = ServerFactory.getServer()
