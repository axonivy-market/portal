...
public class ProcessStartServiceImpl extends AbstractService implements IProcessStartService {
  ...
  @Override
  public ProcessStartServiceResult findProcessStartsByCriteria(ProcessSearchCriteria searchCriteria, String serverUrl,
      String language, boolean isNoConfigurationMode) throws WSException {
    try {
      return ServerFactory.getServer().getSecurityManager().executeAsSystem(new Callable<ProcessStartServiceResult>() {
        ...
        public ProcessStartServiceResult call() throws Exception {
          ...
          IvyProcessStartTransformer transformer = new IvyProcessStartTransformer(serverUrl, isNoConfigurationMode);
