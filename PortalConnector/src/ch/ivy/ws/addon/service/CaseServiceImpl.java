...
public class CaseServiceImpl extends AbstractService implements ICaseService {
          ...
          .executeAsSystem(
              () -> {
                ...
                for (ICase iCase : cases) {
                  ...
                  ivyCase.setCanChangeName(SessionUtil.doesUserHavePermission(iCase.getApplication(), caseSearchCriteria.getInvolvedUsername(), IPermission.CASE_WRITE_NAME));
  ...
  private CaseQuery createCaseQuery(CaseSearchCriteria caseSearchCriteria) throws Exception {
    ...
    finalQuery.orderBy().caseId().descending();
    return finalQuery;
  }
