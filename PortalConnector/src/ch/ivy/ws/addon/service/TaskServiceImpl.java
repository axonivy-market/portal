...
public class TaskServiceImpl extends AbstractService implements ITaskService {
  ...
  private static class TaskSortingQueryAppender {
    ...
    public void appendSortByPriorityIfSet(TaskSearchCriteria criteria) {
      if (criteria.isSortByPriority()) {
        if (criteria.isSortDescending()) {
    ...
    public void appendSortByExpiryDateIfSet(TaskSearchCriteria criteria) {
      if (criteria.isSortByExpiryDate()) {
        if (criteria.isSortDescending()) {
    ...
    public void appendSortByIdIfSet(TaskSearchCriteria criteria) {
      if (criteria.isSortById()) {
        if (criteria.isSortDescending()) {
  ...
  public void save(IvyTask task) throws WSException {
    try {
      securityManager().executeAsSystem(() -> {
        ...
        // As of now, expiryTimestamp, description and originalPriority are the only fields
