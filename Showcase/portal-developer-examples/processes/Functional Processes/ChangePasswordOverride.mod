...
import com.axonivy.portal.developerexamples.service.PasswordCheckingService;
...
>Proto Cd0 .type _com.axonivy.portal.developerexamples.ChangePasswordOverrideData #txt
