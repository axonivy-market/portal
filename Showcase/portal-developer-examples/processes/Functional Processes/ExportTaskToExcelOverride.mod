...
<elementInfo>
    <language>
        <name>exportToExcel(List&lt;ITask&gt;,List&lt;String&gt;)</name>
    </language>
</elementInfo>
' #txt
...
>Proto El0 .type _com.axonivy.portal.developerexamples.ExportTaskToExcelOverrideData #txt
