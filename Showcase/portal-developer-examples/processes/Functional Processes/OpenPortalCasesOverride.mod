...
Ot0 f3 dialogId com.axonivy.portal.developerexamples.component.customize.CaseWidget #txt
Ot0 f3 startMethod start(CaseView) #txt
...
' #txt
Ot0 f3 responseActionDecl '_com.axonivy.portal.developerexamples.OpenPortalCasesOverrideData out;
' #txt
...
>Proto Ot0 .type _com.axonivy.portal.developerexamples.OpenPortalCasesOverrideData #txt
