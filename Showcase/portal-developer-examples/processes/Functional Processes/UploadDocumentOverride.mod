...
' #txt
Ut0 f75 responseActionDecl '_com.axonivy.portal.developerexamples.UploadDocumentOverrideData out;
' #txt
...
Ut0 f2 expr out #txt
Ut0 f2 1312 128 1361 128 #arcP
>Proto Ut0 .type _com.axonivy.portal.developerexamples.UploadDocumentOverrideData #txt
