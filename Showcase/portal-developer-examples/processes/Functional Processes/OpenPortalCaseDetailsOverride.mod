...
Os0 f2 dialogId com.axonivy.portal.developerexamples.component.customize.CaseItemDetails #txt
...
>Proto Os0 .type _com.axonivy.portal.developerexamples.OpenPortalCaseDetailsOverrideData #txt
