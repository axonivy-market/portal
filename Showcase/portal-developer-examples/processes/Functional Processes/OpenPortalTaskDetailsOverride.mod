...
Os0 f2 dialogId com.axonivy.portal.developerexamples.component.customize.TaskItemDetails #txt
...
' #txt
Os0 f2 responseActionDecl '_com.axonivy.portal.developerexamples.OpenPortalTaskDetailsOverrideData out;
' #txt
...
>Proto Os0 .type _com.axonivy.portal.developerexamples.OpenPortalTaskDetailsOverrideData #txt
