...
Os0 f3 dialogId com.axonivy.portal.developerexamples.component.customize.TaskWidget #txt
...
' #txt
Os0 f3 responseActionDecl '_com.axonivy.portal.developerexamples.OpenPortalTasksOverrideData out;
' #txt
...
>Proto Os0 .type _com.axonivy.portal.developerexamples.OpenPortalTasksOverrideData #txt
