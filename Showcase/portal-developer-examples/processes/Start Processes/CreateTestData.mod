...
' #txt
Cs0 f45 responseActionDecl 'com.axonivy.portal.developerexamples.Data out;
' #txt
...
TaskA.EXROL=Everybody
TaskA.EXTYPE=0
TaskA.NAM=Annual Leave Request Annual Leave Request Annual Leave Request Annual Leave Request Annual Leave Request Annual Leave Request Annual Leave Request
TaskA.PRI=2
TaskA.ROL="demo"
TaskA.SKIP_TASK_LIST=false
TaskA.TYPE=3
