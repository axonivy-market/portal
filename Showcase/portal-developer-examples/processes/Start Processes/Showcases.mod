...
out.gdprRequest.processState=com.axonivy.portal.developerexamples.showcase.enums.ProcessState.APPLICATION;
' #txt
...
' #txt
Ss0 f3 responseActionDecl 'com.axonivy.portal.developerexamples.showcase.Data out;
' #txt
...
Ss0 f10 dialogId com.axonivy.portal.developerexamples.showcase.CustomizedUI #txt
