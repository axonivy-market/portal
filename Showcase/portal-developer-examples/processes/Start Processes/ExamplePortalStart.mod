...
Bk5 @GridStep f106 '' #zField
Bk5 @CallSub f104 '' #zField
Bk5 @PushWFArc f107 '' #zField
...
Bk6 @AnnotationArc f8 '' #zField
Bk6 @UserDialog f36 '' #zField
Bk6 @GridStep f22 '' #zField
Bk6 @Alternative f54 '' #zField
Bk6 @PushWFArc f43 '' #zField
Bk6 @PushWFArc f6 '' #zField
Bk6 @InfoButton f3 '' #zField
Bk6 @PushTrueWFInG-01 g0 '' #zField
Bk6 @GridStep f1 '' #zField
Bk6 @PushWFArc f2 '' #zField
Bk6 @PushWFArc f0 '' #zField
Bk6 @GridStep f4 '' #zField
Bk6 @PushWFArc f5 '' #zField
>Proto Bk6 Bk4 BpmnUserTask #zField
...
Bk5 f106 actionTable 'out=in;
' #txt
Bk5 f106 actionCode 'import ch.ivyteam.ivy.workflow.ICase;
import ch.ivyteam.ivy.workflow.query.CaseQuery;
...
Bk5 f106 security system #txt
Bk5 f106 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Find Case</name>
    </language>
...
' #txt
Bk5 f106 136 138 112 44 -28 -8 #rect
Bk5 f106 @|StepIcon #fIcon
Bk5 f104 processCall 'Functional Processes/OpenPortalCaseDetailsHook:call(ch.ivyteam.ivy.workflow.ICase,Boolean)' #txt
Bk5 f104 requestActionDecl '<ch.ivyteam.ivy.workflow.ICase caseData,Boolean isShowBackButton> param;' #txt
Bk5 f104 requestMappingAction 'param.caseData=in.caseSelected;
param.isShowBackButton=true;
' #txt
Bk5 f104 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk5 f104 responseMappingAction 'out=in;
' #txt
Bk5 f104 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk5 f104 288 138 144 44 -65 -8 #rect
Bk5 f104 @|CallSubIcon #fIcon
Bk5 f107 expr out #txt
Bk5 f107 248 160 288 160 #arcP
...
Bk5 f1 expr out #txt
Bk5 f1 432 160 499 160 #arcP
>Proto Bk3 0 0 32 24 18 0 #rect
>Proto Bk3 @|BIcon #fIcon
Bk6 f8 696 160 664 160 #arcP
Bk6 f36 dialogId com.axonivy.portal.developerexamples.PortalHome #txt
Bk6 f36 startMethod start(ch.ivy.addon.portal.generic.view.TaskView) #txt
Bk6 f36 requestActionDecl '<ch.ivy.addon.portal.generic.view.TaskView taskView> param;' #txt
Bk6 f36 requestMappingAction 'param.taskView=in.taskView;
' #txt
Bk6 f36 responseMappingAction 'out=in;
' #txt
Bk6 f36 responseActionCode '
' #txt
Bk6 f36 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk6 f36 552 138 112 44 -45 -8 #rect
Bk6 f36 @|UserDialogIcon #fIcon
Bk6 f22 actionTable 'out=in;
' #txt
Bk6 f22 actionCode 'import ch.ivy.addon.portal.generic.view.TaskView;

in.taskView = TaskView.create().dataModel(in.dataModel).showHeaderToolbar(true).noTaskFoundMessage("").createNewTaskView();
' #txt
Bk6 f22 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk6 f22 400 138 112 44 -38 -8 #rect
Bk6 f22 @|StepIcon #fIcon
Bk6 f54 272 144 32 32 0 16 #rect
Bk6 f54 @|AlternativeIcon #fIcon
Bk6 f43 512 160 552 160 #arcP
Bk6 f6 expr in #txt
Bk6 f6 outCond '!(in.#homepage is initialized) || in.homepage.#type == ch.addon.portal.generic.userprofile.homepage.HomepageType.DASHBOARD' #txt
Bk6 f6 .xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>dashboard</name>
    </language>
...
' #txt
Bk6 f6 304 160 400 160 #arcP
Bk6 f6 0 0.40625 0 -12 #arcLabel
...
' #txt
Bk6 f3 696 138 144 44 -63 -16 #rect
Bk6 f3 @|IBIcon #fIcon
...
' #txt
Bk6 f1 136 138 112 44 -33 -16 #rect
Bk6 f1 @|StepIcon #fIcon
Bk6 f2 77 160 136 160 #arcP
Bk6 f0 248 160 272 160 #arcP
Bk6 f4 actionTable 'out=in;
' #txt
Bk6 f4 actionCode 'import ch.ivy.addon.portalkit.util.RequestUtil;
...
' #txt
Bk6 f4 344 234 128 44 -45 -16 #rect
Bk6 f4 @|StepIcon #fIcon
Bk6 f5 expr in #txt
Bk6 f5 .xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>others</name>
    </language>
...
' #txt
Bk6 f5 288 176 344 256 #arcP
Bk6 f5 1 288 256 #addKink
Bk6 f5 1 0.42857142857142855 0 -10 #arcLabel
...
Bk5 f106 mainOut f107 tail #connect
Bk5 f107 head f104 mainIn #connect
Bk5 g0 m f0 tail #connect
Bk5 f0 head f106 mainIn #connect
Bk5 f1 head g1 m #connect
Bk5 f104 mainOut f1 tail #connect
Bk5 0 0 576 320 0 #ivRect
Bk6 f3 ao f8 tail #connect
Bk6 f8 head f36 @CG|ai #connect
Bk6 f22 mainOut f43 tail #connect
Bk6 f43 head f36 mainIn #connect
Bk6 f54 out f6 tail #connect
Bk6 f6 head f22 mainIn #connect
Bk6 g0 m f2 tail #connect
Bk6 f2 head f1 mainIn #connect
Bk6 f1 mainOut f0 tail #connect
Bk6 f0 head f54 in #connect
Bk6 f54 out f5 tail #connect
Bk6 f5 head f4 mainIn #connect
