...
Bk8 @GridStep f69 '' #zField
Bk8 @PushWFArc f67 '' #zField
Bk8 @PushWFArc f118 '' #zField
Bk8 @CallSub f84 '' #zField
Bk8 @CallSub f73 '' #zField
...
>Proto Bk9 Bk3 BpmnServiceTask #zField
...
Bk7 f36 dialogId com.axonivy.portal.developerexamples.customization.PortalHome #txt
...
Bk8 f69 actionTable 'out=in;
' #txt
Bk8 f69 actionCode 'import ch.ivy.addon.portalkit.enums.TaskAssigneeType;
import ch.ivy.addon.portal.generic.view.TaskView;
...
' #txt
Bk8 f69 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>build data model &#13;
and task view</name>
...
' #txt
Bk8 f69 296 136 112 48 -39 -16 #rect
Bk8 f67 expr out #txt
Bk8 f67 408 160 492 160 #arcP
Bk8 f118 expr out #txt
Bk8 f118 248 160 296 160 #arcP
Bk8 f84 processCall 'Functional Processes/OpenPortalTasks:useView(ch.ivy.addon.portal.generic.view.TaskView)' #txt
Bk8 f84 requestActionDecl '<ch.ivy.addon.portal.generic.view.TaskView taskView> param;' #txt
Bk8 f84 requestMappingAction 'param.taskView=in.taskView;
' #txt
Bk8 f84 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk8 f84 responseMappingAction 'out=in;
' #txt
Bk8 f84 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>OpenPortalTasks</name>
    </language>
...
' #txt
Bk8 f84 492 140 104 40 -48 -12 #rect
Bk8 f73 processCall 'Functional Processes/InitializeTaskDataModel:call()' #txt
Bk8 f73 requestActionDecl '<> param;' #txt
Bk8 f73 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk8 f73 responseMappingAction 'out=in;
out.dataModel=result.dataModel;
' #txt
Bk8 f73 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk8 f73 136 138 112 44 -40 -8 #rect
...
Bk8 f73 mainOut f118 tail #connect
Bk8 f118 head f69 mainIn #connect
Bk8 f69 mainOut f67 tail #connect
Bk8 f67 head f84 mainIn #connect
Bk8 g0 m f0 tail #connect
Bk8 f0 head f73 mainIn #connect
Bk8 f1 head g1 m #connect
Bk8 f84 mainOut f1 tail #connect
