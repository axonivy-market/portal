...
' #txt
Ms0 f6 actionCode 'import com.axonivy.portal.developerexamples.showcase.Person;
...
>Proto Ms0 .type com.axonivy.portal.developerexamples.testdata.ModenaElements.ModenaElementsData #txt
