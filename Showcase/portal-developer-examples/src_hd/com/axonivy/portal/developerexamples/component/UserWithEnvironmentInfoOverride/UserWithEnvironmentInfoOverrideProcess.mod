...
>Proto Ws0 Ws0 UserWithEnvironmentInfoOverrideProcess #zField
...
>Proto Ws0 .type ch.ivyteam.ivy.project.portal.examples.component.UserWithEnvironmentInfoOverride.UserWithEnvironmentInfoOverrideData #txt
