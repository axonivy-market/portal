...
' #txt
Cs0 f6 208 42 176 44 -82 -8 #rect
Cs0 f6 @|StepIcon #fIcon
Cs0 f7 expr out #txt
Cs0 f7 109 64 208 64 #arcP
Cs0 f2 384 64 467 64 #arcP
>Proto Cs0 .type com.axonivy.portal.developerexamples.component.customize.CaseItemDetails.CaseItemDetailsData #txt
