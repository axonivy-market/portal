...
>Proto Ws0 Ws0 PageHeaderOverrideProcess #zField
...
>Proto Ws0 .type com.axonivy.portal.developerexamples.customization.component.PageHeaderOverride.PageHeaderOverrideData #txt
