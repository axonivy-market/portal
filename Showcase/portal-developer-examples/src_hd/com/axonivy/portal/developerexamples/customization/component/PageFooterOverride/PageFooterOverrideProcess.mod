...
>Proto Ws0 Ws0 PageFooterOverrideProcess #zField
...
>Proto Ws0 .type com.axonivy.portal.developerexamples.customization.component.PageFooterOverride.PageFooterOverrideData #txt
