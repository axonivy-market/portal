...
' #txt
Ps0 f6 actionCode 'import com.axonivy.portal.developerexamples.showcase.Score;
...
>Proto Ps0 .type com.axonivy.portal.developerexamples.showcase.PrimefacesDataTable.PrimefacesDataTableData #txt
