...
import static com.axonivy.portal.developerexamples.enums.StatisticTimePeriodSelection.CUSTOM;
import static com.axonivy.portal.developerexamples.enums.StatisticTimePeriodSelection.LAST_6_MONTH;
import static com.axonivy.portal.developerexamples.enums.StatisticTimePeriodSelection.LAST_MONTH;
import static com.axonivy.portal.developerexamples.enums.StatisticTimePeriodSelection.LAST_WEEK;
...
import com.axonivy.portal.developerexamples.enums.StatisticTimePeriodSelection;
...
public class StatisticFilter implements Cloneable {
  ...
  private List<StatisticTimePeriodSelection> allTimePeriodSelection =
      Arrays.asList(CUSTOM, LAST_WEEK, LAST_MONTH, LAST_6_MONTH);
  ...
  private List<IRole> findDistinctRoles() {
    ...
    List<IRole> distinctRoles =
        allRoles.stream().sorted((r1, r2) -> StringUtils.compareIgnoreCase(r1.getDisplayName(), r2.getDisplayName()))
  ...
  public List<String> findSavedCustomFields() {
    ...
    return customFieldFilters.entrySet().stream().filter(item -> CollectionUtils.isNotEmpty(item.getValue()))
