[Ivy]
[>Created: Mon Aug 07 15:22:25 ICT 2017]
15DBBC97904E4964 3.20 #module
...
' #txt
Il0 f0 actionDecl 'internaltest.InitializeTaskDataModelOverrideData out;
' #txt
Il0 f0 callSignature call() #txt
Il0 f0 type internaltest.InitializeTaskDataModelOverrideData #txt
...
Il0 f1 type internaltest.InitializeTaskDataModelOverrideData #txt
Il0 f1 337 49 30 30 0 15 #rect
Il0 f1 @|EndSubIcon #fIcon
Il0 f3 actionDecl 'internaltest.InitializeTaskDataModelOverrideData out;
' #txt
Il0 f3 actionTable 'out=in;
' #txt
Il0 f3 actionCode 'import ch.internalsupport.CustomizedTaskLazyDataModel;

in.dataModel = new CustomizedTaskLazyDataModel();' #txt
Il0 f3 type internaltest.InitializeTaskDataModelOverrideData #txt
...
>Proto Il0 .type internaltest.InitializeTaskDataModelOverrideData #txt
