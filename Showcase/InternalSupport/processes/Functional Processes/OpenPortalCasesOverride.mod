...
' #txt
Ot0 f0 actionDecl 'internaltest.OpenPortalCasesOverrideData out;
' #txt
Ot0 f0 callSignature useView(ch.ivy.addon.portal.generic.view.CaseView) #txt
Ot0 f0 type internaltest.OpenPortalCasesOverrideData #txt
...
' #txt
Ot0 f3 responseActionDecl 'internaltest.OpenPortalCasesOverrideData out;
' #txt
...
>Proto Ot0 .type internaltest.OpenPortalCasesOverrideData #txt
