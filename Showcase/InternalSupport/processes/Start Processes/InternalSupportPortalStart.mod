...
Bk7 B #cInfo
Bk8 BpmnServiceTask Big #zClass
Bk8 B #cInfo
...
Bk6 @GridStep f69 '' #zField
Bk6 @PushWFArc f67 '' #zField
Bk6 @PushWFArc f118 '' #zField
Bk6 @CallSub f84 '' #zField
Bk6 @CallSub f73 '' #zField
...
Bk8 @GridStep f51 '' #zField
Bk8 @GridStep f20 '' #zField
...
>Proto Bk8 Bk3 BpmnServiceTask #zField
...
Pt0 f23 0 0.7688674400459671 0 0 #arcLabel
Pt0 f18 expr in #txt
...
Bk0 f104 processCall 'Functional Processes/OpenPortalCaseDetailsHook:call(ICase,Boolean)' #txt
...
Bk6 f69 actionTable 'out=in;
' #txt
Bk6 f69 actionCode 'import ch.ivy.addon.portalkit.enums.TaskAssigneeType;
...
' #txt
Bk6 f69 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk6 f69 296 136 112 48 -39 -16 #rect
Bk6 f69 @|StepIcon #fIcon
Bk6 f67 expr out #txt
Bk6 f67 408 160 492 160 #arcP
Bk6 f118 expr out #txt
Bk6 f118 248 160 296 160 #arcP
Bk6 f84 processCall 'Functional Processes/OpenPortalTasks:useView(ch.ivy.addon.portal.generic.view.TaskView)' #txt
Bk6 f84 requestActionDecl '<ch.ivy.addon.portal.generic.view.TaskView taskView> param;' #txt
Bk6 f84 requestMappingAction 'param.taskView=in.taskView;
' #txt
Bk6 f84 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk6 f84 responseMappingAction 'out=in;
' #txt
Bk6 f84 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk6 f84 492 140 104 40 -48 -12 #rect
Bk6 f84 @|CallSubIcon #fIcon
Bk6 f73 processCall 'Functional Processes/InitializeTaskDataModel:call()' #txt
Bk6 f73 requestActionDecl '<> param;' #txt
Bk6 f73 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk6 f73 responseMappingAction 'out=in;
out.dataModel=result.dataModel;
' #txt
Bk6 f73 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk6 f73 136 138 112 44 -40 -8 #rect
Bk6 f73 @|CallSubIcon #fIcon
...
Bk7 f37 @|CallSubIcon #fIcon
Bk7 f0 208 80 32 32 0 16 #rect
Bk7 f0 @|AlternativeIcon #fIcon
...
Bk7 f23 processCall 'Functional Processes/OpenPortalCaseDetailsHook:call(ICase,Boolean)' #txt
...
Bk7 f2 expr in #txt
Bk7 f2 outCond 'in.isTaskStartedInDetails && !in.isTaskFinished' #txt
...
Bk8 f51 actionTable 'out=in;
' #txt
Bk8 f51 actionCode 'import ch.ivy.addon.portalkit.enums.SessionAttribute;
import ch.ivy.addon.portalkit.util.SecurityServiceUtils;
SecurityServiceUtils.setSessionAttribute(SessionAttribute.PORTAL_START_PMV_ID.toString(), ivy.task.getProcessModelVersion().getId());
' #txt
Bk8 f51 security system #txt
Bk8 f51 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>store portal start &#xD;
pmv </name>
...
' #txt
Bk8 f51 136 138 128 44 -43 -16 #rect
Bk8 f51 @|StepIcon #fIcon
Bk8 f20 actionTable 'out=in;
' #txt
Bk8 f20 actionCode 'import ch.ivy.addon.portalkit.enums.PortalLibrary;
import org.apache.commons.lang3.StringUtils;
import ch.ivyteam.ivy.workflow.StandardProcessType;
...
' #txt
Bk8 f20 296 138 144 44 -53 -16 #rect
Bk8 f20 @|StepIcon #fIcon
Bk8 f14 expr out #txt
Bk8 f14 264 160 296 160 #arcP
...
Bk6 f73 mainOut f118 tail #connect
Bk6 f118 head f69 mainIn #connect
Bk6 f69 mainOut f67 tail #connect
Bk6 f67 head f84 mainIn #connect
Bk6 g0 m f0 tail #connect
Bk6 f0 head f73 mainIn #connect
Bk6 f1 head g1 m #connect
Bk6 f84 mainOut f1 tail #connect
...
Bk8 f51 mainOut f14 tail #connect
Bk8 f14 head f20 mainIn #connect
Bk8 g0 m f0 tail #connect
Bk8 f0 head f51 mainIn #connect
Bk8 f1 head g1 m #connect
Bk8 f20 mainOut f1 tail #connect
