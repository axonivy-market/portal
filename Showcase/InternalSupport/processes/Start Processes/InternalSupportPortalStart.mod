...
Pt0 f88 312 288 585 201 #arcP
Pt0 f88 1 512 288 #addKink
Pt0 f88 0 0.7914539881357558 0 0 #arcLabel
...
Bk0 f36 dialogId internalPortal.InternalPortalHome #txt
Bk0 f36 startMethod start() #txt
Bk0 f36 requestActionDecl '<> param;' #txt
