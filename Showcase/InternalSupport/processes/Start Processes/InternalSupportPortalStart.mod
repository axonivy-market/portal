...
Bk1 @GridStep f69 '' #zField
Bk1 @PushWFArc f67 '' #zField
Bk1 @PushWFArc f118 '' #zField
Bk1 @CallSub f84 '' #zField
Bk1 @CallSub f73 '' #zField
...
Bk1 f69 actionTable 'out=in;
' #txt
Bk1 f69 actionCode 'import ch.ivy.addon.portalkit.enums.TaskAssigneeType;
...
' #txt
Bk1 f69 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk1 f69 296 136 112 48 -39 -16 #rect
Bk1 f67 expr out #txt
Bk1 f67 408 160 492 160 #arcP
Bk1 f118 expr out #txt
Bk1 f118 248 160 296 160 #arcP
Bk1 f84 processCall 'Functional Processes/OpenPortalTasks:useView(ch.ivy.addon.portal.generic.view.TaskView)' #txt
Bk1 f84 requestActionDecl '<ch.ivy.addon.portal.generic.view.TaskView taskView> param;' #txt
Bk1 f84 requestMappingAction 'param.taskView=in.taskView;
' #txt
Bk1 f84 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk1 f84 responseMappingAction 'out=in;
' #txt
Bk1 f84 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk1 f84 492 140 104 40 -48 -12 #rect
Bk1 f73 processCall 'Functional Processes/InitializeTaskDataModel:call()' #txt
Bk1 f73 requestActionDecl '<> param;' #txt
Bk1 f73 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk1 f73 responseMappingAction 'out=in;
out.dataModel=result.dataModel;
' #txt
Bk1 f73 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk1 f73 136 138 112 44 -40 -8 #rect
...
Bk3 f17 actionTable 'out=in;
' #txt
Bk3 f17 actionCode 'import ch.ivyteam.ivy.workflow.ITask;
import ch.ivyteam.ivy.workflow.ICase;
import ch.ivyteam.ivy.workflow.query.CaseQuery;
...
' #txt
Bk3 f17 352 266 112 44 -27 -8 #rect
Bk3 f68 actionTable 'out=in;
' #txt
Bk3 f68 actionCode 'out.taskSelected = ivy.wf.findTask(Long.valueOf(in.endedTaskId));' #txt
Bk3 f68 security system #txt
Bk3 f68 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk3 f68 352 170 112 44 -35 -8 #rect
Bk3 f52 actionTable 'out=in;
' #txt
Bk3 f52 actionCode 'import ch.ivy.addon.portalkit.datamodel.CaseLazyDataModel;
...
' #txt
Bk3 f52 352 458 112 44 -46 -8 #rect
Bk3 f19 actionTable 'out=in;
' #txt
Bk3 f19 actionCode 'import ch.ivy.addon.portal.generic.view.TaskView;
...
' #txt
Bk3 f19 352 356 128 56 -43 -16 #rect
Bk3 f37 processCall 'Functional Processes/OpenPortalSearch:call(ch.ivy.addon.portalkit.datamodel.SearchResultsDataModel,Number)' #txt
Bk3 f37 requestActionDecl '<ch.ivy.addon.portalkit.datamodel.SearchResultsDataModel searchResultsDataModel,Number activeTabIndex> param;' #txt
Bk3 f37 requestMappingAction 'param.searchResultsDataModel=in.searchResultsDataModel;
param.activeTabIndex=1;
' #txt
Bk3 f37 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk3 f37 responseMappingAction 'out=in;
' #txt
Bk3 f37 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk3 f37 560 458 112 44 -50 -8 #rect
Bk3 f0 208 80 32 32 0 16 #rect
...
' #txt
Bk3 g0 83 83 26 26 0 5 #rect
Bk3 f23 processCall 'Functional Processes/OpenPortalCaseDetailsHook:call(ch.ivyteam.ivy.workflow.ICase,Boolean)' #txt
Bk3 f23 requestActionDecl '<ch.ivyteam.ivy.workflow.ICase caseData,Boolean isShowBackButton> param;' #txt
Bk3 f23 requestMappingAction 'param.caseData=in.caseSelected;
param.isShowBackButton=true;
' #txt
Bk3 f23 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk3 f23 responseMappingAction 'out=in;
' #txt
Bk3 f23 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk3 f23 544 266 160 44 -76 -8 #rect
Bk3 f6 processCall 'Functional Processes/OpenPortalTaskDetailsHook:call(ch.ivyteam.ivy.workflow.ITask,ch.ivy.addon.portalkit.datamodel.TaskLazyDataModel,ch.ivy.addon.portalkit.enums.PortalPage,Boolean)' #txt
Bk3 f6 requestActionDecl '<ch.ivyteam.ivy.workflow.ITask task,ch.ivy.addon.portalkit.datamodel.TaskLazyDataModel dataModel,ch.ivy.addon.portalkit.enums.PortalPage portalPage,Boolean isFromTaskList> param;' #txt
Bk3 f6 requestMappingAction 'param.task=in.taskSelected;
param.dataModel=in.dataModel;
param.portalPage=in.portalPage;
param.isFromTaskList=false;
' #txt
Bk3 f6 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
...
' #txt
Bk3 f6 512 170 176 44 -78 -8 #rect
Bk3 f12 processCall 'Functional Processes/OpenPortalTasks:useView(ch.ivy.addon.portal.generic.view.TaskView)' #txt
Bk3 f12 requestActionDecl '<ch.ivy.addon.portal.generic.view.TaskView taskView> param;' #txt
Bk3 f12 requestMappingAction 'param.taskView=in.taskView;
' #txt
Bk3 f12 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
...
' #txt
Bk3 f12 572 360 104 48 -46 -6 #rect
Bk3 f42 expr out #txt
Bk3 f42 464 192 512 192 #arcP
Bk3 f42 0 0.075 -1 -9 #arcLabel
Bk3 f49 expr out #txt
Bk3 f49 464 480 560 480 #arcP
Bk3 f26 expr out #txt
Bk3 f26 464 288 544 288 #arcP
Bk3 f39 expr out #txt
Bk3 f39 480 384 572 384 #arcP
Bk3 f39 0 0.7418894103244236 0 0 #arcLabel
Bk3 f7 dialogId ch.ivy.addon.portal.generic.PortalUrlCallback #txt
Bk3 f7 startMethod start(String) #txt
Bk3 f7 requestActionDecl '<String callbackUrl> param;' #txt
Bk3 f7 requestMappingAction 'param.callbackUrl=in.callbackUrl;
' #txt
Bk3 f7 responseMappingAction 'out=in;
' #txt
...
' #txt
Bk3 f7 448 74 112 44 -45 -8 #rect
Bk3 f8 expr in #txt
Bk3 f8 outCond 'org.apache.commons.lang3.StringUtils.isNotBlank(in.#callbackUrl)' #txt
...
Bk3 f3 expr in #txt
Bk3 f3 outCond 'java.util.Objects.equals(ch.ivy.addon.portalkit.enums.PortalPage.CASE_DETAIL_FROM_TASK, in.#portalPage)' #txt
Bk3 f3 228 108 352 288 #arcP
Bk3 f3 1 288 288 #addKink
Bk3 f3 0 0.7110060291341136 0 0 #arcLabel
Bk3 f4 expr in #txt
Bk3 f4 outCond 'java.util.Objects.equals(ch.ivy.addon.portalkit.enums.PortalPage.TASK_LIST, in.#portalPage)' #txt
Bk3 f4 226 110 352 384 #arcP
Bk3 f4 1 256 384 #addKink
Bk3 f4 1 0.32297169520409286 0 0 #arcLabel
Bk3 f5 expr in #txt
Bk3 f5 224 112 352 480 #arcP
Bk3 f5 1 224 480 #addKink
Bk3 f5 1 0.32297169520409286 0 0 #arcLabel
Bk3 f1 109 96 208 96 #arcP
>Proto Bk3 0 0 32 24 18 0 #rect
>Proto Bk3 @|BpmnUserTaskIcon #fIcon
Bk4 f8 760 160 716 160 #arcP
...
' #txt
Bk4 f36 604 138 112 44 -45 -8 #rect
...
' #txt
Bk4 f22 452 138 112 44 -38 -8 #rect
Bk4 f54 268 144 32 32 0 16 #rect
Bk4 f43 564 160 604 160 #arcP
...
' #txt
Bk4 f3 760 138 144 44 -63 -16 #rect
...
' #txt
Bk4 f5 284 176 340 256 #arcP
Bk4 f5 1 284 256 #addKink
Bk4 f5 1 0.42857142857142855 0 -10 #arcLabel
Bk4 f11 77 160 124 160 #arcP
Bk4 f2 364 144 32 32 0 16 #rect
Bk4 f7 expr in #txt
Bk4 f7 outCond 'ch.addon.portal.generic.userprofile.homepage.HomepageUtils.isShowDashboard(in.#homepage, in.#isShowDashboard)' #txt
Bk4 f7 .xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>dashboard</name>
    </language>
...
' #txt
Bk4 f7 300 160 364 160 #arcP
Bk4 f7 0 0.40625 0 -12 #arcLabel
Bk4 f6 expr in #txt
Bk4 f6 outCond ch.addon.portal.generic.userprofile.homepage.HomepageUtils.isShowLegacyUI() #txt
Bk4 f6 396 160 452 160 #arcP
Bk4 f9 dialogId ch.ivy.addon.portal.generic.dashboard.PortalDashboard #txt
Bk4 f9 startMethod start() #txt
Bk4 f9 requestActionDecl '<> param;' #txt
Bk4 f9 responseMappingAction 'out=in;
' #txt
Bk4 f9 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk4 f9 600 58 112 44 -47 -8 #rect
Bk4 f10 expr in #txt
Bk4 f10 .xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk4 f10 380 144 600 80 #arcP
Bk4 f10 1 380 80 #addKink
Bk4 f10 1 0.2590909090909091 0 -10 #arcLabel
...
Bk1 f73 mainOut f118 tail #connect
Bk1 f118 head f69 mainIn #connect
Bk1 f69 mainOut f67 tail #connect
Bk1 f67 head f84 mainIn #connect
Bk1 g0 m f0 tail #connect
Bk1 f0 head f73 mainIn #connect
Bk1 f1 head g1 m #connect
Bk1 f84 mainOut f1 tail #connect
...
Bk3 f17 mainOut f26 tail #connect
Bk3 f26 head f23 mainIn #connect
Bk3 f19 mainOut f39 tail #connect
Bk3 f39 head f12 mainIn #connect
Bk3 f52 mainOut f49 tail #connect
Bk3 f49 head f37 mainIn #connect
Bk3 f68 mainOut f42 tail #connect
Bk3 f42 head f6 mainIn #connect
Bk3 g0 m f1 tail #connect
Bk3 f1 head f0 in #connect
Bk3 f0 out f8 tail #connect
Bk3 f8 head f7 mainIn #connect
Bk3 f0 out f2 tail #connect
Bk3 f2 head f68 mainIn #connect
Bk3 f0 out f3 tail #connect
Bk3 f3 head f17 mainIn #connect
Bk3 f0 out f4 tail #connect
Bk3 f4 head f19 mainIn #connect
...
Bk4 g0 m f11 tail #connect
Bk4 f11 head f1 mainIn #connect
Bk4 f54 out f7 tail #connect
Bk4 f7 head f2 in #connect
Bk4 f54 out f5 tail #connect
Bk4 f2 out f6 tail #connect
Bk4 f6 head f22 mainIn #connect
Bk4 f2 out f10 tail #connect
Bk4 f10 head f9 mainIn #connect
Bk4 0 0 944 320 0 #ivRect
