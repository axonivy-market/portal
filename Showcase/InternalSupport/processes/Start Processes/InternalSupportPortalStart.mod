...
Bk2 f106 @|StepIcon #fIcon
Bk2 f104 processCall 'Functional Processes/OpenPortalCaseDetailsHook:call(ICase,Boolean)' #txt
...
' #txt
Bk3 f17 352 170 112 44 -27 -8 #rect
Bk3 f17 @|StepIcon #fIcon
Bk3 f68 actionTable 'out=in;
' #txt
Bk3 f68 actionCode 'out.taskSelected = ivy.wf.findTask(in.endedTaskId);' #txt
...
' #txt
Bk3 f68 352 74 112 44 -35 -8 #rect
Bk3 f68 @|StepIcon #fIcon
...
' #txt
Bk3 f52 352 362 112 44 -46 -8 #rect
...
' #txt
Bk3 f19 352 260 128 56 -43 -16 #rect
Bk3 f19 @|StepIcon #fIcon
...
' #txt
Bk3 f37 560 362 112 44 -50 -8 #rect
Bk3 f37 @|CallSubIcon #fIcon
...
Bk3 f23 processCall 'Functional Processes/OpenPortalCaseDetailsHook:call(ICase,Boolean)' #txt
...
' #txt
Bk3 f23 544 170 160 44 -76 -8 #rect
Bk3 f23 @|CallSubIcon #fIcon
...
' #txt
Bk3 f6 512 74 176 44 -78 -8 #rect
Bk3 f6 @|CallSubIcon #fIcon
...
Bk3 f3 230 106 352 192 #arcP
Bk3 f3 1 288 192 #addKink
Bk3 f3 0 0.565648129243984 0 0 #arcLabel
...
Pt0 f83 ao f8 tail #connect
Pt0 f8 head f7 @CG|ai #connect
