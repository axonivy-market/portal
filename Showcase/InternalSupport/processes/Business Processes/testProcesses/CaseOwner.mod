...
Cr0 f7 startName 'Test role is owner' #txt
...
' #txt
Cr0 f10 actionCode ivy.case.setOwner(ivy.wf.getSecurityContext().findRole("Test")); #txt
...
' #txt
Cr0 f10 168 138 112 44 -34 -16 #rect
...
Cr0 f12 var in1 #txt
Cr0 f12 280 160 336 160 #arcP
Cr0 f13 expr out #txt
Cr0 f13 111 160 168 160 #arcP
