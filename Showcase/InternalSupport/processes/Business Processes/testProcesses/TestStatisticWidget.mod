...
Tt0 f0 type internaltest.TestStatisticWidgetData #txt
Tt0 f0 inParamDecl '<> param;' #txt
Tt0 f0 actionDecl 'internaltest.TestStatisticWidgetData out;
' #txt
Tt0 f0 guid 16150F67EE7B2FB2 #txt
...
Tt0 f1 type internaltest.TestStatisticWidgetData #txt
Tt0 f1 337 49 30 30 0 15 #rect
Tt0 f1 @|EndIcon #fIcon
Tt0 f3 targetWindow NEW #txt
Tt0 f3 targetDisplay TOP #txt
Tt0 f3 richDialogId internalPortal.TestStatisticWidgetPage #txt
Tt0 f3 startMethod start() #txt
Tt0 f3 type internaltest.TestStatisticWidgetData #txt
