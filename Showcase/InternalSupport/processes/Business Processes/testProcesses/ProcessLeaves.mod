[Ivy]
[>Created: Mon Jan 18 16:43:10 ICT 2016]
...
Ps0 f0 startName '<b>Employee Leave Request</b>' #txt
Ps0 f0 startDescription '<u><i>Urlaubsantrag erstellen und genehmigen</i></u>
' #txt
Ps0 f0 taskData '#
#Mon Jul 13 17:31:30 ICT 2015
...
case.description=
case.name=Process Leave Management Case
correspondent.id=
...
process.code=
process.name=
processCategory.code=HolidayRequested
...
Ps0 f18 template "RedirectToTaskList.jsp" #txt
...
TaskA.customFields.varchar.1=in1.Mitarbeiter
TaskA.customFields.varchar.5="CategoryDemo/BookByHR"
' #txt
...
Ct3 f12 template "traffic-control.jsp" #txt
...
Ct3 f0 var in1 #txt
Ct3 f0 template traffic-control.jsp #txt
