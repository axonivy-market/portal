...
Sy0 f0 type internaltest.SearchByCaseJsonQueryData #txt
Sy0 f0 inParamDecl '<> param;' #txt
Sy0 f0 actionDecl 'internaltest.SearchByCaseJsonQueryData out;
' #txt
Sy0 f0 guid 15FA421D27186643 #txt
...
Sy0 f0 taskData 'TaskTriggered.ROL=Everybody
...
Sy0 f3 actionDecl 'internaltest.SearchByCaseJsonQueryData out;
' #txt
...
Sy0 f3 type internaltest.SearchByCaseJsonQueryData #txt
