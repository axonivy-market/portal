...
Rs0 f0 inParameterDecl '<com.axonivy.portal.businessuserexamples.humantask.ProcurementRequest activityLog> param;' #txt
...
>Proto Rs0 .type com.axonivy.portal.businessuserexamples.humantask.RequestLog.RequestLogData #txt
