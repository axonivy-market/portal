...
>Proto As0 As0 CheckInternalSolvencyProcess #zField
...
>Proto As0 .type com.axonivy.portal.userexamples.credit.CheckInternalSolvency.CheckInternalSolvencyData #txt
