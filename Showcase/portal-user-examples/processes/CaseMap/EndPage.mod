...
Ee0 f3 dialogId com.axonivy.portal.userexamples.credit.CustomEndPage #txt
Ee0 f3 startMethod start(Long) #txt
Ee0 f3 requestActionDecl '<Long caseId> param;' #txt
...
' #txt
Ee0 f3 168 42 112 44 -47 -8 #rect
Ee0 f3 @|UserDialogIcon #fIcon
Ee0 f4 111 64 168 64 #arcP
Ee0 f2 280 64 337 64 #arcP
>Proto Ee0 .type com.axonivy.portal.userexamples.Data #txt
