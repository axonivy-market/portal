[Ivy]
[>Created: Tue Jan 19 10:03:00 ICT 2016]
14CE46BFBCEBA622 3.18 #module
...
Ae0 f6 type test002ITInfrastructure.PortalData #txt
Ae0 f6 requestActionDecl '<> param;' #txt
Ae0 f6 responseActionDecl 'test002ITInfrastructure.PortalData out;
' #txt
...
Ae0 f3 type test002ITInfrastructure.PortalData #txt
Ae0 f3 inParamDecl '<java.lang.Number caseId> param;' #txt
Ae0 f3 inParamTable 'out.caseId=param.caseId;
' #txt
Ae0 f3 actionDecl 'test002ITInfrastructure.PortalData out;
' #txt
...
Ae0 f8 richDialogId infrastructure.casedetails.PortalCaseDetails #txt
Ae0 f8 startMethod start(Number) #txt
Ae0 f8 type test002ITInfrastructure.PortalData #txt
Ae0 f8 requestActionDecl '<Number caseId> param;' #txt
Ae0 f8 requestMappingAction 'param.caseId=in.caseId;
' #txt
Ae0 f8 responseActionDecl 'test002ITInfrastructure.PortalData out;
' #txt
...
Ae0 f11 richDialogId infrastructure.caselist.RequestUserEquipmentCaseList #txt
Ae0 f11 startMethod start() #txt
Ae0 f11 type test002ITInfrastructure.PortalData #txt
Ae0 f11 requestActionDecl '<> param;' #txt
Ae0 f11 responseActionDecl 'test002ITInfrastructure.PortalData out;
' #txt
...
Ae0 f11 254 277 36 22 20 -2 #rect
Ae0 f11 @|RichDialogIcon #fIcon
Ae0 f10 outLink InternalUserEquipmentCaseList.ivp #txt
Ae0 f10 type test002ITInfrastructure.PortalData #txt
Ae0 f10 inParamDecl '<> param;' #txt
Ae0 f10 actionDecl 'test002ITInfrastructure.PortalData out;
' #txt
Ae0 f10 guid 14CEA84856C70816 #txt
Ae0 f10 requestEnabled true #txt
Ae0 f10 triggerEnabled false #txt
Ae0 f10 callSignature InternalUserEquipmentCaseList() #txt
Ae0 f10 persist false #txt
Ae0 f10 taskData '#
#Fri Apr 24 17:02:54 ICT 2015
TaskTriggered.ROL=Everybody
TaskTriggered.EXTYPE=0
TaskTriggered.EXPRI=2
TaskTriggered.TYPE=0
...
<elementInfo>
    <language>
        <name>InternalUserEquipmentCaseList.ivp</name>
    </language>
</elementInfo>
' #txt
Ae0 f10 @C|.responsibility Everybody #txt
Ae0 f10 76 275 25 26 -16 19 #rect
Ae0 f10 @|StartRequestIcon #fIcon
Ae0 f12 expr out #txt
Ae0 f12 100 288 254 288 #arcP
Ae0 f5 expr out #txt
Ae0 f5 111 64 246 64 #arcP
>Proto Ae0 .type test002ITInfrastructure.PortalData #txt
