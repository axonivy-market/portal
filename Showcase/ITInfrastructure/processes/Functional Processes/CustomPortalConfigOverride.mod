[Ivy]
[>Created: Fri Apr 24 15:24:19 ICT 2015]
14CEA72CCC6CD96D 3.17 #module
...
' #txt
Cg0 f0 actionDecl 'test002ITInfrastructure.CustomPortalConfigOverrideData out;
' #txt
Cg0 f0 callSignature call(ch.ivy.addon.portal.generic.PortalConfig) #txt
Cg0 f0 type test002ITInfrastructure.CustomPortalConfigOverrideData #txt
...
Cg0 f1 type test002ITInfrastructure.CustomPortalConfigOverrideData #txt
Cg0 f1 369 201 30 30 0 15 #rect
Cg0 f1 @|EndSubIcon #fIcon
Cg0 f5 actionDecl 'test002ITInfrastructure.CustomPortalConfigOverrideData out;
' #txt
...
holiday.displayName = "Request User Equipment";
holiday.url = ivy.html.startref("Start Processes/InternalPortalHome/InternalUserEquipmentCaseList.ivp");
...
Cg0 f5 type test002ITInfrastructure.CustomPortalConfigOverrideData #txt
...
>Proto Cg0 .type test002ITInfrastructure.CustomPortalConfigOverrideData #txt
