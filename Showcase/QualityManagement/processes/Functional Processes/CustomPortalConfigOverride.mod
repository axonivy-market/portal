[Ivy]
[>Created: Fri Apr 24 16:17:35 ICT 2015]
14CEA7331EA47BB9 3.17 #module
...
' #txt
Cg0 f0 actionDecl 'test004QualityManagement.CustomPortalConfigOverrideData out;
' #txt
Cg0 f0 callSignature call(ch.ivy.addon.portal.generic.PortalConfig) #txt
Cg0 f0 type test004QualityManagement.CustomPortalConfigOverrideData #txt
...
Cg0 f1 type test004QualityManagement.CustomPortalConfigOverrideData #txt
Cg0 f1 369 201 30 30 0 15 #rect
Cg0 f1 @|EndSubIcon #fIcon
Cg0 f5 actionDecl 'test004QualityManagement.CustomPortalConfigOverrideData out;
' #txt
...
out.portalConfig.homeLink = ivy.html.startref("Start Processes/InternalPortalHome/start.ivp");
out.portalConfig.customLinkList = new List<ch.ivy.addon.portal.generic.CustomPortalLink>();

//custome link here
CustomPortalLink q001 = new CustomPortalLink();
q001.displayName = "Audit Stage Prepare List";
q001.url = ivy.html.startref("Start Processes/InternalPortalHome/InternalAuditPrepareCaseList.ivp");
q001.icon = "fa fa-cubes";
out.portalConfig.customLinkList.add(q001);

CustomPortalLink q002 = new CustomPortalLink();
q002.displayName = "Audit Stage Perform List";
q002.url = ivy.html.startref("Start Processes/InternalPortalHome/InternalAuditStagePerformCaseList.ivp");
q002.icon = "fa fa-cube";
out.portalConfig.customLinkList.add(q002);
' #txt
Cg0 f5 type test004QualityManagement.CustomPortalConfigOverrideData #txt
...
>Proto Cg0 .type test004QualityManagement.CustomPortalConfigOverrideData #txt
