...
' #txt
Gs0 f0 actionDecl '_ch.ivyteam.ivy.project.portal.examples.GetGroupChatParamsOverrideData out;
' #txt
Gs0 f0 callSignature getGroupChatParams() #txt
Gs0 f0 type _ch.ivyteam.ivy.project.portal.examples.GetGroupChatParamsOverrideData #txt
...
Gs0 f1 type _ch.ivyteam.ivy.project.portal.examples.GetGroupChatParamsOverrideData #txt
Gs0 f1 337 49 30 30 0 15 #rect
Gs0 f1 @|EndSubIcon #fIcon
Gs0 f3 actionDecl '_ch.ivyteam.ivy.project.portal.examples.GetGroupChatParamsOverrideData out;
' #txt
Gs0 f3 actionTable 'out=in;
' #txt
Gs0 f3 actionCode 'out.params.put("groupChatCreator", ivy.session.getSessionUser().getDisplayName());
' #txt
Gs0 f3 security system #txt
Gs0 f3 type _ch.ivyteam.ivy.project.portal.examples.GetGroupChatParamsOverrideData #txt
...
>Proto Gs0 .type _ch.ivyteam.ivy.project.portal.examples.GetGroupChatParamsOverrideData #txt
