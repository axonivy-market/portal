...
Ce0 f0 inParamDecl '<java.util.List<com.axonivy.portal.component.dto.RoleDTO> roles,java.util.List<com.axonivy.portal.component.dto.UserDTO> users,com.axonivy.portal.component.dto.SecurityMemberDTO currentUser,ch.ivyteam.ivy.workflow.ITask task> param;' #txt
Ce0 f0 inParamTable 'out.currentUser=param.currentUser;
out.roles=param.roles;
out.task=param.task;
out.users=param.users;
' #txt
Ce0 f0 outParamDecl '<java.util.List<com.axonivy.portal.component.dto.UserDTO> users,java.util.List<com.axonivy.portal.component.dto.RoleDTO> roles> result;' #txt
Ce0 f0 outParamTable 'result.users=in.users;
result.roles=in.roles;
' #txt
Ce0 f0 callSignature call(java.util.List<com.axonivy.portal.component.dto.RoleDTO>,java.util.List<com.axonivy.portal.component.dto.UserDTO>,com.axonivy.portal.component.dto.SecurityMemberDTO,ch.ivyteam.ivy.workflow.ITask) #txt
