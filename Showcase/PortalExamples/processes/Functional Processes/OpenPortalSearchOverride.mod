...
' #txt
Oh0 f0 actionDecl '_ch.ivyteam.ivy.project.portal.examples.OpenPortalSearchOverrideData out;
' #txt
Oh0 f0 callSignature call(String) #txt
Oh0 f0 type _ch.ivyteam.ivy.project.portal.examples.OpenPortalSearchOverrideData #txt
...
Oh0 f1 type _ch.ivyteam.ivy.project.portal.examples.OpenPortalSearchOverrideData #txt
Oh0 f1 337 49 30 30 0 15 #rect
Oh0 f1 @|EndSubIcon #fIcon
Oh0 f3 targetWindow NEW #txt
Oh0 f3 targetDisplay TOP #txt
Oh0 f3 richDialogId ch.ivyteam.ivy.project.portal.examples.customization.CustomizedSearchResults #txt
Oh0 f3 startMethod start(String) #txt
Oh0 f3 type _ch.ivyteam.ivy.project.portal.examples.OpenPortalSearchOverrideData #txt
