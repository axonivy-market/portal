...
' #txt
By0 f0 actionDecl '_ch.ivyteam.ivy.project.portal.examples.BuildTaskJsonQueryOverrideData out;
' #txt
By0 f0 callSignature buildTaskJsonQuery() #txt
By0 f0 type _ch.ivyteam.ivy.project.portal.examples.BuildTaskJsonQueryOverrideData #txt
...
By0 f1 type _ch.ivyteam.ivy.project.portal.examples.BuildTaskJsonQueryOverrideData #txt
By0 f1 51 339 26 26 14 0 #rect
By0 f1 @|EndSubIcon #fIcon
By0 f3 actionDecl '_ch.ivyteam.ivy.project.portal.examples.BuildTaskJsonQueryOverrideData out;
' #txt
By0 f3 actionTable 'out=in;
' #txt
By0 f3 actionCode 'import ch.ivyteam.ivy.workflow.query.TaskQuery;

if (in.isQueryForHomePage) { // in home page
	in.jsonQuery = TaskQuery.create().where().activatorUserId().isNotNull().asJson();
}' #txt
By0 f3 type _ch.ivyteam.ivy.project.portal.examples.BuildTaskJsonQueryOverrideData #txt
...
' #txt
By0 f7 actionDecl '_ch.ivyteam.ivy.project.portal.examples.BuildTaskJsonQueryOverrideData out;
' #txt
By0 f7 callSignature buildTaskJsonQuery(Boolean) #txt
By0 f7 type _ch.ivyteam.ivy.project.portal.examples.BuildTaskJsonQueryOverrideData #txt
...
>Proto By0 .type _ch.ivyteam.ivy.project.portal.examples.BuildTaskJsonQueryOverrideData #txt
