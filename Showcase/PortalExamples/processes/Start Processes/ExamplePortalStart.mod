...
Bk2 @PushWFArc f60 '' #zField
Bk2 @PushWFArc f61 '' #zField
Bk2 @CallSub f62 '' #zField
Bk2 @GridStep f59 '' #zField
Bk2 @CallSub f55 '' #zField
...
Bk3 @GridStep f106 '' #zField
Bk3 @CallSub f104 '' #zField
Bk3 @PushWFArc f107 '' #zField
...
Bk4 @GridStep f17 '' #zField
Bk4 @GridStep f68 '' #zField
Bk4 @GridStep f52 '' #zField
Bk4 @GridStep f19 '' #zField
Bk4 @CallSub f37 '' #zField
Bk4 @Alternative f0 '' #zField
Bk4 @PushTrueWFInG-01 g0 '' #zField
Bk4 @CallSub f23 '' #zField
Bk4 @CallSub f6 '' #zField
Bk4 @CallSub f12 '' #zField
Bk4 @PushWFArc f1 '' #zField
Bk4 @PushWFArc f42 '' #zField
Bk4 @PushWFArc f49 '' #zField
Bk4 @PushWFArc f4 '' #zField
Bk4 @PushWFArc f26 '' #zField
Bk4 @PushWFArc f2 '' #zField
Bk4 @PushWFArc f5 '' #zField
Bk4 @PushWFArc f39 '' #zField
...
' #txt
Pt0 f12 456 170 144 44 -54 -16 #rect
...
' #txt
Pt0 S11 744 168 160 48 -58 -20 #rect
...
Pt0 f5 656 176 32 32 0 16 #rect
...
' #txt
Pt0 f3 1040 74 144 44 -63 -16 #rect
Pt0 f3 @|IBIcon #fIcon
...
' #txt
Pt0 f22 728 74 112 44 -38 -8 #rect
...
Pt0 f18 expr in #txt
Pt0 f18 outCond 'java.util.Objects.equals(ch.ivy.addon.portalkit.enums.PortalPage.HOME_PAGE, in.#portalPage)' #txt
Pt0 f18 672 176 672 112 #arcP
Pt0 f2 296 193 376 192 #arcP
Pt0 f19 expr in #txt
Pt0 f19 outCond 'in.#portalPage == null' #txt
...
Pt0 f21 600 192 656 192 #arcP
Pt0 f16 464 96 656 96 #arcP
Pt0 f38 840 96 888 96 #arcP
Pt0 f6 688 96 728 96 #arcP
Pt0 f23 expr in #txt
Pt0 f23 688 192 744 192 #arcP
...
Bk2 f60 expr out #txt
Bk2 f60 416 160 488 160 #arcP
Bk2 f61 expr out #txt
Bk2 f61 248 160 288 160 #arcP
Bk2 f62 processCall 'Functional Processes/InitializeCaseDataModel:call()' #txt
Bk2 f62 requestActionDecl '<> param;' #txt
Bk2 f62 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk2 f62 responseMappingAction 'out=in;
out.caseDataModel=result.caseDataModel;
' #txt
Bk2 f62 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk2 f62 136 138 112 44 -38 -20 #rect
Bk2 f62 @|CallSubIcon #fIcon
Bk2 f59 actionTable 'out=in;
' #txt
Bk2 f59 actionCode 'import ch.ivy.addon.portalkit.util.PermissionUtils;
import ch.ivy.addon.portalkit.util.SecurityServiceUtils;
...
Bk2 f59 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk2 f59 288 138 128 44 -43 -16 #rect
Bk2 f59 @|StepIcon #fIcon
Bk2 f55 processCall 'Functional Processes/OpenPortalCases:useView(ch.ivy.addon.portal.generic.view.CaseView)' #txt
Bk2 f55 requestActionDecl '<ch.ivy.addon.portal.generic.view.CaseView view> param;' #txt
Bk2 f55 requestMappingAction 'param.view=in.caseView;
' #txt
Bk2 f55 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk2 f55 responseMappingAction 'out=in;
' #txt
Bk2 f55 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk2 f55 488 136 112 48 -49 -12 #rect
Bk2 f55 @|CallSubIcon #fIcon
...
Bk2 f1 expr out #txt
Bk2 f1 600 160 659 160 #arcP
>Proto Bk0 0 0 32 24 18 0 #rect
>Proto Bk0 @|BIcon #fIcon
Bk3 f106 actionTable 'out=in;
' #txt
Bk3 f106 actionCode 'import ch.ivyteam.ivy.workflow.ICase;
...
Bk3 f106 security system #txt
Bk3 f106 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Find Case</name>
    </language>
...
' #txt
Bk3 f106 136 138 112 44 -28 -8 #rect
Bk3 f106 @|StepIcon #fIcon
Bk3 f104 processCall 'Functional Processes/OpenPortalCaseDetailsHook:call(ICase,Boolean)' #txt
Bk3 f104 requestActionDecl '<ch.ivyteam.ivy.workflow.ICase caseData,Boolean isShowBackButton> param;' #txt
Bk3 f104 requestMappingAction 'param.caseData=in.caseSelected;
param.isShowBackButton=true;
' #txt
Bk3 f104 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk3 f104 responseMappingAction 'out=in;
' #txt
Bk3 f104 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk3 f104 288 138 144 44 -65 -8 #rect
Bk3 f104 @|CallSubIcon #fIcon
Bk3 f107 expr out #txt
Bk3 f107 248 160 288 160 #arcP
...
' #txt
Bk3 g1 499 147 26 26 0 5 #rect
Bk3 g1 @|MOGIcon #fIcon
Bk3 f1 expr out #txt
Bk3 f1 432 160 499 160 #arcP
>Proto Bk1 0 0 32 24 18 0 #rect
>Proto Bk1 @|BIcon #fIcon
Bk4 f17 actionTable 'out=in;
' #txt
Bk4 f17 actionCode 'import ch.ivyteam.ivy.workflow.ITask;
...
Bk4 f17 security system #txt
Bk4 f17 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Find case</name>
    </language>
...
' #txt
Bk4 f17 352 170 112 44 -27 -8 #rect
Bk4 f17 @|StepIcon #fIcon
Bk4 f68 actionTable 'out=in;
' #txt
Bk4 f68 actionCode 'out.taskSelected = ivy.wf.findTask(in.endedTaskId);' #txt
Bk4 f68 security system #txt
Bk4 f68 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk4 f68 352 74 112 44 -35 -8 #rect
Bk4 f68 @|StepIcon #fIcon
Bk4 f52 actionTable 'out=in;
' #txt
Bk4 f52 actionCode 'import ch.ivy.addon.portalkit.datamodel.CaseLazyDataModel;
...
' #txt
Bk4 f52 security system #txt
Bk4 f52 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
...
' #txt
Bk4 f52 352 362 112 44 -46 -8 #rect
Bk4 f52 @|StepIcon #fIcon
Bk4 f19 actionTable 'out=in;
' #txt
Bk4 f19 actionCode 'import ch.ivy.addon.portal.generic.view.TaskView;
...
Bk4 f19 security system #txt
Bk4 f19 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>build data model,
 task </name>
...
' #txt
Bk4 f19 352 260 128 56 -43 -16 #rect
Bk4 f19 @|StepIcon #fIcon
Bk4 f37 processCall 'Functional Processes/OpenPortalSearch:call(ch.ivy.addon.portalkit.datamodel.SearchResultsDataModel,Number)' #txt
Bk4 f37 requestActionDecl '<ch.ivy.addon.portalkit.datamodel.SearchResultsDataModel searchResultsDataModel,Number activeTabIndex> param;' #txt
Bk4 f37 requestMappingAction 'param.searchResultsDataModel=in.searchResultsDataModel;
param.activeTabIndex=1;
' #txt
Bk4 f37 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk4 f37 responseMappingAction 'out=in;
' #txt
...
' #txt
Bk4 f37 560 362 112 44 -50 -8 #rect
Bk4 f37 @|CallSubIcon #fIcon
Bk4 f0 208 80 32 32 0 16 #rect
...
' #txt
Bk4 g0 83 83 26 26 0 5 #rect
Bk4 g0 @|MIGIcon #fIcon
Bk4 f23 processCall 'Functional Processes/OpenPortalCaseDetailsHook:call(ICase,Boolean)' #txt
Bk4 f23 requestActionDecl '<ch.ivyteam.ivy.workflow.ICase caseData,Boolean isShowBackButton> param;' #txt
Bk4 f23 requestMappingAction 'param.caseData=in.caseSelected;
param.isShowBackButton=false;
' #txt
Bk4 f23 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk4 f23 responseMappingAction 'out=in;
' #txt
...
' #txt
Bk4 f23 544 170 160 44 -76 -8 #rect
Bk4 f23 @|CallSubIcon #fIcon
Bk4 f6 processCall 'Functional Processes/OpenPortalTaskDetailsHook:call(ch.ivyteam.ivy.workflow.ITask,ch.ivy.addon.portalkit.datamodel.TaskLazyDataModel,ch.ivy.addon.portalkit.enums.PortalPage,Boolean)' #txt
Bk4 f6 requestActionDecl '<ch.ivyteam.ivy.workflow.ITask task,ch.ivy.addon.portalkit.datamodel.TaskLazyDataModel dataModel,ch.ivy.addon.portalkit.enums.PortalPage portalPage,Boolean isFromTaskList> param;' #txt
Bk4 f6 requestMappingAction 'param.task=in.taskSelected;
param.dataModel=in.dataModel;
param.portalPage=in.portalPage;
param.isFromTaskList=false;
' #txt
Bk4 f6 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
Bk4 f6 responseMappingAction 'out=in;
' #txt
...
' #txt
Bk4 f6 512 74 176 44 -78 -8 #rect
Bk4 f6 @|CallSubIcon #fIcon
Bk4 f12 processCall 'Functional Processes/OpenPortalTasks:useView(ch.ivy.addon.portal.generic.view.TaskView)' #txt
Bk4 f12 requestActionDecl '<ch.ivy.addon.portal.generic.view.TaskView taskView> param;' #txt
Bk4 f12 requestMappingAction 'param.taskView=in.taskView;
' #txt
Bk4 f12 responseActionDecl 'ch.ivy.addon.portal.generic.PortalStartData out;
' #txt
...
' #txt
Bk4 f12 572 264 104 48 -46 -6 #rect
Bk4 f12 @|CallSubIcon #fIcon
Bk4 f1 109 96 208 96 #arcP
Bk4 f42 expr out #txt
Bk4 f42 464 96 512 96 #arcP
Bk4 f42 0 0.075 -1 -9 #arcLabel
Bk4 f49 expr out #txt
Bk4 f49 464 384 560 384 #arcP
Bk4 f4 expr in #txt
Bk4 f4 outCond 'java.util.Objects.equals(ch.ivy.addon.portalkit.enums.PortalPage.TASK_LIST, in.#portalPage)' #txt
Bk4 f4 226 110 352 288 #arcP
Bk4 f4 1 256 288 #addKink
Bk4 f4 0 0.7110060291341136 0 0 #arcLabel
Bk4 f26 expr out #txt
Bk4 f26 464 192 544 192 #arcP
Bk4 f2 expr in #txt
Bk4 f2 outCond 'in.isTaskStartedInDetails && !in.isTaskFinished' #txt
Bk4 f2 240 96 352 96 #arcP
Bk4 f5 expr in #txt
Bk4 f5 224 112 352 384 #arcP
Bk4 f5 1 224 384 #addKink
Bk4 f5 1 0.32297169520409286 0 0 #arcLabel
Bk4 f39 expr out #txt
Bk4 f39 480 288 572 288 #arcP
Bk4 f39 0 0.7418894103244236 0 0 #arcLabel
Bk4 f3 expr in #txt
Bk4 f3 outCond 'java.util.Objects.equals(ch.ivy.addon.portalkit.enums.PortalPage.CASE_DETAIL_FROM_TASK, in.#portalPage)' #txt
Bk4 f3 230 106 352 192 #arcP
Bk4 f3 1 288 192 #addKink
Bk4 f3 0 0.565648129243984 0 0 #arcLabel
...
Bk2 f62 mainOut f61 tail #connect
Bk2 f61 head f59 mainIn #connect
Bk2 f59 mainOut f60 tail #connect
Bk2 f60 head f55 mainIn #connect
Bk2 g0 m f0 tail #connect
Bk2 f0 head f62 mainIn #connect
Bk2 f1 head g1 m #connect
Bk2 f55 mainOut f1 tail #connect
Bk2 0 0 736 320 0 #ivRect
Bk3 f106 mainOut f107 tail #connect
Bk3 f107 head f104 mainIn #connect
Bk3 g0 m f0 tail #connect
Bk3 f0 head f106 mainIn #connect
Bk3 f1 head g1 m #connect
Bk3 f104 mainOut f1 tail #connect
Bk3 0 0 576 320 0 #ivRect
Bk4 f17 mainOut f26 tail #connect
Bk4 f26 head f23 mainIn #connect
Bk4 f19 mainOut f39 tail #connect
Bk4 f39 head f12 mainIn #connect
Bk4 f52 mainOut f49 tail #connect
Bk4 f49 head f37 mainIn #connect
Bk4 f68 mainOut f42 tail #connect
Bk4 f42 head f6 mainIn #connect
Bk4 g0 m f1 tail #connect
Bk4 f1 head f0 in #connect
Bk4 f0 out f2 tail #connect
Bk4 f2 head f68 mainIn #connect
Bk4 f0 out f3 tail #connect
Bk4 f3 head f17 mainIn #connect
Bk4 f0 out f4 tail #connect
Bk4 f4 head f19 mainIn #connect
Bk4 f0 out f5 tail #connect
Bk4 f5 head f52 mainIn #connect
Bk4 0 0 736 480 0 #ivRect
