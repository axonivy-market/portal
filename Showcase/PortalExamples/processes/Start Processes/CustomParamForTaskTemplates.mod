...
' #txt
Cs0 f3 outLinks "TaskA.ivp","TaskB.ivp" #txt
...
Cs0 f5 dialogId ch.ivyteam.ivy.project.portal.examples.testdata.CustomParamsForIFrame #txt
...
Cs0 f7 dialogId ch.ivyteam.ivy.project.portal.examples.testdata.CustomParamsForTaskTemplate8 #txt
...
>Proto Cs0 .type ch.ivyteam.ivy.project.portal.examples.CustomParamForTaskTemplatesData #txt
