...
Re0 f3 dialogId ch.ivyteam.ivy.project.portal.examples.RoleSelectionExample #txt
...
TaskA.TYPE=2' #txt
Re0 f5 337 49 30 30 0 16 #rect
Re0 f5 @|TaskSwitchSimpleIcon #fIcon
Re0 f6 296 64 337 64 #arcP
Re0 f2 367 64 433 64 #arcP
