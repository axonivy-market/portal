...
TaskTriggered.PRI=2
TaskTriggered.NAM=Start\: Global Growl
...
Gl0 f4 expr out #txt
Gl0 f4 type ch.ivyteam.ivy.project.portal.examples.GlobalGrowlData #txt
Gl0 f4 var in1 #txt
