...
Dt0 @RichDialog f3 '' #zField
Dt0 @PushWFArc f4 '' #zField
Dt0 @PushWFArc f2 '' #zField
>Proto Dt0 Dt0 DocumentTableComponent #zField
Dt0 f0 outLink start.ivp #txt
Dt0 f0 type ch.ivyteam.ivy.project.portal.examples.DocumentTableComponentData #txt
Dt0 f0 inParamDecl '<> param;' #txt
Dt0 f0 actionDecl 'ch.ivyteam.ivy.project.portal.examples.DocumentTableComponentData out;
' #txt
Dt0 f0 guid 16B4472358821239 #txt
...
Dt0 f1 type ch.ivyteam.ivy.project.portal.examples.DocumentTableComponentData #txt
Dt0 f1 337 49 30 30 0 15 #rect
Dt0 f1 @|EndIcon #fIcon
Dt0 f3 richDialogId ch.ivyteam.ivy.project.portal.examples.DocumentTableUsage #txt
Dt0 f3 startMethod start() #txt
Dt0 f3 type ch.ivyteam.ivy.project.portal.examples.DocumentTableComponentData #txt
