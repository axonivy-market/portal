...
Es0 f0 type ch.ivyteam.ivy.project.portal.examples.customization.CustomizedExpressEndPage.CustomizedExpressEndPageData #txt
...
Es0 f1 type ch.ivyteam.ivy.project.portal.examples.customization.CustomizedExpressEndPage.CustomizedExpressEndPageData #txt
Es0 f1 211 51 26 26 0 12 #rect
Es0 f1 @|RichDialogProcessEndIcon #fIcon
Es0 f2 expr out #txt
Es0 f2 109 64 211 64 #arcP
Es0 f3 guid 1600BE1A7AAA872E #txt
Es0 f3 type ch.ivyteam.ivy.project.portal.examples.customization.CustomizedExpressEndPage.CustomizedExpressEndPageData #txt
Es0 f3 actionDecl 'ch.ivyteam.ivy.project.portal.examples.customization.CustomizedExpressEndPage.CustomizedExpressEndPageData out;
' #txt
...
Es0 f4 type ch.ivyteam.ivy.project.portal.examples.customization.CustomizedExpressEndPage.CustomizedExpressEndPageData #txt
