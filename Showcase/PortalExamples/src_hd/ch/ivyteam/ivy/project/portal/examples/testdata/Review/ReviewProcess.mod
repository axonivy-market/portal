...
As0 f0 method start(ch.ivyteam.ivy.project.portal.examples.Investment,Boolean,String) #txt
As0 f0 inParameterDecl '<ch.ivyteam.ivy.project.portal.examples.Investment investment,Boolean isApproved,String note> param;' #txt
As0 f0 inParameterMapAction 'out.isApproved=param.isApproved;
out.note=param.note;
out.selectedInvestment=param.investment;
' #txt
...
>Proto As0 .type ch.ivyteam.ivy.project.portal.examples.testdata.Review.ReviewData #txt
