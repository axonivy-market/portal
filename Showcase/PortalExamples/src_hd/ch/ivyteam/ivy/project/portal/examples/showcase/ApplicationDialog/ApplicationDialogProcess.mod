...
As0 @RichDialogMethodStart f9 '' #zField
...
As0 f17 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f17 467 283 26 26 0 12 #rect
As0 f17 @|RichDialogProcessEndIcon #fIcon
As0 f6 actionDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
As0 f6 actionTable 'out=in;
' #txt
As0 f6 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
...
As0 f9 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f9 method delete(ch.ivyteam.ivy.project.portal.examples.showcase.GdprFile) #txt
As0 f9 disableUIEvents false #txt
As0 f9 inParameterDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
...
As0 f9 @|RichDialogMethodStartIcon #fIcon
As0 f13 actionDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
...
' #txt
As0 f13 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
...
As0 f28 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f28 actionDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
...
As0 f1 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f1 371 51 26 26 0 12 #rect
As0 f1 @|RichDialogProcessEndIcon #fIcon
As0 f12 actionDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
...
As0 f12 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
...
As0 f11 actionDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
...
As0 f11 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
...
As0 f18 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f18 467 363 26 26 0 12 #rect
As0 f18 @|RichDialogProcessEndIcon #fIcon
As0 f10 guid 169C76B36E183099 #txt
As0 f10 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f10 actionDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
...
As0 f29 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f29 actionDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
...
As0 f30 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f30 459 539 26 26 0 12 #rect
As0 f30 @|RichDialogProcessEndIcon #fIcon
As0 f3 guid 169C76B36E13A297 #txt
As0 f3 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f3 actionDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
...
As0 f31 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
...
As0 f8 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f8 method show(ch.ivyteam.ivy.project.portal.examples.showcase.GdprFile) #txt
As0 f8 disableUIEvents false #txt
As0 f8 inParameterDecl 'ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData out;
' #txt
...
As0 f4 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f4 guid 1670762C39AAFF4D #txt
As0 f4 243 155 26 26 0 12 #rect
As0 f4 @|RichDialogEndIcon #fIcon
As0 f23 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
As0 f23 467 219 26 26 0 12 #rect
As0 f23 @|RichDialogProcessEndIcon #fIcon
As0 f19 type ch.ivyteam.ivy.project.portal.examples.showcase.ApplicationDialog.ApplicationDialogData #txt
