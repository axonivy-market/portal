...
Ps0 f1 type ch.ivyteam.ivy.project.portal.examples.component.customize.TaskWidget.TaskWidgetData #txt
Ps0 f1 229 133 22 22 14 0 #rect
Ps0 f1 @|RichDialogProcessEndIcon #fIcon
Ps0 f2 guid 1573377403EC1C55 #txt
Ps0 f2 type ch.ivyteam.ivy.project.portal.examples.component.customize.TaskWidget.TaskWidgetData #txt
...
>Proto Ps0 .type ch.ivyteam.ivy.project.portal.examples.component.customize.TaskWidget.TaskWidgetData #txt
