...
public class ChartJsBean implements Serializable {
  ...
  public void createRadarModel2() {
    ...
    labels.add(Arrays.asList("Process", "Excellence"));
    labels.add(Arrays.asList("Problem", "Solving"));
    labels.add(Arrays.asList("Facilitation"));
    labels.add(Arrays.asList("Project", "Mgmt"));
    labels.add(Arrays.asList("Change", "Mgmt"));
    data.setLabels(labels);
