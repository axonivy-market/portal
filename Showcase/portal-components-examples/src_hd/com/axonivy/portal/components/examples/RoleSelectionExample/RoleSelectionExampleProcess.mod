...
Ds0 f10 outParameterDecl '<com.axonivy.portal.components.dto.RoleDTO selectedRole> result;' #txt
...
>Proto Ds0 .type com.axonivy.portal.components.examples.RoleSelectionExample.RoleSelectionExampleData #txt
