...
Ds0 f0 outParameterDecl '<com.axonivy.portal.components.dto.UserDTO selectedUser> result;' #txt
...
>Proto Ds0 .type com.axonivy.portal.components.examples.UserSelectionExample.UserSelectionExampleData #txt
