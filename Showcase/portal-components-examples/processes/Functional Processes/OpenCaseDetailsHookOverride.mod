...
Oa0 f3 dialogId com.axonivy.portal.components.examples.ProcessHistoryDetailsExample #txt
...
>Proto Oa0 .type com.axonivy.portal.components.examples.override.OpenCaseDetailsHookOverrideData #txt
