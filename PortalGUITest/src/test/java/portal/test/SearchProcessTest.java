...
public class SearchProcessTest extends BaseTest {
  ...
  public void testFindProcessByNameAndOpenProcessList() {
    ...
    int numberOfProcesses = globalSearch.countFoundProcesses();
    SearchResultPage resultPage = globalSearch.startProcessOnGlobalSearch(processName);
    assertEquals(numberOfProcesses, resultPage.countProcesses());
  }
