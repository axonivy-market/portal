...
public class CasePage extends TemplatePage {
  ...
  public String getIdOfSelectingCase() {
    ...
    WebElement selectingCaseHeader = findElementById(selectingCase.getAttribute("id") + ":case-header-data-top");
    String selectingCaseHeaderText = selectingCaseHeader.getText();
    String selectingCaseId = selectingCaseHeaderText.substring(0, selectingCaseHeaderText.indexOf(" "));
    return selectingCaseId;
  }
}
