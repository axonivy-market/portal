...
public class CaseDetailsPage extends TemplatePage {
  ...
  public void changeCaseName(String newCaseName, int caseIndex) {
    String caseNameInplaceId = String.format("case-widget:case-list-scroller:%d:case-item:case-header:case-name-edit-inplace_display", caseIndex);
    WebElement caseNameInplace = findElementById(caseNameInplaceId);
    caseNameInplace.click();              
    String caseNameInputId = String.format("case-widget:case-list-scroller:%d:case-item:case-header:case-name-input", caseIndex);
    ...
    WebElement editor = findElementById(String.format("case-widget:case-list-scroller:%d:case-item:case-header:case-name-edit-inplace_editor", caseIndex));
  ...
  public String getNameOfCaseAt(int caseIndex) {
    String caseNameId = String.format("case-widget:case-list-scroller:%d:case-item:case-header:case-name-edit-inplace_display", caseIndex);
  ...
  public boolean isCaseNameChangeComponentPresented(int caseIndex) {
    return isElementPresent(By.id(String.format("case-widget:case-list-scroller:%d:case-item:case-header:case-name-input", caseIndex)));
  }
  
  public void changeCaseDescription(String newCaseDescription, int caseIndex) {
    String caseNameInplaceId = String.format("case-widget:case-list-scroller:%d:case-item:case-header:case-description-inplace_display", caseIndex);
    WebElement caseNameInplace = findElementById(caseNameInplaceId);
    caseNameInplace.click();
    String caseNameInputId = String.format("case-widget:case-list-scroller:%d:case-item:case-header:case-description-input", caseIndex);
    WebElement caseNameInput = findElementById(caseNameInputId);
    waitForElementDisplayed(caseNameInput, true);
    caseNameInput.clear();
    caseNameInput.sendKeys(newCaseDescription);
    WebElement editor = findElementById(String.format("case-widget:case-list-scroller:%d:case-item:case-header:case-description-inplace_editor", caseIndex));
    WebElement saveButton = findChildElementByClassName(editor, "ui-inplace-save");
    saveButton.click();
    waitForPageLoaded();
  }
  ...
  public String getDescriptionOfCaseAt(int caseIndex) {
    String caseDescriptionId = String.format("case-widget:case-list-scroller:%d:case-item:case-header:case-description-inplace_display", caseIndex);
