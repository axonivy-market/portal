[Ivy]
[>Created: Tue Jan 19 10:03:12 ICT 2016]
14CE5789393C8A1E 3.18 #module
...
Ae0 f6 type test003HumanRessources.PortalData #txt
Ae0 f6 requestActionDecl '<> param;' #txt
Ae0 f6 responseActionDecl 'test003HumanRessources.PortalData out;
' #txt
...
Ae0 f3 type test003HumanRessources.PortalData #txt
Ae0 f3 inParamDecl '<java.lang.Number caseId> param;' #txt
Ae0 f3 inParamTable 'out.caseId=param.caseId;
' #txt
Ae0 f3 actionDecl 'test003HumanRessources.PortalData out;
' #txt
...
Ae0 f8 richDialogId casedetails.PortalCaseDetails #txt
Ae0 f8 startMethod start(Number) #txt
Ae0 f8 type test003HumanRessources.PortalData #txt
Ae0 f8 requestActionDecl '<Number caseId> param;' #txt
Ae0 f8 requestMappingAction 'param.caseId=in.caseId;
' #txt
Ae0 f8 responseActionDecl 'test003HumanRessources.PortalData out;
' #txt
...
Ae0 f11 richDialogId caselist.OnBoardingCaseList #txt
Ae0 f11 startMethod start() #txt
Ae0 f11 type test003HumanRessources.PortalData #txt
Ae0 f11 requestActionDecl '<> param;' #txt
Ae0 f11 responseActionDecl 'test003HumanRessources.PortalData out;
' #txt
...
Ae0 f10 outLink InternalOnboardingCaseList.ivp #txt
Ae0 f10 type test003HumanRessources.PortalData #txt
Ae0 f10 inParamDecl '<> param;' #txt
Ae0 f10 actionDecl 'test003HumanRessources.PortalData out;
' #txt
Ae0 f10 guid 14CEA9596CB996A9 #txt
Ae0 f10 requestEnabled true #txt
Ae0 f10 triggerEnabled false #txt
Ae0 f10 callSignature InternalOnboardingCaseList() #txt
Ae0 f10 persist false #txt
Ae0 f10 taskData '#
#Fri Apr 24 15:46:38 ICT 2015
TaskTriggered.ROL=Everybody
TaskTriggered.EXTYPE=0
TaskTriggered.EXPRI=2
TaskTriggered.TYPE=0
...
<elementInfo>
    <language>
        <name>InternalOnboardingCaseList.ivp</name>
    </language>
</elementInfo>
' #txt
...
>Proto Ae0 .type test003HumanRessources.PortalData #txt
