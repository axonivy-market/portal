...
ivy.log.debug("WORKFLOW DELETED! " + deletedWorkflows + ". Workflows | " + deletedTaskdef + " Taskdefinitions | " + deletedFormelements + " Formelements" + "(" + ivy.task.getId()+ "/" + ivy.case.getId()+")");
