...
public class ProcessStartCollectorTest {
  ...
  public void testFindProcessStartByUserFriendlyRequestPathWithInactiveApplication() {
    ...
    IProcessStart actualProcessStart = processStartCollector.findProcessStartByUserFriendlyRequestPath(StringUtils.EMPTY);
  ...
  public void testFindProcessStartByUserFriendlyRequestPathReturnProcessStart() {
    ...
    IProcessStart expectedProcessStart = mockWorkflowProcessModelVersionFindProcessStart(processModelVersion, requestPath);
  ...
  private IProcessStart mockWorkflowProcessModelVersionFindProcessStart(IProcessModelVersion processModelVersion, String requestPath) {
    ...
    Mockito.when(workflowProcessModelVersion.findProcessStartByUserFriendlyRequestPath(requestPath)).thenReturn(processStart);
    PowerMockito.mockStatic(WorkflowNavigationUtil.class);
    PowerMockito.when(WorkflowNavigationUtil.getWorkflowProcessModelVersion(processModelVersion)).thenReturn(workflowProcessModelVersion);
    return processStart;
  }
}
