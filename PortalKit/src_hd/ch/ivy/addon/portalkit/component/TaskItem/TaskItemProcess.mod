[Ivy]
[>Created: Tue May 17 10:19:21 ICT 2016]
...
out.selectedTask.canDelegate=result.ivyTask.canDelegate;
out.selectedTask.canPark=result.ivyTask.canPark;
out.selectedTask.canReset=result.ivyTask.canReset;
out.selectedTask.canResume=result.ivyTask.canResume;
...
' #txt
Ts0 f40 530 562 28 28 11 -21 #rect
...
' #txt
Ts0 f23 526 436 36 24 20 -2 #rect
...
' #txt
Ts0 f7 526 500 36 24 20 -2 #rect
...
' #txt
Ts0 f26 654 620 36 24 20 -11 #rect
Ts0 f26 @|StepIcon #fIcon
Ts0 f10 expr out #txt
Ts0 f10 544 330 544 372 #arcP
Ts0 f11 expr out #txt
Ts0 f11 544 396 544 436 #arcP
Ts0 f25 expr out #txt
Ts0 f25 544 460 544 500 #arcP
Ts0 f41 expr out #txt
Ts0 f41 544 524 544 562 #arcP
Ts0 f43 expr in #txt
...
' #txt
Ts0 f43 558 576 672 620 #arcP
Ts0 f43 1 672 576 #addKink
Ts0 f43 1 0.3269230769230769 16 0 #arcLabel
Ts0 f59 expr out #txt
Ts0 f59 672 644 554 688 #arcP
Ts0 f59 1 672 688 #addKink
...
out.selectedTask.state=ch.ivyteam.ivy.workflow.TaskState.PARKED;
' #txt
...
Ts0 f102 mainOut f97 tail #connect
Ts0 f97 head f92 mainIn #connect
