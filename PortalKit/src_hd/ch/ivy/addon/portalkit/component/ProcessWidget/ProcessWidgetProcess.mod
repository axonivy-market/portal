[Ivy]
[>Created: Wed Mar 30 17:33:32 ICT 2016]
...
' #txt
Ps0 f17 517 309 22 22 14 0 #rect
...
' #txt
Ps0 f28 82 434 28 28 16 -15 #rect
...
' #txt
Ps0 f30 82 448 85 576 #arcP
Ps0 f30 1 32 448 #addKink
...
' #txt
Ps0 f13 actionCode 'import ch.ivyteam.ivy.security.IUser;
...
' #txt
Ps0 f13 78 372 36 24 20 -2 #rect
Ps0 f13 @|StepIcon #fIcon
Ps0 f14 expr out #txt
Ps0 f14 96 331 96 372 #arcP
Ps0 f15 expr out #txt
Ps0 f15 96 396 96 434 #arcP
Ps0 f29 actionDecl 'ch.ivy.addon.portalkit.component.ProcessWidget.ProcessWidgetData out;
' #txt
Ps0 f29 actionTable 'out=in;
' #txt
Ps0 f29 actionCode 'import ch.ivy.addon.portalkit.service.UserProcessService;
...
in.processes = userProcessService.subtractByLink(processesFromSubProcess, deletedDefaultProcesses);' #txt
Ps0 f29 type ch.ivy.addon.portalkit.component.ProcessWidget.ProcessWidgetData #txt
...
' #txt
Ps0 f29 78 148 36 24 20 -2 #rect
Ps0 f29 @|StepIcon #fIcon
Ps0 f35 expr out #txt
Ps0 f35 96 107 96 148 #arcP
Ps0 f20 expr out #txt
Ps0 f20 96 172 96 213 #arcP
...
Ps0 f23 mainOut f14 tail #connect
Ps0 f14 head f13 mainIn #connect
Ps0 f13 mainOut f15 tail #connect
Ps0 f15 head f28 in #connect
Ps0 f12 mainOut f35 tail #connect
Ps0 f35 head f29 mainIn #connect
Ps0 f29 mainOut f20 tail #connect
