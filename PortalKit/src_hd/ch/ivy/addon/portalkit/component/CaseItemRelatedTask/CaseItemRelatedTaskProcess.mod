[Ivy]
[>Created: Tue May 10 11:19:41 ICT 2016]
...
Cs0 f4 processCall 'Functional Processes/Navigator:viewTask(String,ch.ivy.addon.portalkit.dto.GlobalCaseId,String)' #txt
Cs0 f4 doCall true #txt
Cs0 f4 requestActionDecl '<java.lang.String taskId,ch.ivy.addon.portalkit.dto.GlobalCaseId caseId,java.lang.String caseName> param;
' #txt
...
' #txt
Cs0 f4 478 196 36 24 20 -2 #rect
Cs0 f4 @|CallSubIcon #fIcon
Cs0 f5 expr out #txt
Cs0 f5 496 107 496 196 #arcP
