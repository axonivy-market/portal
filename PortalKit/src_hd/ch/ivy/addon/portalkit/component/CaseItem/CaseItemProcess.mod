[Ivy]
[>Created: Thu Jul 28 12:11:44 ICT 2016]
...
Cs0 f16 type ch.ivy.addon.portalkit.component.CaseItem.CaseItemData #txt
...
' #txt
Cs0 f16 765 85 22 22 14 0 #rect
Cs0 f16 @|RichDialogMethodStartIcon #fIcon
Cs0 f17 type ch.ivy.addon.portalkit.component.CaseItem.CaseItemData #txt
Cs0 f17 765 277 22 22 14 0 #rect
Cs0 f17 @|RichDialogProcessEndIcon #fIcon
Cs0 f18 type ch.ivy.addon.portalkit.component.CaseItem.CaseItemData #txt
...
' #txt
Cs0 f18 requestMappingAction 'param.serverId=in.ivyCase.serverId;
param.ivyCase=in.ivyCase;
' #txt
Cs0 f18 responseActionDecl 'ch.ivy.add.portalkit.Data out;
' #txt
...
' #txt
Cs0 f18 758 212 36 24 20 -2 #rect
Cs0 f18 @|CallSubIcon #fIcon
Cs0 f19 actionDecl 'ch.ivy.addon.portalkit.component.CaseItem.CaseItemData out;
' #txt
...
in.ivyCase = service.prepareDataToSaveCase(in.remoteCase);' #txt
Cs0 f19 type ch.ivy.addon.portalkit.component.CaseItem.CaseItemData #txt
...
' #txt
Cs0 f19 760 148 32 24 20 -2 #rect
Cs0 f19 @|StepIcon #fIcon
Cs0 f20 expr out #txt
Cs0 f20 776 107 776 148 #arcP
Cs0 f21 expr out #txt
Cs0 f21 776 172 776 212 #arcP
Cs0 f22 expr out #txt
Cs0 f22 776 236 776 277 #arcP
