[Ivy]
[>Created: Tue May 10 11:45:23 ICT 2016]
...
Cs0 f16 processCall MultiPortal/TaskService:findTasksByCriteria(ch.ivy.ws.addon.TaskSearchCriteria,Integer,Integer) #txt
Cs0 f16 doCall true #txt
Cs0 f16 requestActionDecl '<ch.ivy.ws.addon.TaskSearchCriteria taskSearchCriteria,java.lang.Integer startIndex,java.lang.Integer count> param;
' #txt
Cs0 f16 requestMappingAction 'param.taskSearchCriteria=in.taskSearchCriteria;
' #txt
...
in.taskId = String.valueOf(commandLink.getAttributes().get("taskId") as Long);' #txt
...
Cs0 f11 processCall 'Functional Processes/Navigator:viewTask(String,ch.ivy.addon.portalkit.dto.GlobalCaseId,String)' #txt
Cs0 f11 doCall true #txt
Cs0 f11 requestActionDecl '<java.lang.String taskId,ch.ivy.addon.portalkit.dto.GlobalCaseId caseId,java.lang.String caseName> param;
' #txt
...
' #txt
Cs0 f11 110 500 36 24 20 -2 #rect
Cs0 f11 @|CallSubIcon #fIcon
Cs0 f13 expr out #txt
Cs0 f13 128 459 128 500 #arcP
...
Cs0 f10 mainOut f13 tail #connect
