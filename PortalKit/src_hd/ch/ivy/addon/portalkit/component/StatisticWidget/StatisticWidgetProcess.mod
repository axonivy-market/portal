[Ivy]
[>Created: Wed Apr 20 17:37:45 ICT 2016]
...
' #txt
Cs0 f8 782 532 36 24 20 -2 #rect
...
Cs0 f7 789 597 22 22 14 0 #rect
...
' #txt
Cs0 f11 782 404 36 24 20 -2 #rect
Cs0 f11 @|StepIcon #fIcon
Cs0 f2 expr out #txt
Cs0 f2 800 556 800 597 #arcP
...
' #txt
Cs0 f15 786 466 28 28 14 0 #rect
Cs0 f15 @|AlternativeIcon #fIcon
Cs0 f17 expr out #txt
Cs0 f17 800 428 800 466 #arcP
Cs0 f18 expr in #txt
Cs0 f18 outCond in.hasStatistic #txt
Cs0 f18 800 494 800 532 #arcP
Cs0 f9 expr in #txt
Cs0 f9 786 480 789 608 #arcP
Cs0 f9 1 736 480 #addKink
Cs0 f9 2 736 608 #addKink
Cs0 f9 1 0.51171875 0 0 #arcLabel
Cs0 f19 type ch.ivy.addon.portalkit.component.StatisticWidget.StatisticWidgetData #txt
Cs0 f19 processCall MultiPortal/TaskService:analyzeExpiryStatistic(String) #txt
Cs0 f19 doCall true #txt
Cs0 f19 requestActionDecl '<java.lang.String userName> param;
' #txt
Cs0 f19 requestMappingAction 'param.userName=ivy.session.getSessionUserName();
' #txt
...
' #txt
Cs0 f19 686 276 36 24 20 -2 #rect
Cs0 f19 @|CallSubIcon #fIcon
Cs0 f20 type ch.ivy.addon.portalkit.component.StatisticWidget.StatisticWidgetData #txt
Cs0 f20 processCall MultiPortal/TaskService:analyzePriorityStatistic(String) #txt
Cs0 f20 doCall true #txt
Cs0 f20 requestActionDecl '<java.lang.String userName> param;
' #txt
Cs0 f20 requestMappingAction 'param.userName=ivy.session.getSessionUserName();
' #txt
...
' #txt
Cs0 f20 878 276 36 24 -41 14 #rect
...
' #txt
Cs0 f21 786 338 28 28 14 0 #rect
...
Cs0 f22 786 210 28 28 14 0 #rect
Cs0 f22 @|ThreadIcon #fIcon
Cs0 f23 expr out1 #txt
Cs0 f23 814 224 896 276 #arcP
Cs0 f23 1 896 224 #addKink
...
Cs0 f24 var in1 #txt
Cs0 f24 896 300 814 352 #arcP
Cs0 f24 1 896 352 #addKink
Cs0 f24 1 0.008702834448251838 0 0 #arcLabel
Cs0 f25 expr out2 #txt
Cs0 f25 786 224 704 276 #arcP
Cs0 f25 1 704 224 #addKink
...
Cs0 f26 var in2 #txt
Cs0 f26 704 300 786 352 #arcP
Cs0 f26 1 704 352 #addKink
...
Cs0 f29 expr in #txt
Cs0 f29 outCond '!in.#priorityStatistic is initialized' #txt
...
' #txt
Cs0 f30 814 160 818 416 #arcP
Cs0 f30 1 960 160 #addKink
Cs0 f30 2 960 416 #addKink
