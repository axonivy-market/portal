[Ivy]
[>Created: Wed May 18 15:29:26 ICT 2016]
...
' #txt
As0 f10 741 53 22 22 14 0 #rect
...
As0 f11 741 181 22 22 14 0 #rect
...
' #txt
As0 f14 734 116 36 24 20 -2 #rect
As0 f14 @|StepIcon #fIcon
As0 f15 expr out #txt
As0 f15 752 75 752 116 #arcP
As0 f12 expr out #txt
As0 f12 752 140 752 181 #arcP
As0 f17 type ch.ivy.addon.portalkit.multiapp.general.ApplicationSelectionMenu.ApplicationSelectionMenuData #txt
As0 f17 processCall 'Functional Processes/Navigator:thirdPartyApplication(String,String)' #txt
As0 f17 doCall true #txt
As0 f17 requestActionDecl '<java.lang.String appName,java.lang.String url> param;
' #txt
As0 f17 requestMappingAction 'param.appName=in.thirdPartyAppName;
param.url=in.thirdPartyAppUrl;
' #txt
As0 f17 responseActionDecl 'ch.ivy.addon.portalkit.multiapp.general.ApplicationSelectionMenu.ApplicationSelectionMenuData out;
' #txt
...
<elementInfo>
    <language>
        <name>Navigate to third party application</name>
        <nameStyle>35,5,7
</nameStyle>
    </language>
</elementInfo>
' #txt
As0 f17 502 300 36 24 -58 19 #rect
As0 f17 @|CallSubIcon #fIcon
As0 f16 guid 154C2F1BF0654F28 #txt
As0 f16 type ch.ivy.addon.portalkit.multiapp.general.ApplicationSelectionMenu.ApplicationSelectionMenuData #txt
As0 f16 actionDecl 'ch.ivy.addon.portalkit.multiapp.general.ApplicationSelectionMenu.ApplicationSelectionMenuData out;
' #txt
...
<elementInfo>
    <language>
        <name>openThirdPartyApp</name>
        <nameStyle>17,5,7
</nameStyle>
    </language>
</elementInfo>
' #txt
As0 f16 509 213 22 22 14 0 #rect
As0 f16 @|RichDialogProcessStartIcon #fIcon
As0 f18 expr out #txt
As0 f18 520 235 520 300 #arcP
