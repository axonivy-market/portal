[Ivy]
[>Created: Wed Nov 02 16:38:27 ICT 2016]
...
As0 f55 462 222 20 20 13 0 #rect
...
' #txt
As0 f54 454 156 36 24 22 -5 #rect
As0 f54 @|StepIcon #fIcon
As0 f57 expr out #txt
As0 f57 472 180 472 222 #arcP
...
' #txt
As0 f102 actionCode 'import ch.ivy.addon.portalkit.util.Dates;
import ch.ivy.addon.portalkit.bo.RemoteAbsence;
...
As0 f33 360 74 454 168 #arcP
As0 f33 1 360 168 #addKink
...
As0 f53 592 140 490 168 #arcP
As0 f53 1 592 168 #addKink
As0 f53 1 0.22097550057337825 0 0 #arcLabel
