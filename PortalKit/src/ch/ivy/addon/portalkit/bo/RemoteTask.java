...
public class RemoteTask implements ITask {
  ...
  @Override
  public ResumeTaskResult canResumeWithRequestPath(String arg0) throws PersistencyException {
    return ResumeTaskResult.wrongRequestPath(this, this.getState());
  }

  @Override
  public ResumeTaskResult canUserResumeTask(ISession arg0) throws PersistencyException {
    return ResumeTaskResult.wrongUser(this, this.getState());
  }
