...
public class RemoteApplication implements IApplication {
	...
	@Override
	public List<IProperty> getConfigurationProperties()
			throws PersistencyException {
		return null;
	}

	@Override
	public IProperty getConfigurationProperty(String arg0)
			throws PersistencyException {
		return null;
	}
	...
	public void addSystemEventListener(EnumSet<SystemEventCategory> arg0,
			ISystemEventListener arg1) {

	}

	@Override
	@PublicAPI(IvyScriptVisibility.ADVANCED)
	public void removeSystemEventListener(EnumSet<SystemEventCategory> arg0,
			ISystemEventListener arg1) {
	...
	@Override
	public IEnvironment createEnvironment(String arg0, String arg1,
			IEnvironment arg2) throws PersistencyException {
		return null;
	}

	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public IExternalDatabaseDefaultConfiguration createExternalDatabaseConfiguration(
			String userFriendlyName,
			DatabaseConnectionConfiguration connectionConfiguration,
			EnumSet<ExternalDatabaseConfigurationAccessFlag> accessFlags,
			int maxConnections) throws PersistencyException {
		return null;
	}

	@Override
	public IDefaultGlobalVariable createGlobalVariable(String arg0,
			String arg1, String arg2) throws PersistencyException {
		return null;
	}

	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public IProcessModel createProcessModel(String processModelName,
			String description) throws PersistencyException {
		return null;
	}

	@Override
	public IDefaultWebService createWebService(String arg0, String arg1,
			String arg2, String arg3, String arg4, boolean arg5, int arg6,
			String arg7, String arg8, int arg9, String arg10, String arg11,
			String arg12) throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public void deleteExternalDatabaseConfiguration(String userFriendlyName)
			throws PersistencyException {
	...
	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public void deleteProcessModel(String processModelName)
			throws PersistencyException {
	...
	@Override
	public IExternalDatabaseDefaultConfiguration findDefaultExternalDatabaseConfiguration(
			String arg0) throws PersistencyException {
		return null;
	}

	@Override
	public IDefaultGlobalVariable findDefaultGlobalVariable(String arg0)
			throws PersistencyException {
		return null;
	}

	@Override
	public IDefaultWebService findDefaultWebService(String arg0)
			throws PersistencyException {
		return null;
	}

	@Override
	public IEnvironment findEnvironment(String arg0)
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.ADVANCED)
	public IExternalDatabaseConfiguration findExternalDatabaseConfiguration(
			String userFriendlyName) throws PersistencyException {
		return null;
	}

	@Override
	public IExternalDatabaseConfiguration findExternalDatabaseConfiguration(
			String arg0, ISession arg1) throws PersistencyException {
		return null;
	}

	@Override
	public IGlobalVariable findGlobalVariable(String arg0)
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.ADVANCED)
	public IProcessModel findProcessModel(String processModelName)
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.ADVANCED)
	public IProcessModel findProcessModel(Object identifier)
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.ADVANCED)
	public IProcessModelVersion findProcessModelVersion(
			String processModelVersionUrl) throws PersistencyException {
		return null;
	}

	@Override
	public IProcessModelVersion findProcessModelVersion(Object arg0)
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.HIDDEN)
	public IEnvironment getActualEnvironment(ISession session)
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public IEMailNotificationSettings getDefaultEMailNotifcationSettings()
			throws PersistencyException {
		return null;
	}

	@Override
	public List<IExternalDatabaseConfiguration> getDefaultExternalDatabaseConfigurations()
			throws PersistencyException {
		return null;
	}

	@Override
	public List<IGlobalVariable> getDefaultGlobalVariables()
			throws PersistencyException {
		return null;
	}

	@Override
	public List<IWebService> getDefaultWebServices()
			throws PersistencyException {
		return null;
	}
	...
	@Override
	public List<IEnvironment> getEnvironmentsSortedByName()
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.ADVANCED)
	public List<IExternalDatabaseConfiguration> getExternalDatabaseConfigurations()
			throws PersistencyException {
		return null;
	}
	...
	@Override
	@PublicAPI(IvyScriptVisibility.ADVANCED)
	public List<IProcessModel> getProcessModelsSortedByName()
			throws PersistencyException {
		return null;
	}
	...
	public void setActiveEnvironment(String environment)
			throws PersistencyException, NoSuchElementException {
	...
	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public void setDefaultEMailLanguage(Locale emailLanguage)
			throws PersistencyException {
	...
	@Override
	@PublicAPI(IvyScriptVisibility.EXPERT)
	public void setDefaultEMailNotifcationSettings(
			IEMailNotificationSettings settings) throws PersistencyException {
	...
	@Override
	public IDefaultWebService createWebService(String generationIdentifier,
			String name, String description, String tag, String wsdlurl,
			boolean transportSession, int sessionHandlingMode,
			String webServiceFramework, String generationProperties,
			int generationPropertiesVersion,
			WebServiceAuthentication authentication)
			throws PersistencyException {
		return null;
	}
