[Ivy]
[>Created: Tue May 10 11:03:37 ICT 2016]
...
Nr0 f5 inParamDecl '<java.lang.String taskId,ch.ivy.addon.portalkit.dto.GlobalCaseId caseId,java.lang.String caseName> param;' #txt
Nr0 f5 outParamDecl '<> result;
' #txt
Nr0 f5 actionDecl 'ch.ivy.add.portalkit.NavigatorData out;
' #txt
Nr0 f5 callSignature viewTask(String,ch.ivy.addon.portalkit.dto.GlobalCaseId,String) #txt
