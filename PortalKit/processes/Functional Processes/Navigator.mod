[Ivy]
[>Created: Fri May 20 10:21:26 ICT 2016]
...
Nr0 f8 inParamDecl '<java.lang.String appName,java.lang.String url> param;' #txt
Nr0 f8 outParamDecl '<> result;
' #txt
Nr0 f8 actionDecl 'ch.ivy.add.portalkit.NavigatorData out;
' #txt
Nr0 f8 callSignature thirdPartyApplication(String,String) #txt
...
' #txt
Nr0 f23 536 450 496 172 -238 -84 #rect
...
Nr0 f23 ao f13 tail #connect
Nr0 f13 head f10 ai #connect
