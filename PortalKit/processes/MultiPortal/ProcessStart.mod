[Ivy]
[>Created: Tue Jul 12 17:17:49 ICT 2016]
...
Pt0 f5 requestActionDecl '<java.lang.Boolean isNoConfigurationMode,java.lang.String endpoint,java.lang.String language,ch.ivy.ws.addon.ProcessSearchCriteria processSearchCriteria,ch.ivy.addon.portalkit.persistence.domain.Server server> param;
' #txt
Pt0 f5 requestMappingAction 'param.isNoConfigurationMode=in.isNoConfigurationMode;
...
' #txt
Pt0 f29 actionCode 'import ch.ivy.addon.portalkit.util.ServerUtil;
