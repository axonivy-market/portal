[Ivy]
[>Created: Mon May 30 10:55:01 ICT 2016]
...
Ce0 f30 2296 260 1030 568 #arcP
Ce0 f30 1 2296 568 #addKink
...
Ce0 f75 inParamDecl '<java.lang.Integer startIndex,java.lang.Integer count,ch.ivy.ws.addon.CaseSearchCriteria caseSearchCriteria> param;' #txt
...
' #txt
Ce0 f75 callSignature findCasesByCriteria(Integer,Integer,ch.ivy.ws.addon.CaseSearchCriteria) #txt
...
' #txt
Ce0 f84 302 284 36 24 20 -2 #rect
...
' #txt
Ce0 f91 302 364 36 24 21 -18 #rect
...
' #txt
Ce0 f92 302 508 36 24 20 -2 #rect
Ce0 f92 @|StepIcon #fIcon
Ce0 f96 expr out #txt
Ce0 f96 338 520 440 244 #arcP
Ce0 f96 1 440 520 #addKink
...
Ce0 f106 306 168 1002 568 #arcP
Ce0 f106 1 240 168 #addKink
Ce0 f106 2 240 568 #addKink
...
Ce0 f181 2576 284 1030 568 #arcP
...
Ce0 f135 2928 300 1030 568 #arcP
...
Ce0 f183 96 300 1002 568 #arcP
Ce0 f183 1 96 568 #addKink
Ce0 f183 1 0.4293924466338259 0 0 #arcLabel
Ce0 f0 inParamDecl '<ch.ivy.ws.addon.CaseSearchCriteria caseSearchCriteria> param;' #txt
...
' #txt
Ce0 f0 callSignature countCasesByCriteria(ch.ivy.ws.addon.CaseSearchCriteria) #txt
...
' #txt
Ce0 f4 actionCode 'import ch.ivy.addon.portalkit.service.PortalConnectorDetector;
import ch.ivy.addon.portalkit.enums.WebServiceEndPoint;
import ch.ivy.ws.addon.IvyApplication;
...
' #txt
Ce0 f4 558 380 36 24 21 -18 #rect
...
' #txt
Ce0 f8 558 452 36 24 20 -2 #rect
...
' #txt
Ce0 f11 actionCode 'import ch.ivy.addon.portalkit.service.ServerService;
...
' #txt
Ce0 f13 558 284 36 24 20 -2 #rect
...
' #txt
Ce0 f14 558 508 36 24 20 -2 #rect
Ce0 f14 @|StepIcon #fIcon
Ce0 f18 expr out #txt
Ce0 f18 594 520 696 244 #arcP
Ce0 f18 1 696 520 #addKink
...
Ce0 f23 576 244 576 284 #arcP
Ce0 f29 expr in #txt
Ce0 f29 outCond in.listIterator.hasNext() #txt
Ce0 f29 576 182 576 220 #arcP
Ce0 f77 expr out #txt
Ce0 f77 576 77 576 100 #arcP
Ce0 f79 expr out #txt
Ce0 f79 576 404 576 452 #arcP
Ce0 f79 0 0.4643737380072319 0 0 #arcLabel
Ce0 f82 expr out #txt
Ce0 f82 576 476 576 508 #arcP
Ce0 f83 expr in #txt
Ce0 f83 562 168 1002 568 #arcP
Ce0 f83 1 496 168 #addKink
Ce0 f83 2 496 568 #addKink
...
Ce0 f49 320 308 320 364 #arcP
Ce0 f51 expr out #txt
Ce0 f51 576 308 576 380 #arcP
...
Ce0 f9 mainOut f23 tail #connect
...
Ce0 f4 mainOut f79 tail #connect
Ce0 f79 head f8 mainIn #connect
...
Ce0 f13 mainOut f51 tail #connect
Ce0 f51 head f4 mainIn #connect
