[Ivy]
[>Created: Tue Jun 14 15:04:44 ICT 2016]
...
KEY_HOST=
KEY_USE_AUTHENTICATION=false
KEY_AXIS_CSL_PARAMETER_DATA=""arg0.findTasksByCriteria.count__@@__Integer__@@__in.count"",""arg0.findTasksByCriteria.serverId__@@__Long__@@__in.server.id"",""arg0.findTasksByCriteria.serverUrl__@@__String__@@__in.serverUrl"",""arg0.findTasksByCriteria.startIndex__@@__Integer__@@__in.startIndex"",""arg0.findTasksByCriteria.taskSearchCriteria__@@__ch.ivy.ws.addon.TaskSearchCriteria__@@__in.taskSearchCriteria"""' #txt
...
Te0 f35 inParamDecl '<ch.ivy.ws.addon.TaskSearchCriteria taskSearchCriteria,java.lang.String endpoint,ch.ivy.addon.portalkit.persistence.domain.Server server,java.lang.Integer startIndex,java.lang.Integer count> param;' #txt
...
' #txt
Te0 f35 callSignature findTasksByCriteria(ch.ivy.ws.addon.TaskSearchCriteria,String,ch.ivy.addon.portalkit.persistence.domain.Server,Integer,Integer) #txt
