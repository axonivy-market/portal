...
User needs permission: :ref:`🔑ShowAllTasksOfCase <ShowAllTasksOfCase>` to display this action, and :ref:`🔑TaskReadOwnCaseTasks <TaskReadOwnCaseTasks>` or :ref:`🔑TaskReadAll <TaskReadAll>` to view related tasks.
