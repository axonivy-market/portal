...
.. code-block:: html
   ...
   [{  "id": "01322912db224658a222804802844a7b",
      ...
      "imageUrl": "/ExternalLinkProcess/3f9910e2-30fd-45fc-a79f-b387e04c5ed2",
      "imageType": "jpeg",
...
- ``imageUrl``: the process's image. This image is stored in the Application CMS
- ``imageType``: the process's image type
