...
Portal settings are stored as :dev-url:`Variables </doc/9.4.0/designer-guide/configuration/variables.html>`.
...
</doc/9.4.0/engine-guide/tool-reference/engine-cockpit/security.html>`. In the
...
.. code-block:: html
   ...
   { "id": "423152a58c7a48a2b63be8a946e5731c",
      "processType": "IVY_PROCESS",
      "processName": "cms:/Processes/CreateInvestment/name",
      "icon": "fa-building",
      "processId": "Portal/portal-developer-examples/Start Processes/IFrameExample/CreateInvestment.ivp",
      "index": 2
   }]
