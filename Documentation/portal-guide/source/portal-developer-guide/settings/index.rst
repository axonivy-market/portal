...
Portal settings are stored as :dev-url:`Variables </doc/10.0.1/designer-guide/configuration/variables.html>`.
...
</doc/10.0.1/engine-guide/tool-reference/engine-cockpit/security.html>`. In the
