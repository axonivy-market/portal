...
.. list-table::
   ...
   * - ``processPaths``
     - array
     - *(all processes)*
     - :dev-url:`IWebStartable </doc/12.0/public-api/ch/ivyteam/ivy/workflow/start/IWebStartable.html>` identifiers of specific processes to display
   * - ``categories``
     - array
     - *(all processes)*
     - :dev-url:`CMS URI </doc/12.0/designer-guide/how-to/workflow/categories.html#workflow-categories>` of process categories. Shows all processes in these categories
   * - ``sorting``
     - string
     - ``"ALPHABETICALLY"``
...
.. list-table::
   ...
   * - ``processPath``
     - string
     - *(required)*
     - :dev-url:`IWebStartable </doc/12.0/public-api/ch/ivyteam/ivy/workflow/start/IWebStartable.html>` identifier of the process to display with its tasks/cases
   * - ``rowsPerPage``
     - number
     - ``5``
...
.. list-table::
   ...
   * - ``processPath``
     - string
     - :dev-url:`IWebStartable </doc/12.0/public-api/ch/ivyteam/ivy/workflow/start/IWebStartable.html>` identifier of the process to display in detail
...
.. list-table::
   ...
   * - ``processPath``
     - string
     - :dev-url:`IWebStartable </doc/12.0/public-api/ch/ivyteam/ivy/workflow/start/IWebStartable.html>` identifier of the process to display with its image
