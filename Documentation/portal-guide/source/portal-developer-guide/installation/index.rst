...
deployment <https://developer.axonivy.com/doc/9.3.0/engine-guide/deployment/index.html>`__
.
...
.. important:: 
   ...
   `Axon Ivy migration
   notes <https://developer.axonivy.com/doc/9.3.0/axonivy/migration/index.html>`__.
...
#. Deprecated callable processes: ``OpenPortalSearch.mod``, ``OpenPortalTasks.mod``, ``OpenPortalTaskDetails.mod``, ``OpenPortalCases.mod``, ``OpenPortalCaseDetails.mod`` process.
   ...
   Portal recommends using `Axon Ivy HtmlOverride wizard <https://developer.axonivy.com/doc/9.3.0/designer-guide/how-to/overrides.html?#override-new-wizard>`_ to customize ``Portal HTML Dialog``
