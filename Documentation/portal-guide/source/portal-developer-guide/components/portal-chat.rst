...
- If your system uses an additional Tomcat **Valve**, then we recommend to add asyncSupported in file ``Context.xml``. An example file is available at :doc-url:`File Reference </engine-guide/configuration/files/context-xml.html>`.
