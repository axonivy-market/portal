...
This default error page (located at ``${AxonIvyEngineFolder}/webapp/ivy/ivy-error-page.xhtml``) is not user-friendly. Portal provides custom error pages with a better user experience.
