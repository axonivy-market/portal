...
.. tip::
   ...
   :dev-url:`Color Customizing </doc/|version|/designer-guide/user-interface/user-dialogs/html-dialog-themes.html?highlight=color%20customizing#color-customizing>`.
