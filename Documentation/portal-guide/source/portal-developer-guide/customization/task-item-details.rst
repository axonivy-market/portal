...
.. important::
   ...
   -  We support all task business states for filter type ``states``. Please refer to :dev-url:`Task Business States </doc/12.0/public-api/ch/ivyteam/ivy/workflow/task/TaskBusinessState.html>` to check for available task business states.
