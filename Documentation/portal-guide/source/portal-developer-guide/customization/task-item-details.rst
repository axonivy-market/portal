...
.. important::
   ...
   -  We support all task states for filter type ``states``. Please refer to :dev-url:`Task States </doc/9.4.0/public-api/ch/ivyteam/ivy/workflow/TaskState.html>` to check for avaiable task states.
...
#. Use :dev-url:`Axon Ivy HtmlOverride wizard </doc/9.4.0/designer-guide/how-to/overrides.html?#override-new-wizard>` to override ``PortalTaskDetails`` HTML dialog.
