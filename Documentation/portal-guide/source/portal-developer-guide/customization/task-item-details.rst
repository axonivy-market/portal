...
.. important::
   ...
   -  We support all task states for filter type ``states``. Please refer to `Task States <https://developer.axonivy.com/doc/|version|/public-api/ch/ivyteam/ivy/workflow/TaskState.html>`_ to check for avaiable task states.
...
#. Use `Axon Ivy HtmlOverride wizard <https://developer.axonivy.com/doc/|version|/designer-guide/how-to/overrides.html?#override-new-wizard>`_ to override ``PortalTaskDetails`` HTML dialog.
