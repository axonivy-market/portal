...
#. Use `Axon Ivy HtmlOverride wizard <https://developer.axonivy.com/doc/9.3.3/designer-guide/how-to/overrides.html?#override-new-wizard>`_ to override ``SearchResults`` HTML dialog.
