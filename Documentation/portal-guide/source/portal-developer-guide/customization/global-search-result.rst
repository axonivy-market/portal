...
#. Use :dev-url:`Axon Ivy HtmlOverride wizard </doc/10.0.1/designer-guide/how-to/overrides.html?#override-new-wizard>` to override the ``SearchResults`` HTML dialog.
