...
Refer to `Axon Ivy HtmlOverride wizard <https://developer.axonivy.com/doc/|version|/designer-guide/how-to/overrides.html?#override-new-wizard>`_ to override ``UserWithEnvironmentInfo`` HTML dialog.
