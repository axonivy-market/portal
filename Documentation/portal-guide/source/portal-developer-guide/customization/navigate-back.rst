...
Normally, to reset a task and navigate to a URL, use the following approach:
...
However, if you need Portal to handle the task reset as part of the redirect process, use:
