...
You can access this statistic demonstration by accessing **Demo Portal** in Axon Ivy Engine.
If you are working with Axon Ivy Designer, please run the process :guilabel:`Init sample statistic dashboard config` by yourself,
but be aware that this process will automatically append sample configurations to your **Portal.Dashboard** and **Portal.CustomStatistic** variables.

You will see the item :guilabel:`Sample: KPI Procurement Overview` in the left menu, and more data can be generated by starting the process :guilabel:`Procurement Data For Sample Statistic Dashboard`.
