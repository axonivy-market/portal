...
.. note:: Portal settings could be configured in `Axon Ivy Cockpit <https://developer.axonivy.com/doc/|version|/engine-guide/tool-reference/engine-cockpit/configuration.html#engine-cockpit-variables>`_ .
