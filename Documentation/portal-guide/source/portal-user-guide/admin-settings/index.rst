...
.. deprecated:: 12.0
   ...
   **Migration**: Use the permission :ref:`🔑NoteReadAllCaseTaskDetails <NoteReadAllCaseTaskDetails>` to control visibility of system notes in task and case details instead.
