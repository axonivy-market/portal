...
**|ivy| Express**  is a module of the |ivy|
platform which is provided to you with the |ivy| Portal as well. It
...
-  The **Seamless Integration** into the |ivy|
...
in the |ivy| Portal menu or the quick link :guilabel:`Show all processes` in
your dashboard.
...
workflow`. This feature is explained in detail in `|ivy| Express`_. Below
...
#. Define your :guilabel:`User Interface`:
   ...
   -  With the option *Use default,* the user dialogs will be
      automatically generated by |ivy| Express
