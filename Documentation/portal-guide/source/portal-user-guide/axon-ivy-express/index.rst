...
So far, this document familiarized you with the |ivy| Portal and
...
**|ivy| Express** is a module of the |ivy| Portal. It
...
You can reach |ivy| Express by using the link ``Processes``
in the |ivy| Portal menu.
...
#. Define your :guilabel:`User Interface` :
   ...
   -  With the option *Use default,* the user dialogs will
      automatically be generated by |ivy| Express
...
.. note::
   ...
   :bdg-ref-warning:`🔑ExpressCreateWorkflow <ExpressCreateWorkflow>` permission is required to create an Express Workflow.
...
.. important:: 
  ...
  The export file is a JSON file. It contains a version of |ivy| Express
...
|ivy| Express also provides an ad hoc process feature. Onc Express is
