...
<update-portal-settings>` :guilabel:`Portal.Cases.BehaviourWhenClickingOnLineInCaseList` is set to
...
#. **Summary**: The name of the case, its ID and creation date and the |actions-menu-icon|
   :guilabel:`Actions` menu of the case. Below you find :guilabel:`Case Id`, :guilabel:`State`
   and :guilabel:`Case Category`.

#. **Case Details**: The description of the case, followed by
   :guilabel:`Role and User Information` and :guilabel:`Time Information`.
