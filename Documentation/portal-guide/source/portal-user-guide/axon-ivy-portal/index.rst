...
**2. Sidebar**
   ...
   The sidebar provides access to the :ref:`full-process-list`, cases, tasks and :ref:`portal-configuration` pages. Administrators can configure the sidebar to use one of three behaviours: Hover, Click, or Stick.
