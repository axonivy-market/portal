...
The |ivy| Portal Dashboard is the first page you see after having logged
in. You can always get back to the dashboard using the **Dashboard** link in the
|ivy| Portal menu. Alternatively, you can click on the logo in
the header.
...
.. note::
   ...
   Grant permission :ref:`🔑AccessFullProcessList <AccessFullProcessList>` to allow a user to access the full process list.
...
This quick link routes you to the **Full Process List** page of the |ivy|
...
:ref:`full-task-list` for detailed information. Grant permission :ref:`🔑AccessFullTaskList <AccessFullTaskList>` to allow a user to access the full task list.
...
to :ref:`full-statistic-list` for detailed information. Grant permission :ref:`🔑AccessFullStatisticsList <AccessFullStatisticsList>` to allow a user to access the full list of statistics.
